...
export const tests = Test_testList("Harmonization Tests", ofArray([Test_testList("Pnt Squared Distance Methods", ofArray([(() => {
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_3, Test_TestCaseBuilder__Delay_1505(builder$0040_3, () => {
        let p_5, b_3, x_3, y_3, z_3;
        Expect_isTrue(((p_5 = Pnt_$ctor_Z7AD9E565(1, 2, 3), (b_3 = Pnt_$ctor_Z7AD9E565(1 + 1E-10, 2, 3), (x_3 = (p_5.X - b_3.X), (y_3 = (p_5.Y - b_3.Y), (z_3 = (p_5.Z - b_3.Z), ((x_3 * x_3) + (y_3 * y_3)) + (z_3 * z_3))))))) < 1E-15)("Very close points should have tiny squared distance");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_4, Test_TestCaseBuilder__Delay_1505(builder$0040_4, () => {
        let half;
        const v_1 = Vec_$ctor_Z7AD9E565(4, 6, 8);
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_5, Test_TestCaseBuilder__Delay_1505(builder$0040_5, () => {
        let a, v_4, x_4, y_4, z_4, l, f, b_4, v_5, x_7, y_6, z_6, l_1, f_1;
        const v_2 = Vec_$ctor_Z7AD9E565(1, 2, 3);
        let half_1;
        const v_3 = v_2;
        half_1 = Vec_$ctor_Z7AD9E565_1(v_3.X * 0.5, v_3.Y * 0.5, v_3.Z * 0.5);
        Expect_floatClose(AccuracyModule_high, (a = ((v_4 = v_2, (x_4 = v_4.X, (y_4 = v_4.Y, (z_4 = v_4.Z, (l = Math.sqrt(((x_4 * x_4) + (y_4 * y_4)) + (z_4 * z_4)), (!(l > 1E-12) ? failUnit3("Vec.Unitized", x_4, y_4, z_4) : undefined, (f = (1 / l), UnitVec_$ctor_Z7AD9E565(f * x_4, f * y_4, f * z_4))))))))), (b_4 = ((v_5 = half_1, (x_7 = v_5.X, (y_6 = v_5.Y, (z_6 = v_5.Z, (l_1 = Math.sqrt(((x_7 * x_7) + (y_6 * y_6)) + (z_6 * z_6)), (!(l_1 > 1E-12) ? failUnit3("Vec.Unitized", x_7, y_6, z_6) : undefined, (f_1 = (1 / l_1), UnitVec_$ctor_Z7AD9E565(f_1 * x_7, f_1 * y_6, f_1 * z_6))))))))), ((a.X * b_4.X) + (a.Y * b_4.Y)) + (a.Z * b_4.Z))), 1, "Direction should be preserved");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_6, Test_TestCaseBuilder__Delay_1505(builder$0040_6, () => {
        const rotated = Euclid_Vc__Vc_rotateByQuarterCircle_Static(0, Vc_$ctor_7B00E9A0(1, 0));
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_7, Test_TestCaseBuilder__Delay_1505(builder$0040_7, () => {
        const rotated_1 = Euclid_Vc__Vc_rotateByQuarterCircle_Static(1, Vc_$ctor_7B00E9A0(1, 0));
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_8, Test_TestCaseBuilder__Delay_1505(builder$0040_8, () => {
        const rotated_2 = Euclid_Vc__Vc_rotateByQuarterCircle_Static(2, Vc_$ctor_7B00E9A0(1, 0));
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_9, Test_TestCaseBuilder__Delay_1505(builder$0040_9, () => {
        const rotated_3 = Euclid_Vc__Vc_rotateByQuarterCircle_Static(3, Vc_$ctor_7B00E9A0(1, 0));
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_10, Test_TestCaseBuilder__Delay_1505(builder$0040_10, () => {
        const rotated_4 = Euclid_Vc__Vc_rotateByQuarterCircle_Static(-1, Vc_$ctor_7B00E9A0(1, 0));
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_12, Test_TestCaseBuilder__Delay_1505(builder$0040_12, () => {
        ...
        Expect_floatClose(AccuracyModule_high, (v_21 = Euclid_Vc__Vc_rotateByQuarterCircle_Static(1, v_18), (x_11 = v_21.X, (y_9 = v_21.Y, Math.sqrt((x_11 * x_11) + (y_9 * y_9))))), len, "Length should be preserved");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_13, Test_TestCaseBuilder__Delay_1505(builder$0040_13, () => {
        let l_2;
        const rotated_7 = Euclid_UnitVc__UnitVc_rotateByQuarterCircle_Static(1, (l_2 = Math.sqrt((1 * 1) + (1 * 1)), (!(l_2 > 1E-12) ? failUnit2("UnitVc.create", 1, 1) : undefined, UnitVc_$ctor_7B00E9A0(1 / l_2, 1 / l_2))));
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_14, Test_TestCaseBuilder__Delay_1505(builder$0040_14, () => {
        const rotated_8 = Euclid_Vec__Vec_rotateByQuarterCircle_Static(0, Vec_$ctor_Z7AD9E565(1, 0, 5));
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_15, Test_TestCaseBuilder__Delay_1505(builder$0040_15, () => {
        const rotated_9 = Euclid_Vec__Vec_rotateByQuarterCircle_Static(1, Vec_$ctor_Z7AD9E565(1, 0, 5));
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_16, Test_TestCaseBuilder__Delay_1505(builder$0040_16, () => {
        ...
        Expect_floatClose(AccuracyModule_high, Euclid_Vec__Vec_rotateByQuarterCircle_Static(2, v_28).Z, v_28.Z, "Z should be preserved");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_17, Test_TestCaseBuilder__Delay_1505(builder$0040_17, () => {
        ...
        Test_TestCaseBuilder__For_Z371464DD(builder$0040_17, [-2, -1, 0, 1, 2, 3, 4, 5], (_arg) => {
            ...
            Expect_floatClose(AccuracyModule_high, (v_33 = Euclid_Vec__Vec_rotateByQuarterCircle_Static(quarters, v_30), Math.sqrt(((v_33.X * v_33.X) + (v_33.Y * v_33.Y)) + (v_33.Z * v_33.Z))), len_1, `Length preserved for ${quarters} quarters`);
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_18, Test_TestCaseBuilder__Delay_1505(builder$0040_18, () => {
        let l_3, li;
        const rotated_12 = Euclid_UnitVec__UnitVec_rotateByQuarterCircle_Static(1, (l_3 = Math.sqrt(((1 * 1) + (1 * 1)) + (0 * 0)), (!(l_3 > 1E-12) ? failUnit3_1("UnitVec.create", 1, 1, 0) : undefined, (li = (1 / l_3), UnitVec_$ctor_Z7AD9E565(li * 1, li * 1, li * 0)))));
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_19, Test_TestCaseBuilder__Delay_1505(builder$0040_19, () => {
        const rotated_13 = Euclid_Vec__Vec_rotateByQuarterCircle_Static(1, Vec_$ctor_Z7AD9E565(0, 0, 5));
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_22, Test_TestCaseBuilder__Delay_1505(builder$0040_22, () => {
        const rotated_14 = Euclid_Vc__Vc_rotateByQuarterCircle_Static(1000, Vc_$ctor_7B00E9A0(1, 0));
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_23, Test_TestCaseBuilder__Delay_1505(builder$0040_23, () => {
        const rotated_15 = Euclid_Vc__Vc_rotateByQuarterCircle_Static(-1001, Vc_$ctor_7B00E9A0(1, 0));
