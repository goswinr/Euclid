    ...
    while (idx < xs.length) {
        ...
        while (i < xs.length) {
            ...
            if (((a_1 = en, (b_1 = ((ln_2 = oth, Pt_$ctor_7B00E9A0(ln_2.FromX, ln_2.FromY))), (vx = (a_1.X - b_1.X), (vy = (a_1.Y - b_1.Y), (vx * vx) + (vy * vy)))))) < distSq) {
                void (((this$ = loops, item(this$.length - 1, this$))).forward.push(item(i, xs)));
                const i_1 = i | 0;
                const j = (idx + 1) | 0;
                const xs_1 = xs;
                if (i_1 !== j) {
        ...
        while (i < xs.length) {
            ...
            if (((a_3 = st, (b_3 = ((ln_5 = oth_1, Pt_$ctor_7B00E9A0(ln_5.ToX, ln_5.ToY))), (vx_1 = (a_3.X - b_3.X), (vy_1 = (a_3.Y - b_3.Y), (vx_1 * vx_1) + (vy_1 * vy_1)))))) < distSq) {
                void (((this$_1 = loops, item(this$_1.length - 1, this$_1))).backward.push(item(i, xs)));
                const i_2 = i | 0;
                const j_1 = (idx + 1) | 0;
                const xs_2 = xs;
                if (i_2 !== j_1) {
...
export function Topology2D_joinReversing_Z484E292B(getLine, splitDistance, xs) {
    ...
    while (idx < xs.length) {
        ...
        while (i < xs.length) {
            ...
            const oth = getLine(item(i, xs));
            if (((a_1 = en, (b_1 = ((ln_2 = oth, Pt_$ctor_7B00E9A0(ln_2.FromX, ln_2.FromY))), (vx = (a_1.X - b_1.X), (vy = (a_1.Y - b_1.Y), (vx * vx) + (vy * vy)))))) < distSq) {
                void (((this$ = loops, item(this$.length - 1, this$))).forward.push([item(i, xs), false]));
                const i_1 = i | 0;
                const j = (idx + 1) | 0;
                const xs_1 = xs;
                if (i_1 !== j) {
                ...
                void (((this$_1 = loops, item(this$_1.length - 1, this$_1))).forward.push([item(i, xs), true]));
                const i_2 = i | 0;
                const j_1 = (idx + 1) | 0;
                const xs_2 = xs;
                if (i_2 !== j_1) {
        ...
        while (i < xs.length) {
            ...
            if (((a_5 = st, (b_5 = ((ln_7 = oth_1, Pt_$ctor_7B00E9A0(ln_7.ToX, ln_7.ToY))), (vx_2 = (a_5.X - b_5.X), (vy_2 = (a_5.Y - b_5.Y), (vx_2 * vx_2) + (vy_2 * vy_2)))))) < distSq) {
                void (((this$_2 = loops, item(this$_2.length - 1, this$_2))).backward.push([item(i, xs), false]));
                const i_3 = i | 0;
                const j_2 = (idx + 1) | 0;
                const xs_3 = xs;
                if (i_3 !== j_2) {
                ...
                void (((this$_3 = loops, item(this$_3.length - 1, this$_3))).backward.push([item(i, xs), true]));
                const i_4 = i | 0;
                const j_3 = (idx + 1) | 0;
                const xs_4 = xs;
                if (i_4 !== j_3) {
