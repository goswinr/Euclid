...
export class Rect2D extends Record {
    ...
    toString() {
        ...
        const r = this;
        return `Euclid.Rect2D ${float((v = r.Xaxis, (x = v.X, (y = v.Y, Math.sqrt((x * x) + (y * y))))))} x ${float((v_1 = r.Yaxis, (x_1 = v_1.X, (y_1 = v_1.Y, Math.sqrt((x_1 * x_1) + (y_1 * y_1))))))} (Origin:${Pt__get_AsString(r.Origin)}| X-ax:${Vc__get_AsString(r.Xaxis)}|Y-ax:${Vc__get_AsString(r.Yaxis)})`;
    }
}
...
export function Rect2D__get_AsString(r) {
    let v, x, y, v_1, x_1, y_1;
    return concat(float((v = r.Xaxis, (x = v.X, (y = v.Y, Math.sqrt((x * x) + (y * y)))))), " x ", ...float((v_1 = r.Yaxis, (x_1 = v_1.X, (y_1 = v_1.Y, Math.sqrt((x_1 * x_1) + (y_1 * y_1)))))));
}
...
export function Rect2D__Contains_6ADE94FD(r, p) {
    let a_1, b_1, a_2, b_2, a_3, a_4, b_4, p_2, v_2, b_3, a_5, a_6, b_6, b_5;
    const p0 = r.Origin;
    const x = r.Xaxis;
    const y = r.Yaxis;
    let v;
    ...
    if (((((a_1 = v, (b_1 = x, (a_1.X * b_1.X) + (a_1.Y * b_1.Y)))) >= 0) && (((a_2 = v, (b_2 = y, (a_2.X * b_2.X) + (a_2.Y * b_2.Y)))) >= 0)) && (((a_3 = ((a_4 = p, (b_4 = ((p_2 = p0, (v_2 = y, Pt_$ctor_7B00E9A0(p_2.X + v_2.X, p_2.Y + v_2.Y)))), Vc_$ctor_7B00E9A0(a_4.X - b_4.X, a_4.Y - b_4.Y)))), (b_3 = y, (a_3.X * b_3.X) + (a_3.Y * b_3.Y)))) <= 0)) {
...
export function Rect2D_createFromXVectorAndWidth_645BD0EA(origin, x, sizeY) {
    ...
    return Rect2D_$ctor_50BD42FD(origin, x, (v_1 = ((v = x, Vc_$ctor_7B00E9A0_1(-v.Y, v.X))), (f = sizeY, Vc_$ctor_7B00E9A0(v_1.X * f, v_1.Y * f))));
}
...
export function Rect2D_createFromDirectionAndSizes_2A9F2837(origin, directionX, sizeX, sizeY) {
    ...
    return Rect2D_$ctor_50BD42FD(origin, (a = directionX, (f = sizeX, Vc_$ctor_7B00E9A0(a.X * f, a.Y * f))), (a_1 = ((v = directionX, UnitVc_$ctor_7B00E9A0(-v.Y, v.X))), (f_1 = sizeY, Vc_$ctor_7B00E9A0(a_1.X * f_1, a_1.Y * f_1))));
}
...
export function Rect2D_createFromLine_7E37C061(line, offRight, offLeft) {
    let ln_1, ln_2, a, ln_3, b, v_2, f, v_3, f_1;
    if (-offRight >= offLeft) {
    ...
    return Rect2D_$ctor_50BD42FD((a = ((ln_3 = line, Pt_$ctor_7B00E9A0(ln_3.FromX, ln_3.FromY))), (b = ((v_2 = y_1, (f = (offRight / len), Vc_$ctor_7B00E9A0(v_2.X * f, v_2.Y * f)))), Pt_$ctor_7B00E9A0(a.X - b.X, a.Y - b.Y))), x, (v_3 = y_1, (f_1 = ((offLeft + offRight) / len), Vc_$ctor_7B00E9A0(v_3.X * f_1, v_3.Y * f_1))));
}
...
export function Rect2D_createFromDirAndPoints(dirX, pts) {
    let v, x, y, p, v_1, p_1, v_3, v_2, ln_1, ln_2, ln_4, ln_5, ln_7, ln_8, ln_10, ln_11, p_8, p_7, v_5, v_4, ln_12, ln_13, ln_14, f, v_7, v_6, ln_15, ln_16, ln_17, f_1;
    ...
    return Rect2D_$ctor_50BD42FD((p_8 = ((p_7 = p0, (v_5 = ((v_4 = ((ln_12 = x_2, Vc_$ctor_7B00E9A0((ln_13 = ln_12, ln_13.ToX - ln_13.FromX), (ln_14 = ln_12, ln_14.ToY - ln_14.FromY)))), (f = minX, Vc_$ctor_7B00E9A0(v_4.X * f, v_4.Y * f)))), Pt_$ctor_7B00E9A0(p_7.X + v_5.X, p_7.Y + v_5.Y)))), (v_7 = ((v_6 = ((ln_15 = y_1, Vc_$ctor_7B00E9A0((ln_16 = ln_15, ln_16.ToX - ln_16.FromX), (ln_17 = ln_15, ln_17.ToY - ln_17.FromY)))), (f_1 = minY, Vc_$ctor_7B00E9A0(v_6.X * f_1, v_6.Y * f_1)))), Pt_$ctor_7B00E9A0(p_8.X + v_7.X, p_8.Y + v_7.Y))), vx, vy);
}
    ...
    if (!(lx1 > 1E-12) ? true : !(ly1 > 1E-12)) {
        ...
        for (let ix = 0; ix <= (xCount - 1); ix++) {
            ...
            for (let iy = 0; iy <= (yCount - 1); iy++) {
                ...
                setItem(rs, iy, Rect2D_$ctor_50BD42FD((p_1 = ((p = rect.Origin, (v_6 = x_4, Pt_$ctor_7B00E9A0(p.X + v_6.X, p.Y + v_6.Y)))), (v_7 = y_2, Pt_$ctor_7B00E9A0(p_1.X + v_7.X, p_1.Y + v_7.Y))), vx, vy));
            }
            setItem(rss, ix, rs);
        }
        return rss;
...
export function Rect2D_subDivideMinLength_Z549E38D1(rect, xMinLen, yMinLen, xGap, yGap) {
    ...
    return Rect2D_subDivide_5FE3FC8F(rect, ~~(xLen / (xMinLen * 0.9999)), ~~(yLen / (yMinLen * 0.9999)), xGap, yGap);
}
...
export function Rect2D_subDivideMaxLength_Z549E38D1(rect, xMaxLen, yMaxLen, xGap, yGap) {
    let v, x, y, v_1, x_1, y_1;
    return Rect2D_subDivide_5FE3FC8F(rect, 1 + ~~(((v = rect.Xaxis, (x = v.X, (y = v.Y, Math.sqrt((x * x) + (y * y)))))) / (xMaxLen * 1.00001)), 1 + ~~(((v_1 = rect.Yaxis, (x_1 = v_1.X, (y_1 = v_1.Y, Math.sqrt((x_1 * x_1) + (y_1 * y_1)))))) / (yMaxLen * 1.00001)), xGap, yGap);
}
...
export function Rect2D_grid_638FCC2F(rect, xCount, yCount) {
    ...
    for (let ix = 0; ix <= (xCount - 1); ix++) {
        ...
        for (let iy = 0; iy <= (yCount - 1); iy++) {
            ...
            const f_1 = (ly1 * iy) / yl;
            y_2 = Vc_$ctor_7B00E9A0(v_3.X * f_1, v_3.Y * f_1);
            setItem(rs, iy, (p_1 = ((p = rect.Origin, (v_4 = x_2, Pt_$ctor_7B00E9A0(p.X + v_4.X, p.Y + v_4.Y)))), (v_5 = y_2, Pt_$ctor_7B00E9A0(p_1.X + v_5.X, p_1.Y + v_5.Y))));
        }
        setItem(rss, ix, rs);
    }
    return rss;
...
export function Rect2D_gridMinLength_ZFDE0F31(rect, xMinLen, yMinLen) {
    ...
    return Rect2D_grid_638FCC2F(rect, 1 + ~~(xLen / (xMinLen * 0.9999)), 1 + ~~(yLen / (yMinLen * 0.9999)));
}
...
export function Rect2D_gridMaxLength_ZFDE0F31(rect, xMaxLen, yMaxLen) {
    let v, x, y, v_1, x_1, y_1;
    return Rect2D_grid_638FCC2F(rect, 2 + ~~(((v = rect.Xaxis, (x = v.X, (y = v.Y, Math.sqrt((x * x) + (y * y)))))) / (xMaxLen * 1.00001)), 2 + ~~(((v_1 = rect.Yaxis, (x_1 = v_1.X, (y_1 = v_1.Y, Math.sqrt((x_1 * x_1) + (y_1 * y_1)))))) / (yMaxLen * 1.00001)));
}
