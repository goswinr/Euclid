...
export function Quaternion__setAngleInRadians_5E38073B(q, angleInRadians) {
    ...
    const sa = (1 / length) * Math.sin(angHalf);
...
export function Quaternion_createVecToVec_5A694120(vecFrom, vecTo) {
    let v_1, a, b, v_3, a_1, b_1, a_2, b_2;
    let fu;
    const x = vecFrom.X;
    const y = vecFrom.Y;
    const z = vecFrom.Z;
    ...
    if (((v_1 = ((a = fu, (b = tu, Vec_$ctor_Z7AD9E565(a.X - b.X, a.Y - b.Y, a.Z - b.Z)))), ((v_1.X * v_1.X) + (v_1.Y * v_1.Y)) + (v_1.Z * v_1.Z))) < 1E-24) {
        return Quaternion_$ctor_77D16AC0(0, 0, 0, 1);
    }
    else {
        if (!(((v_3 = ((a_1 = fu, (b_1 = tu, Vec_$ctor_Z7AD9E565(a_1.X + b_1.X, a_1.Y + b_1.Y, a_1.Z + b_1.Z)))), ((v_3.X * v_3.X) + (v_3.Y * v_3.Y)) + (v_3.Z * v_3.Z))) > 1E-12)) {
