...
export function Euclid_Line2D__Line2D_RayClosestParameter_6ADE94FD(ln, pt) {
    ...
    return ((x * (ln.FromX - pt.X)) + (y * (ln.FromY - pt.Y))) / lenSq;
}
...
export function Euclid_Line2D__Line2D_RayClosestPoint_6ADE94FD(ln, pt) {
    ...
    const t = ((x * (fromX - pt.X)) + (y * (fromY - pt.Y))) / lenSq;
    return Pt_$ctor_7B00E9A0(fromX - (x * t), fromY - (y * t));
}
...
export function Euclid_Line2D__Line2D_ClosestPoint_6ADE94FD(ln, p) {
    ...
    const dot = (x * (ln_1.FromX - p_1.X)) + (y * (ln_1.FromY - p_1.Y));
    const lenSq = (x * x) + (y * y);
    if (!(lenSq > 1E-12)) {
        p_2 = ((dot < 0) ? 0 : 1);
    }
...
export function Euclid_Line2D__Line2D_ClosestPoints_4CC2E301(lnA, lnB) {
    let ln, ln_1, ln_2, ln_3, ln_4, ln_5, ln_6, ln_7, pAx, pAy, vAx, ln_8, vAy, ln_9, t, vAx_1, vAy_1, ln_10, pAx_2, pAy_2, vAx_2, ln_11, vAy_2, ln_12, t_1, vAx_3, vAy_3, ln_13;
    let matchValue;
    const lineA = lnA;
    const lineB = lnB;
    ...
    switch (matchValue.tag) {
        ...
        case 3:
            return [(ln_6 = lnA, Pt_$ctor_7B00E9A0_1(ln_6.FromX, ln_6.FromY)), (ln_7 = lnB, (pAx = ln_7.FromX, (pAy = ln_7.FromY, (vAx = ((ln_8 = ln_7, ln_8.ToX - ln_8.FromX)), (vAy = ((ln_9 = ln_7, ln_9.ToY - ln_9.FromY)), (t = ((vAx_1 = vAx, (vAy_1 = vAy, ((vAx_1 * (lnA.FromX - pAx)) + (vAy_1 * (lnA.FromY - pAy))) / ((vAx_1 * vAx_1) + (vAy_1 * vAy_1))))), (t > -1E-06) ? ((t < 1.000001) ? Pt_$ctor_7B00E9A0_1(pAx + (vAx * t), pAy + (vAy * t)) : Pt_$ctor_7B00E9A0_1(pAx + vAx, pAy + vAy)) : Pt_$ctor_7B00E9A0_1(pAx, pAy)))))))];
        case 4:
            return [(ln_10 = lnA, (pAx_2 = ln_10.FromX, (pAy_2 = ln_10.FromY, (vAx_2 = ((ln_11 = ln_10, ln_11.ToX - ln_11.FromX)), (vAy_2 = ((ln_12 = ln_10, ln_12.ToY - ln_12.FromY)), (t_1 = ((vAx_3 = vAx_2, (vAy_3 = vAy_2, ((vAx_3 * (lnB.FromX - pAx_2)) + (vAy_3 * (lnB.FromY - pAy_2))) / ((vAx_3 * vAx_3) + (vAy_3 * vAy_3))))), (t_1 > -1E-06) ? ((t_1 < 1.000001) ? Pt_$ctor_7B00E9A0_1(pAx_2 + (vAx_2 * t_1), pAy_2 + (vAy_2 * t_1)) : Pt_$ctor_7B00E9A0_1(pAx_2 + vAx_2, pAy_2 + vAy_2)) : Pt_$ctor_7B00E9A0_1(pAx_2, pAy_2))))))), (ln_13 = lnB, Pt_$ctor_7B00E9A0_1(ln_13.FromX, ln_13.FromY))];
        default:
            return [matchValue.fields[0], matchValue.fields[1]];
    }
}
...
export function Euclid_Line2D__Line2D_ClosestParameters_4CC2E301(lnA, lnB) {
    let ln, ln_1, ln_2, ln_3, ln_4, x_2, vAx, ln_5, vAy, ln_6, ln_7, x_5, vAx_1, ln_8, vAy_1, ln_9;
    let matchValue;
    const lineA = lnA;
    const lineB = lnB;
    ...
    switch (matchValue.tag) {
        ...
        case 5:
            return [0, 0];
        case 3:
            return [0, (ln_4 = lnB, (x_2 = ((vAx = ((ln_5 = ln_4, ln_5.ToX - ln_5.FromX)), (vAy = ((ln_6 = ln_4, ln_6.ToY - ln_6.FromY)), ((vAx * (lnA.FromX - ln_4.FromX)) + (vAy * (lnA.FromY - ln_4.FromY))) / ((vAx * vAx) + (vAy * vAy))))), (x_2 > 0) ? ((x_2 < 1) ? x_2 : 1) : 0))];
        case 4:
            return [(ln_7 = lnA, (x_5 = ((vAx_1 = ((ln_8 = ln_7, ln_8.ToX - ln_8.FromX)), (vAy_1 = ((ln_9 = ln_7, ln_9.ToY - ln_9.FromY)), ((vAx_1 * (lnB.FromX - ln_7.FromX)) + (vAy_1 * (lnB.FromY - ln_7.FromY))) / ((vAx_1 * vAx_1) + (vAy_1 * vAy_1))))), (x_5 > 0) ? ((x_5 < 1) ? x_5 : 1) : 0)), 0];
        default:
            return [matchValue.fields[0], matchValue.fields[1]];
    }
}
...
export function Euclid_Line2D__Line2D_SqDistanceRayPoint_6ADE94FD(ln, p) {
    let ln_2;
    const nx = -((ln_2 = ln, ln_2.ToY - ln_2.FromY));
    let ny;
    const ln_1 = ln;
    ny = (ln_1.ToX - ln_1.FromX);
    const lenSq = (nx * nx) + (ny * ny);
    if (!(lenSq > 1E-12)) {
        failTooSmall2("Line2D.SqDistanceRayPoint", ln, p);
    }
    const dot = (nx * (ln.FromX - p.X)) + (ny * (ln.FromY - p.Y));
...
export function Euclid_Line2D__Line2D_SqDistanceFromPoint_6ADE94FD(ln, p) {
    ...
    const vAx_1 = vAx;
    const vAy_1 = vAy;
    t = (((vAx_1 * (x_1 - pAx)) + (vAy_1 * (y_1 - pAy))) / ((vAx_1 * vAx_1) + (vAy_1 * vAy_1)));
    if (t > -1E-06) {
        if (t < 1.000001) {
            const vx = (pAx + (vAx * t)) - x_1;
            const vy = (pAy + (vAy * t)) - y_1;
            return (vx * vx) + (vy * vy);
        }
        else {
            const vx_1 = (pAx + vAx) - x_1;
            const vy_1 = (pAy + vAy) - y_1;
...
export function Euclid_Line2D__Line2D_divide_Static(segments, ln) {
    ...
    if (segments === 1) {
        ...
        for (let i = 1; i <= (segments - 1); i++) {
            const t = i / segments;
            setItem(r, i, Pt_$ctor_7B00E9A0(ln.FromX + (x * t), ln.FromY + (y * t)));
        }
...
export function Euclid_Line2D__Line2D_divideMinLength_Static(minSegmentLength, ln) {
    ...
    return Euclid_Line2D__Line2D_divide_Static(~~(len / (minSegmentLength * 1.000001)), ln);
}
...
export function Euclid_Line2D__Line2D_divideMaxLength_Static(maxSegmentLength, ln) {
    ...
    return Euclid_Line2D__Line2D_divide_Static(~~((len / maxSegmentLength) * 0.999999) + 1, ln);
}
...
export function Euclid_Line2D__Line2D_splitMinLength_Static(gap, minSegmentLength, ln) {
    ...
    return Euclid_Line2D__Line2D_split_Static(gap, ~~((len + gap) / ((minSegmentLength + gap) * 1.000001)), ln);
}
...
export function Euclid_Line2D__Line2D_splitMaxLength_Static(gap, maxSegmentLength, ln) {
    ...
    return Euclid_Line2D__Line2D_split_Static(gap, ~~(((len + gap) / (maxSegmentLength + gap)) * 0.999999) + 1, ln);
}
...
export function Euclid_Line2D__Line2D_divideEvery_Static(dist, l) {
    let ln, x, ln_1, y, ln_2, ln_3, ln_4, ln_5, ln_9;
    const div = ((ln = l, (x = ((ln_1 = ln, ln_1.ToX - ln_1.FromX)), (y = ((ln_2 = ln, ln_2.ToY - ln_2.FromY)), Math.sqrt((x * x) + (y * y)))))) / dist;
...
export function Euclid_Line2D__Line2D_divideInsideEvery_Static(dist, l) {
    let ln, x, ln_1, y, ln_2, ln_7, ln_8;
    const div = ((ln = l, (x = ((ln_1 = ln, ln_1.ToX - ln_1.FromX)), (y = ((ln_2 = ln, ln_2.ToY - ln_2.FromY)), Math.sqrt((x * x) + (y * y)))))) / dist;
    const floor = Math.floor(div);
    if (floor === 0) {
        return [];
...
export function Euclid_Line2D__Line2D_projectOntoRayParam_Static(rayToProjectOnto, lineToProject) {
    ...
    return [((ovx * (lineToProject.FromX - osx)) + (ovy * (lineToProject.FromY - osy))) / lenSq, ((ovx * (lineToProject.ToX - osx)) + (ovy * (lineToProject.ToY - osy))) / lenSq];
}
...
export function Euclid_Line2D__Line2D_projectOntoRay_Static(rayToProjectOnto, lineToProject) {
    ...
    const s = ((ovx * (lineToProject.FromX - osx)) + (ovy * (lineToProject.FromY - osy))) / lenSq;
    const e = ((ovx * (lineToProject.ToX - osx)) + (ovy * (lineToProject.ToY - osy))) / lenSq;
...
export function Euclid_Line2D__Line2D_tryProjectOntoLineParam_Static(onToLine, lineToProject) {
    ...
    const bStartOnA = ((ovx * (lineToProject.FromX - osx)) + (ovy * (lineToProject.FromY - osy))) / lenSq;
    const bEndOnA = ((ovx * (lineToProject.ToX - osx)) + (ovy * (lineToProject.ToY - osy))) / lenSq;
...
export function Euclid_Line2D__Line2D_doIntersectOrOverlap_Static(lnA, lnB) {
    let ln, ln_1, ln_2, ln_3, ln_4, ln_5, ln_6, ln_7, a, b, dx, dy, ln_8, pAx, pAy, vAx, ln_9, vAy, ln_10, x_1, y_1, t, vAx_1, vAy_1, vx, vy, vx_1, vy_1, vX, vY, ln_11, pAx_2, pAy_2, vAx_2, ln_12, vAy_2, ln_13, x_4, y_4, t_1, vAx_3, vAy_3, vx_2, vy_2, vx_1_1, vy_1_1, vX_1, vY_1;
    let matchValue;
    const lnA_1 = lnA;
    const lnB_1 = lnB;
    ...
    switch (matchValue.tag) {
        ...
        case 3:
            return ((ln_8 = lnB, (pAx = ln_8.FromX, (pAy = ln_8.FromY, (vAx = ((ln_9 = ln_8, ln_9.ToX - ln_9.FromX)), (vAy = ((ln_10 = ln_8, ln_10.ToY - ln_10.FromY)), (x_1 = lnA.FromX, (y_1 = lnA.FromY, (t = ((vAx_1 = vAx, (vAy_1 = vAy, ((vAx_1 * (x_1 - pAx)) + (vAy_1 * (y_1 - pAy))) / ((vAx_1 * vAx_1) + (vAy_1 * vAy_1))))), (t > -1E-06) ? ((t < 1.000001) ? ((vx = ((pAx + (vAx * t)) - x_1), (vy = ((pAy + (vAy * t)) - y_1), (vx * vx) + (vy * vy)))) : ((vx_1 = ((pAx + vAx) - x_1), (vy_1 = ((pAy + vAy) - y_1), (vx_1 * vx_1) + (vy_1 * vy_1))))) : ((vX = (pAx - x_1), (vY = (pAy - y_1), (vX * vX) + (vY * vY))))))))))))) < 1E-12;
        case 4:
            return ((ln_11 = lnA, (pAx_2 = ln_11.FromX, (pAy_2 = ln_11.FromY, (vAx_2 = ((ln_12 = ln_11, ln_12.ToX - ln_12.FromX)), (vAy_2 = ((ln_13 = ln_11, ln_13.ToY - ln_13.FromY)), (x_4 = lnB.FromX, (y_4 = lnB.FromY, (t_1 = ((vAx_3 = vAx_2, (vAy_3 = vAy_2, ((vAx_3 * (x_4 - pAx_2)) + (vAy_3 * (y_4 - pAy_2))) / ((vAx_3 * vAx_3) + (vAy_3 * vAy_3))))), (t_1 > -1E-06) ? ((t_1 < 1.000001) ? ((vx_2 = ((pAx_2 + (vAx_2 * t_1)) - x_4), (vy_2 = ((pAy_2 + (vAy_2 * t_1)) - y_4), (vx_2 * vx_2) + (vy_2 * vy_2)))) : ((vx_1_1 = ((pAx_2 + vAx_2) - x_4), (vy_1_1 = ((pAy_2 + vAy_2) - y_4), (vx_1_1 * vx_1_1) + (vy_1_1 * vy_1_1))))) : ((vX_1 = (pAx_2 - x_4), (vY_1 = (pAy_2 - y_4), (vX_1 * vX_1) + (vY_1 * vY_1))))))))))))) < 1E-12;
        default:
            return true;
    }
}
...
export function Euclid_Line2D__Line2D_tryIntersectRay_Static(lineA, lineB) {
    ...
    if ((Math.abs(tan) > 0.004363350820701567) && (Math.abs(det) > 1E-10)) {
        const t = (((lineB_1.FromX - pAx) * vBy) - ((lineB_1.FromY - pAy) * vBx)) / det;
        return Pt_$ctor_7B00E9A0_1(pAx + (t * vAx), pAy + (t * vAy));
    }
    else {
        return undefined;
...
export function Euclid_Line2D__Line2D_tryIntersectOrOverlap_Static(lnA, lnB) {
    let ln, ln_1, ln_2, ln_3, nx, ln_5, ny, ln_4, dotN, ln_6, p_1, ln_7, ln_8, a, b, dx, dy, ln_9, ln_10, pAx_1, pAy_1, vAx_1, ln_11, vAy_1, ln_12, x_2, y_2, t, vAx_2, vAy_2, vx, vy, vx_1, vy_1, vX, vY, ln_13, ln_14, pAx_3, pAy_3, vAx_3, ln_15, vAy_3, ln_16, x_5, y_5, t_1, vAx_4, vAy_4, vx_2, vy_2, vx_1_1, vy_1_1, vX_1, vY_1, ln_17;
    let matchValue;
    const lineA = lnA;
    const lineB = lnB;
    ...
    switch (matchValue.tag) {
        case 1:
            return undefined;
        case 2:
            if (((nx = -((ln_5 = lnA, ln_5.ToY - ln_5.FromY)), (ny = ((ln_4 = lnA, ln_4.ToX - ln_4.FromX)), (dotN = ((nx * (lnB.FromX - lnA.FromX)) + (ny * (lnB.FromY - lnA.FromY))), (dotN * dotN) / ((nx * nx) + (ny * ny)))))) < 1E-12) {
                const matchValue_1 = Euclid_Line2D__Line2D_tryProjectOntoLineParam_Static(lnA, lnB);
                if (matchValue_1 == null) {
                    return undefined;
                }
                else {
                    return (ln_6 = lnA, (p_1 = ((matchValue_1[0] + matchValue_1[1]) * 0.5), Pt_$ctor_7B00E9A0(ln_6.FromX + (((ln_7 = ln_6, ln_7.ToX - ln_7.FromX)) * p_1), ln_6.FromY + (((ln_8 = ln_6, ln_8.ToY - ln_8.FromY)) * p_1))));
                }
            }
            else {
                return undefined;
        ...
        case 3:
            if (((ln_10 = lnB, (pAx_1 = ln_10.FromX, (pAy_1 = ln_10.FromY, (vAx_1 = ((ln_11 = ln_10, ln_11.ToX - ln_11.FromX)), (vAy_1 = ((ln_12 = ln_10, ln_12.ToY - ln_12.FromY)), (x_2 = lnA.FromX, (y_2 = lnA.FromY, (t = ((vAx_2 = vAx_1, (vAy_2 = vAy_1, ((vAx_2 * (x_2 - pAx_1)) + (vAy_2 * (y_2 - pAy_1))) / ((vAx_2 * vAx_2) + (vAy_2 * vAy_2))))), (t > -1E-06) ? ((t < 1.000001) ? ((vx = ((pAx_1 + (vAx_1 * t)) - x_2), (vy = ((pAy_1 + (vAy_1 * t)) - y_2), (vx * vx) + (vy * vy)))) : ((vx_1 = ((pAx_1 + vAx_1) - x_2), (vy_1 = ((pAy_1 + vAy_1) - y_2), (vx_1 * vx_1) + (vy_1 * vy_1))))) : ((vX = (pAx_1 - x_2), (vY = (pAy_1 - y_2), (vX * vX) + (vY * vY))))))))))))) < 1E-12) {
        ...
        case 4:
            if (((ln_14 = lnA, (pAx_3 = ln_14.FromX, (pAy_3 = ln_14.FromY, (vAx_3 = ((ln_15 = ln_14, ln_15.ToX - ln_15.FromX)), (vAy_3 = ((ln_16 = ln_14, ln_16.ToY - ln_16.FromY)), (x_5 = lnB.FromX, (y_5 = lnB.FromY, (t_1 = ((vAx_4 = vAx_3, (vAy_4 = vAy_3, ((vAx_4 * (x_5 - pAx_3)) + (vAy_4 * (y_5 - pAy_3))) / ((vAx_4 * vAx_4) + (vAy_4 * vAy_4))))), (t_1 > -1E-06) ? ((t_1 < 1.000001) ? ((vx_2 = ((pAx_3 + (vAx_3 * t_1)) - x_5), (vy_2 = ((pAy_3 + (vAy_3 * t_1)) - y_5), (vx_2 * vx_2) + (vy_2 * vy_2)))) : ((vx_1_1 = ((pAx_3 + vAx_3) - x_5), (vy_1_1 = ((pAy_3 + vAy_3) - y_5), (vx_1_1 * vx_1_1) + (vy_1_1 * vy_1_1))))) : ((vX_1 = (pAx_3 - x_5), (vY_1 = (pAy_3 - y_5), (vX_1 * vX_1) + (vY_1 * vY_1))))))))))))) < 1E-12) {
...
export function Euclid_Line2D__Line2D_tryGetOverlap_Static(lnA, lnB) {
    let ln_1, ln_2, ln_4, ln_5, nx, ln_7, ny, ln_6, dotN;
    let va;
    const ln = lnA;
    ...
    if (((Math.abs(va.X) + Math.abs(va.Y)) < 1E-06) ? true : ((Math.abs(vb.X) + Math.abs(vb.Y)) < 1E-06)) {
        ...
        const vBx = vb.X;
        const vBy = vb.Y;
        tan = (((vAx * vBy) - (vAy * vBx)) / ((vAx * vBx) + (vAy * vBy)));
        if (Math.abs(tan) < 0.004363350820701567) {
            if (((nx = -((ln_7 = lnA, ln_7.ToY - ln_7.FromY)), (ny = ((ln_6 = lnA, ln_6.ToX - ln_6.FromX)), (dotN = ((nx * (lnB.FromX - lnA.FromX)) + (ny * (lnB.FromY - lnA.FromY))), (dotN * dotN) / ((nx * nx) + (ny * ny)))))) < 1E-09) {
