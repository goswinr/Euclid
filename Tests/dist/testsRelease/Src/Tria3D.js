...
export function Tria3D_isLinear_Z305FC6B8(a, b, c, distanceTolerance = 1E-06) {
    let tupledArg, lnFrom, lnTo, p, x, y, z, t, u$0027, v$0027, w$0027, tupledArg_1, lnFrom_1, lnTo_1, p_1, x_1, y_1, z_1, t_1, u$0027_1, v$0027_1, w$0027_1, tupledArg_2, lnFrom_2, lnTo_2, p_2, x_2, y_2, z_2, t_2, u$0027_2, v$0027_2, w$0027_2;
    let ab;
    const a_1 = b;
    const b_1 = a;
    ...
    if (((abLenSq < distSq) ? true : (bcLenSq < distSq)) ? true : (caLenSq < distSq)) {
        ...
        if ((dotA > dotB) && (dotA > dotC)) {
            return ((tupledArg = [b, c, a, bcLenSq], (lnFrom = tupledArg[0], (lnTo = tupledArg[1], (p = tupledArg[2], (x = (lnFrom.X - lnTo.X), (y = (lnFrom.Y - lnTo.Y), (z = (lnFrom.Z - lnTo.Z), (t = ((((x * (lnFrom.X - p.X)) + (y * (lnFrom.Y - p.Y))) + (z * (lnFrom.Z - p.Z))) / tupledArg[3]), (u$0027 = ((lnFrom.X - (x * t)) - p.X), (v$0027 = ((lnFrom.Y - (y * t)) - p.Y), (w$0027 = ((lnFrom.Z - (z * t)) - p.Z), ((u$0027 * u$0027) + (v$0027 * v$0027)) + (w$0027 * w$0027))))))))))))) < distSq;
        }
        else if ((dotB > dotA) && (dotB > dotC)) {
            return ((tupledArg_1 = [c, a, b, caLenSq], (lnFrom_1 = tupledArg_1[0], (lnTo_1 = tupledArg_1[1], (p_1 = tupledArg_1[2], (x_1 = (lnFrom_1.X - lnTo_1.X), (y_1 = (lnFrom_1.Y - lnTo_1.Y), (z_1 = (lnFrom_1.Z - lnTo_1.Z), (t_1 = ((((x_1 * (lnFrom_1.X - p_1.X)) + (y_1 * (lnFrom_1.Y - p_1.Y))) + (z_1 * (lnFrom_1.Z - p_1.Z))) / tupledArg_1[3]), (u$0027_1 = ((lnFrom_1.X - (x_1 * t_1)) - p_1.X), (v$0027_1 = ((lnFrom_1.Y - (y_1 * t_1)) - p_1.Y), (w$0027_1 = ((lnFrom_1.Z - (z_1 * t_1)) - p_1.Z), ((u$0027_1 * u$0027_1) + (v$0027_1 * v$0027_1)) + (w$0027_1 * w$0027_1))))))))))))) < distSq;
        }
        else {
            return ((tupledArg_2 = [a, b, c, abLenSq], (lnFrom_2 = tupledArg_2[0], (lnTo_2 = tupledArg_2[1], (p_2 = tupledArg_2[2], (x_2 = (lnFrom_2.X - lnTo_2.X), (y_2 = (lnFrom_2.Y - lnTo_2.Y), (z_2 = (lnFrom_2.Z - lnTo_2.Z), (t_2 = ((((x_2 * (lnFrom_2.X - p_2.X)) + (y_2 * (lnFrom_2.Y - p_2.Y))) + (z_2 * (lnFrom_2.Z - p_2.Z))) / tupledArg_2[3]), (u$0027_2 = ((lnFrom_2.X - (x_2 * t_2)) - p_2.X), (v$0027_2 = ((lnFrom_2.Y - (y_2 * t_2)) - p_2.Y), (w$0027_2 = ((lnFrom_2.Z - (z_2 * t_2)) - p_2.Z), ((u$0027_2 * u$0027_2) + (v$0027_2 * v$0027_2)) + (w$0027_2 * w$0027_2))))))))))))) < distSq;
        }
    }
}
...
export function Tria3D_offsetPnt_Z305FC6B8(pntToOffset, prev, next, dist) {
    ...
    if (!(((v = perp, ((v.X * v.X) + (v.Y * v.Y)) + (v.Z * v.Z))) > 1E-24)) {
...
export function Tria3D_offset_Z305FC6B8(a, b, c, dist) {
    let v, pt_1, nPrev_1, nNext_1, perp_2, cosine_1, a_8, b_8, dirPrev, v_9, a_11, b_11, l_3, v_10, a_12, f_3, dirNext, v_12, a_13, b_12, l_4, v_13, a_14, f_4, p_1, p, v_14, v_15, p_2, v_16, a_16, a_15, b_13, f_5, pt_4, nPrev_4, nNext_4, perp_4, cosine_4, dirPrev_1, v_19, a_17, b_14, l_5, v_20, a_18, f_6, dirNext_1, v_22, a_19, b_15, l_6, v_23, a_20, f_7, p_4, p_3, v_24, v_25, p_5, v_26, a_22, a_21, b_16, f_8, pt_7, nPrev_7, nNext_7, perp_6, cosine_7, dirPrev_2, v_29, a_23, b_17, l_7, v_30, a_24, f_9, dirNext_2, v_32, a_25, b_18, l_8, v_33, a_26, f_10, p_7, p_6, v_34, v_35, p_8, v_36, a_28, a_27, b_19, f_11;
    let vAB;
    const a_1 = b;
    const b_1 = a;
...
export function Tria3D_offsetVar_Z62609A8D(ptToOffset, prev, next, distPrev, distNext) {
    ...
    if (!(lenPerpSq > 1E-24)) {
        ...
        return (p_2 = lnAFrom, (v_7 = ((a_8 = nPrevU, (f_5 = (((b_5 * (((bx * vx) + (by * vy)) + (bz * vz))) - (((ax * vx) + (ay * vy)) + (az * vz))) / (1 - (b_5 * b_5))), Vec_$ctor_Z7AD9E565(a_8.X * f_5, a_8.Y * f_5, a_8.Z * f_5)))), Pnt_$ctor_Z7AD9E565(p_2.X + v_7.X, p_2.Y + v_7.Y, p_2.Z + v_7.Z)));
    }
}
...
export function Tria3D_intersectLine_Z60F2B6CD(line, p1, p2, p3) {
    let x, tupledArg, a, a_1, a_4, a_2, b_2, b_4, a_3, b_3, b_1, a_5, b_5, x_1, tupledArg_1, a_6, a_7, a_10, a_8, b_8, b_10, a_9, b_9, b_7, a_11, b_11, x_4, tupledArg_4, a_24, a_25, a_28, a_26, b_26, b_28, a_27, b_27, b_25, a_29, b_29, a_35, a_36, b_36, b_35, x_6, p, v_1, a_37, f;
    let q1;
    const ln = line;
    ...
    if (((x = ((tupledArg = [q1, p1, p2, p3], (a = tupledArg[0], (a_1 = ((a_4 = ((a_2 = tupledArg[1], (b_2 = a, Vec_$ctor_Z7AD9E565(a_2.X - b_2.X, a_2.Y - b_2.Y, a_2.Z - b_2.Z)))), (b_4 = ((a_3 = tupledArg[2], (b_3 = a, Vec_$ctor_Z7AD9E565(a_3.X - b_3.X, a_3.Y - b_3.Y, a_3.Z - b_3.Z)))), Vec_$ctor_Z7AD9E565((a_4.Y * b_4.Z) - (a_4.Z * b_4.Y), (a_4.Z * b_4.X) - (a_4.X * b_4.Z), (a_4.X * b_4.Y) - (a_4.Y * b_4.X))))), (b_1 = ((a_5 = tupledArg[3], (b_5 = a, Vec_$ctor_Z7AD9E565(a_5.X - b_5.X, a_5.Y - b_5.Y, a_5.Z - b_5.Z)))), ((a_1.X * b_1.X) + (a_1.Y * b_1.Y)) + (a_1.Z * b_1.Z)))))), (x === 0) ? 0 : ((x > 0) ? 1 : -1))) === ((x_1 = ((tupledArg_1 = [q2, p1, p2, p3], (a_6 = tupledArg_1[0], (a_7 = ((a_10 = ((a_8 = tupledArg_1[1], (b_8 = a_6, Vec_$ctor_Z7AD9E565(a_8.X - b_8.X, a_8.Y - b_8.Y, a_8.Z - b_8.Z)))), (b_10 = ((a_9 = tupledArg_1[2], (b_9 = a_6, Vec_$ctor_Z7AD9E565(a_9.X - b_9.X, a_9.Y - b_9.Y, a_9.Z - b_9.Z)))), Vec_$ctor_Z7AD9E565((a_10.Y * b_10.Z) - (a_10.Z * b_10.Y), (a_10.Z * b_10.X) - (a_10.X * b_10.Z), (a_10.X * b_10.Y) - (a_10.Y * b_10.X))))), (b_7 = ((a_11 = tupledArg_1[3], (b_11 = a_6, Vec_$ctor_Z7AD9E565(a_11.X - b_11.X, a_11.Y - b_11.Y, a_11.Z - b_11.Z)))), ((a_7.X * b_7.X) + (a_7.Y * b_7.Y)) + (a_7.Z * b_7.Z)))))), (x_1 === 0) ? 0 : ((x_1 > 0) ? 1 : -1)))) {
        return undefined;
    }
    else {
        let s3;
        ...
        if ((s3 === s4) && (s4 === ((x_4 = ((tupledArg_4 = [q1, q2, p3, p1], (a_24 = tupledArg_4[0], (a_25 = ((a_28 = ((a_26 = tupledArg_4[1], (b_26 = a_24, Vec_$ctor_Z7AD9E565(a_26.X - b_26.X, a_26.Y - b_26.Y, a_26.Z - b_26.Z)))), (b_28 = ((a_27 = tupledArg_4[2], (b_27 = a_24, Vec_$ctor_Z7AD9E565(a_27.X - b_27.X, a_27.Y - b_27.Y, a_27.Z - b_27.Z)))), Vec_$ctor_Z7AD9E565((a_28.Y * b_28.Z) - (a_28.Z * b_28.Y), (a_28.Z * b_28.X) - (a_28.X * b_28.Z), (a_28.X * b_28.Y) - (a_28.Y * b_28.X))))), (b_25 = ((a_29 = tupledArg_4[3], (b_29 = a_24, Vec_$ctor_Z7AD9E565(a_29.X - b_29.X, a_29.Y - b_29.Y, a_29.Z - b_29.Z)))), ((a_25.X * b_25.X) + (a_25.Y * b_25.Y)) + (a_25.Z * b_25.Z)))))), (x_4 === 0) ? 0 : ((x_4 > 0) ? 1 : -1))))) {
            let n;
            let a_32;
            const a_30 = p2;
            const b_30 = p1;
