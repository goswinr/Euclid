...
export class Box extends Record {
    ...
    toString() {
        let v, v_1, v_2;
        const b = this;
        return `Euclid.Box ${float((v = b.Xaxis, Math.sqrt(((v.X * v.X) + (v.Y * v.Y)) + (v.Z * v.Z))))} x ${float((v_1 = b.Yaxis, Math.sqrt(((v_1.X * v_1.X) + (v_1.Y * v_1.Y)) + (v_1.Z * v_1.Z))))} x ${float((v_2 = b.Zaxis, Math.sqrt(((v_2.X * v_2.X) + (v_2.Y * v_2.Y)) + (v_2.Z * v_2.Z))))} (Origin:${Pnt__get_AsString(b.Origin)}| X-ax:${Vec__get_AsString(b.Xaxis)}|Y-ax:${Vec__get_AsString(b.Yaxis)}|Z-ax:${Vec__get_AsString(b.Zaxis)})`;
    }
}
...
export function Box__get_AsString(b) {
    let v, v_1, v_2;
    return `${float((v = b.Xaxis, Math.sqrt(((v.X * v.X) + (v.Y * v.Y)) + (v.Z * v.Z))))} x ${float((v_1 = b.Yaxis, Math.sqrt(((v_1.X * v_1.X) + (v_1.Y * v_1.Y)) + (v_1.Z * v_1.Z))))} x ${float((v_2 = b.Zaxis, Math.sqrt(((v_2.X * v_2.X) + (v_2.Y * v_2.Y)) + (v_2.Z * v_2.Z))))}`;
}
...
export function Box__get_BBox(b) {
    ...
    return BBox_$ctor_76A78260(min(min(min(min(min(min(min(p0.X, p1.X), p2.X), p3.X), p4.X), p5.X), p6.X), p7.X), min(min(min(min(min(min(min(p0.Y, p1.Y), p2.Y), p3.Y), p4.Y), p5.Y), p6.Y), p7.Y), min(min(min(min(min(min(min(p0.Z, p1.Z), p2.Z), p3.Z), p4.Z), p5.Z), p6.Z), p7.Z), max(max(max(max(max(max(max(p0.X, p1.X), p2.X), p3.X), p4.X), p5.X), p6.X), p7.X), max(max(max(max(max(max(max(p0.Y, p1.Y), p2.Y), p3.Y), p4.Y), p5.Y), p6.Y), p7.Y), max(max(max(max(max(max(max(p0.Z, p1.Z), p2.Z), p3.Z), p4.Z), p5.Z), p6.Z), p7.Z));
}
...
export function Box_createFromDirsAndPoints(dirX, dirY, pts) {
    ...
    return Box_createFromPlaneAndPoints(Euclid_PPlane__PPlane_createOriginXaxisYaxis_Static_6181AF53(item(0, pts), dirX, dirY), pts);
}
