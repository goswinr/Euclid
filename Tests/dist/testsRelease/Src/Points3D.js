...
export function Points3D_mostDistantPoint_Z1881DE00(findPointFrom, checkAgainst) {
    return item(Points3D_mostDistantPointIdx_Z1881DE00(findPointFrom, checkAgainst)[0], findPointFrom);
}
...
export function Points3D_normalOfPoints_Z16D69110(pts) {
    ...
    if (count(pts) === 3) {
        ...
        a_3 = Vec_$ctor_Z7AD9E565(a_2.X - b_1.X, a_2.Y - b_1.Y, a_2.Z - b_1.Z);
        const b_3 = a_1;
