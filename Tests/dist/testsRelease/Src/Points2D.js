...
export function Points2D_closestOfTwo(pt1, pt2, referencePoint) {
    let a_1, b_1, vx, vy, a_3, b_3, vx_1, vy_1;
    if (((a_1 = pt1, (b_1 = referencePoint, (vx = (a_1.X - b_1.X), (vy = (a_1.Y - b_1.Y), (vx * vx) + (vy * vy)))))) <= ((a_3 = pt2, (b_3 = referencePoint, (vx_1 = (a_3.X - b_3.X), (vy_1 = (a_3.Y - b_3.Y), (vx_1 * vx_1) + (vy_1 * vy_1))))))) {
        return pt1;
    }
    else {
        return pt2;
...
export function Points2D_minDistBetweenPointSets_6A06E040(xs, ys) {
    ...
    const a_1 = item(patternInput[0], xs);
    const b_1 = item(patternInput[1], ys);
    const vx = a_1.X - b_1.X;
    const vy = a_1.Y - b_1.Y;
...
export function Points2D_mostDistantPoint_6A06E040(findPointFrom, checkAgainst) {
    return item(Points2D_mostDistantPointIdx_6A06E040(findPointFrom, checkAgainst)[0], findPointFrom);
}
...
export function Points2D_findContinuousPoints_53EC9D26(ptss, tolGap) {
    let res;
    const this$ = ptss;
    const index = ResizeArr_maxIndexBy((xs) => (xs.length | 0), ptss) | 0;
    ...
    while (loop && (ptss.length > 0)) {
        ...
        if ((sd < tolGap) && (sd < ed)) {
            addRangeInPlace((this$_5 = ptss, (index_1 = (si | 0), (v_1 = item(index_1, this$_5), (this$_5.splice(index_1, 1), v_1)))), res);
        }
        else if ((ed < tolGap) && (ed < sd)) {
            addRangeInPlace(ResizeArr_rev((this$_6 = ptss, (index_2 = (ei | 0), (v_2 = item(index_2, this$_6), (this$_6.splice(index_2, 1), v_2))))), res);
        }
        else {
            const start = item(0, res);
            const si_1 = ResizeArr_minIndexBy((ps_2) => {
                const a_9 = start;
                const b_9 = item(0, ps_2);
            ...
            let sd_1;
            const a_13 = start;
            const b_13 = item(0, item(si_1, ptss));
            ...
            if ((sd_1 < tolGap) && (sd_1 < ed_1)) {
                insertRangeInPlace(0, ResizeArr_rev((this$_11 = ptss, (index_3 = (si_1 | 0), (v_3 = item(index_3, this$_11), (this$_11.splice(index_3, 1), v_3))))), res);
            }
            else if ((ed_1 < tolGap) && (ed_1 < sd_1)) {
                insertRangeInPlace(0, (this$_12 = ptss, (index_4 = (ei_1 | 0), (v_4 = item(index_4, this$_12), (this$_12.splice(index_4, 1), v_4)))), res);
            }
            else {
                loop = false;
            }
