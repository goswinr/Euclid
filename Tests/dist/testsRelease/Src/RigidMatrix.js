...
export function RigidMatrix__get_Determinant(m) {
    return Matrix__get_Determinant(RigidMatrix__get_Matrix(m));
}
...
export function RigidMatrix_createPlaneToPlane_3B6074E0(fromPlane, toPlane) {
    return RigidMatrix_multiply_Z31732520(RigidMatrix__get_Inverse(RigidMatrix_createToPlane_2F29039F(fromPlane)), RigidMatrix_createToPlane_2F29039F(toPlane));
}
