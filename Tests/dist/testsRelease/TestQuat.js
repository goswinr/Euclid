...
${Pnt__get_AsString(a_2)}`);
        ...
        a_5 = Pnt_$ctor_Z7AD9E565_1(((x_2 + (qw_1 * tx_1)) + (qy_1 * tz_1)) - (qz_1 * ty_1), ((y_2 + (qw_1 * ty_1)) + (qz_1 * tx_1)) - (qx_1 * tz_1), ((z_2 + (qw_1 * tz_1)) + (qx_1 * ty_1)) - (qy_1 * tx_1));
        const b_4 = expected;
...
${Pnt__get_AsString(a_10)}`);
        ...
        a_13 = Pnt_$ctor_Z7AD9E565_1(((x_6 + (qw_3 * tx_3)) + (qy_3 * tz_3)) - (qz_3 * ty_3), ((y_6 + (qw_3 * ty_3)) + (qz_3 * tx_3)) - (qx_3 * tz_3), ((z_6 + (qw_3 * tz_3)) + (qx_3 * ty_3)) - (qy_3 * tx_3));
...
${Pnt__get_AsString(a_17)}`);
        ...
        a_20 = Pnt_$ctor_Z7AD9E565_1(((x_10 + (qw_5 * tx_5)) + (qy_5 * tz_5)) - (qz_5 * ty_5), ((y_10 + (qw_5 * ty_5)) + (qz_5 * tx_5)) - (qx_5 * tz_5), ((z_10 + (qw_5 * tz_5)) + (qx_5 * ty_5)) - (qy_5 * tx_5));
...
${Pnt__get_AsString(a_20)}`);
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_3, Test_TestCaseBuilder__Delay_1505(builder$0040_3, () => {
        ...
        b_22 = Pnt_$ctor_Z7AD9E565_1(((x_14 + (qw_7 * tx_7)) + (qy_7 * tz_7)) - (qz_7 * ty_7), ((y_14 + (qw_7 * ty_7)) + (qz_7 * tx_7)) - (qx_7 * tz_7), ((z_14 + (qw_7 * tz_7)) + (qx_7 * ty_7)) - (qy_7 * tx_7));
...
${Pnt__get_AsString(a_25)}`);
        ...
        b_25 = Pnt_$ctor_Z7AD9E565_1(((x_17 + (qw_9 * tx_9)) + (qy_9 * tz_9)) - (qz_9 * ty_9), ((y_17 + (qw_9 * ty_9)) + (qz_9 * tx_9)) - (qx_9 * tz_9), ((z_17 + (qw_9 * tz_9)) + (qx_9 * ty_9)) - (qy_9 * tx_9));
...
${Pnt__get_AsString(a_28)}`);
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_4, Test_TestCaseBuilder__Delay_1505(builder$0040_4, () => {
        ...
        let a_32;
        const p_10 = Pnt_$ctor_Z7AD9E565(5, 3, 7);
        const q_26 = q_25;
        const x_19 = p_10.X;
        const y_19 = p_10.Y;
        const z_19 = p_10.Z;
        ...
        a_32 = Pnt_$ctor_Z7AD9E565_1(((x_19 + (qw_10 * tx_10)) + (qy_10 * tz_10)) - (qz_10 * ty_10), ((y_19 + (qw_10 * ty_10)) + (qz_10 * tx_10)) - (qx_10 * tz_10), ((z_19 + (qw_10 * tz_10)) + (qx_10 * ty_10)) - (qy_10 * tx_10));
        const b_29 = Pnt_$ctor_Z7AD9E565(-5, -3, 7);
...
${Pnt__get_AsString(a_32)}`);
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_5, Test_TestCaseBuilder__Delay_1505(builder$0040_5, () => {
        ...
        let b_32;
        const p_11 = Pnt_$ctor_Z7AD9E565(1, 0, 0);
        const q_28 = q_27;
        const x_21 = p_11.X;
        const y_21 = p_11.Y;
        const z_21 = p_11.Z;
        ...
        const a_36 = b_32;
        const b_33 = Pnt_$ctor_Z7AD9E565(sqrt2_2, sqrt2_2, 0);
...
${Pnt__get_AsString(a_36)}`);
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_6, Test_TestCaseBuilder__Delay_1505(builder$0040_6, () => {
        ...
        const q_29 = Quaternion_createFromRadians_Z3D1F83EE(Vec_$ctor_Z7AD9E565_2(1, 1, 1), 0.017453292519943295 * 120);
        let a_40;
        const p_12 = Pnt_$ctor_Z7AD9E565(1, 0, 0);
        const q_30 = q_29;
        const x_23 = p_12.X;
        const y_23 = p_12.Y;
        const z_23 = p_12.Z;
        ...
        a_40 = Pnt_$ctor_Z7AD9E565_1(((x_23 + (qw_12 * tx_12)) + (qy_12 * tz_12)) - (qz_12 * ty_12), ((y_23 + (qw_12 * ty_12)) + (qz_12 * tx_12)) - (qx_12 * tz_12), ((z_23 + (qw_12 * tz_12)) + (qx_12 * ty_12)) - (qy_12 * tx_12));
        const b_37 = Pnt_$ctor_Z7AD9E565(0, 1, 0);
...
${Pnt__get_AsString(a_40)}`);
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_7, Test_TestCaseBuilder__Delay_1505(builder$0040_7, () => {
        ...
        const qCombined = Quaternion_multiply_400F31E0(Quaternion_createFromRadians_Z3D1F83EE(Vec_$ctor_Z7AD9E565(0, 0, 1), 0.017453292519943295 * 45), Quaternion_createFromRadians_Z3D1F83EE(Vec_$ctor_Z7AD9E565(0, 0, 1), 0.017453292519943295 * 45));
        ...
        a_44 = Pnt_$ctor_Z7AD9E565_1(((x_25 + (qw_13 * tx_13)) + (qy_13 * tz_13)) - (qz_13 * ty_13), ((y_25 + (qw_13 * ty_13)) + (qz_13 * tx_13)) - (qx_13 * tz_13), ((z_25 + (qw_13 * tz_13)) + (qx_13 * ty_13)) - (qy_13 * tx_13));
        let b_40;
        const p_14 = a_43;
        const q_32 = qDirect;
        const x_26 = p_14.X;
        ...
        b_40 = Pnt_$ctor_Z7AD9E565_1(((x_26 + (qw_14 * tx_14)) + (qy_14 * tz_14)) - (qz_14 * ty_14), ((y_26 + (qw_14 * ty_14)) + (qz_14 * tx_14)) - (qx_14 * tz_14), ((z_26 + (qw_14 * tz_14)) + (qx_14 * ty_14)) - (qy_14 * tx_14));
...
${Pnt__get_AsString(a_44)}`);
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_8, Test_TestCaseBuilder__Delay_1505(builder$0040_8, () => {
        ...
        b_44 = Pnt_$ctor_Z7AD9E565_1(((x_29 + (qw_15 * tx_15)) + (qy_15 * tz_15)) - (qz_15 * ty_15), ((y_29 + (qw_15 * ty_15)) + (qz_15 * tx_15)) - (qx_15 * tz_15), ((z_29 + (qw_15 * tz_15)) + (qx_15 * ty_15)) - (qy_15 * tx_15));
...
${Pnt__get_AsString(a_48)}`);
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_10, Test_TestCaseBuilder__Delay_1505(builder$0040_10, () => {
        ...
        const q2_1 = Quaternion__setAngleInRadians_5E38073B(Quaternion_createFromRadians_Z3D1F83EE(Vec_$ctor_Z7AD9E565(0, 0, 1), 0.017453292519943295 * 90), 0.017453292519943295 * 45);
        let result;
        const p_16 = Pnt_$ctor_Z7AD9E565(1, 0, 0);
        const q_41 = q2_1;
        const x_37 = p_16.X;
        const y_33 = p_16.Y;
        const z_31 = p_16.Z;
        ...
        const a_56 = result;
        const b_47 = Pnt_$ctor_Z7AD9E565(sqrt2_2_1, sqrt2_2_1, 0);
...
${Pnt__get_AsString(a_56)}`);
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_11, Test_TestCaseBuilder__Delay_1505(builder$0040_11, () => {
        let v_1, a_59, b_50, v_2, a_60, b_51, a_61, b_52;
        let q_42;
        const vecFrom = UnitVec_$ctor_Z7AD9E565(1, 0, 0);
        const vecTo = UnitVec_$ctor_Z7AD9E565(0, 1, 0);
        if (((v_1 = ((a_59 = vecFrom, (b_50 = vecTo, Vec_$ctor_Z7AD9E565_1(a_59.X - b_50.X, a_59.Y - b_50.Y, a_59.Z - b_50.Z)))), ((v_1.X * v_1.X) + (v_1.Y * v_1.Y)) + (v_1.Z * v_1.Z))) < 1E-24) {
            q_42 = Quaternion_$ctor_77D16AC0(0, 0, 0, 1);
        }
        else {
            if (!(((v_2 = ((a_60 = vecFrom, (b_51 = vecTo, Vec_$ctor_Z7AD9E565_1(a_60.X + b_51.X, a_60.Y + b_51.Y, a_60.Z + b_51.Z)))), ((v_2.X * v_2.X) + (v_2.Y * v_2.Y)) + (v_2.Z * v_2.Z))) > 1E-12)) {
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_13, Test_TestCaseBuilder__Delay_1505(builder$0040_13, () => {
        const patternInput_1 = Quaternion_toEulerAnglesZYX_Z2A007687(Quaternion_createFromEulerZYX_Z7AD9E565(30, 45, 60));
        Expect_floatClose(AccuracyModule_medium, patternInput_1[0], 30, "roundtrip Z");
        Expect_floatClose(AccuracyModule_medium, patternInput_1[1], 45, "roundtrip Y");
        Expect_floatClose(AccuracyModule_medium, patternInput_1[2], 60, "roundtrip X");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_15, Test_TestCaseBuilder__Delay_1505(builder$0040_15, () => {
        ...
        let a_63;
        const p_17 = Pnt_$ctor_Z7AD9E565(1, 0, 0);
        ...
        a_63 = Pnt_$ctor_Z7AD9E565_1(((x_50 + (qw_18 * tx_18)) + (qy_18 * tz_18)) - (qz_18 * ty_18), ((y_45 + (qw_18 * ty_18)) + (qz_18 * tx_18)) - (qx_18 * tz_18), ((z_43 + (qw_18 * tz_18)) + (qx_18 * ty_18)) - (qy_18 * tx_18));
        const b_53 = Pnt_$ctor_Z7AD9E565(0, 0, 1);
...
${Pnt__get_AsString(a_63)}`);
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_16, Test_TestCaseBuilder__Delay_1505(builder$0040_16, () => {
        ...
        let a_67;
        const p_18 = Pnt_$ctor_Z7AD9E565(0, 1, 0);
        ...
        a_67 = Pnt_$ctor_Z7AD9E565_1(((x_52 + (qw_19 * tx_19)) + (qy_19 * tz_19)) - (qz_19 * ty_19), ((y_47 + (qw_19 * ty_19)) + (qz_19 * tx_19)) - (qx_19 * tz_19), ((z_45 + (qw_19 * tz_19)) + (qx_19 * ty_19)) - (qy_19 * tx_19));
        const b_56 = Pnt_$ctor_Z7AD9E565(0, -1, 0);
...
${Pnt__get_AsString(a_67)}`);
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_18, Test_TestCaseBuilder__Delay_1505(builder$0040_18, () => {
        ...
        Expect_throws(() => {
            let vecFrom_1, vecTo_1, v_6, a_71, b_60, v_7, a_72, b_61, a_73, b_62;
            (vecFrom_1 = from_1, (vecTo_1 = toPt_1, (((v_6 = ((a_71 = vecFrom_1, (b_60 = vecTo_1, Vec_$ctor_Z7AD9E565_1(a_71.X - b_60.X, a_71.Y - b_60.Y, a_71.Z - b_60.Z)))), ((v_6.X * v_6.X) + (v_6.Y * v_6.Y)) + (v_6.Z * v_6.Z))) < 1E-24) ? Quaternion_$ctor_77D16AC0(0, 0, 0, 1) : ((!(((v_7 = ((a_72 = vecFrom_1, (b_61 = vecTo_1, Vec_$ctor_Z7AD9E565_1(a_72.X + b_61.X, a_72.Y + b_61.Y, a_72.Z + b_61.Z)))), ((v_7.X * v_7.X) + (v_7.Y * v_7.Y)) + (v_7.Z * v_7.Z))) > 1E-12) ? fail(`Quaternion.createVecToVec failed to find a rotation axis for (almost) colinear unit-vectors in opposite directions: ${interpolate("%O%P()", [vecFrom_1])} and ${interpolate("%O%P()", [vecTo_1])}`) : undefined, Quaternion_create_77D16AC0((vecFrom_1.Y * vecTo_1.Z) - (vecFrom_1.Z * vecTo_1.Y), (vecFrom_1.Z * vecTo_1.X) - (vecFrom_1.X * vecTo_1.Z), (vecFrom_1.X * vecTo_1.Y) - (vecFrom_1.Y * vecTo_1.X), ((a_73 = vecFrom_1, (b_62 = vecTo_1, ((a_73.X * b_62.X) + (a_73.Y * b_62.Y)) + (a_73.Z * b_62.Z)))) + 1)))));
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_26, Test_TestCaseBuilder__Delay_1505(builder$0040_26, () => {
        let axis_23;
        const q_57 = Quaternion_$ctor_77D16AC0(0, 0, 0, 1);
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_27, Test_TestCaseBuilder__Delay_1505(builder$0040_27, () => {
        let axis_25;
        const q_59 = Quaternion_createFromRadians_Z3D1F83EE(Vec_$ctor_Z7AD9E565(0, 0, 1), 0.017453292519943295 * 60);
        axis_25 = Vec_$ctor_Z7AD9E565_1(q_59.X, q_59.Y, q_59.Z);
        const expectedLength = Math.sin(3.141592653589793 / 6);
        Expect_floatClose(AccuracyModule_high, Math.sqrt(((axis_25.X * axis_25.X) + (axis_25.Y * axis_25.Y)) + (axis_25.Z * axis_25.Z)), expectedLength, "axis length is sin(angle/2)");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_28, Test_TestCaseBuilder__Delay_1505(builder$0040_28, () => {
        ...
        a_77 = Pnt_$ctor_Z7AD9E565_1(((x_63 + (qw_21 * tx_21)) + (qy_21 * tz_21)) - (qz_21 * ty_21), ((y_56 + (qw_21 * ty_21)) + (qz_21 * tx_21)) - (qx_21 * tz_21), ((z_54 + (qw_21 * tz_21)) + (qx_21 * ty_21)) - (qy_21 * tx_21));
        let b_65;
        const p_21 = a_76;
        const q_62 = qNeg;
        const x_64 = p_21.X;
        ...
        b_65 = Pnt_$ctor_Z7AD9E565_1(((x_64 + (qw_22 * tx_22)) + (qy_22 * tz_22)) - (qz_22 * ty_22), ((y_57 + (qw_22 * ty_22)) + (qz_22 * tx_22)) - (qx_22 * tz_22), ((z_55 + (qw_22 * tz_22)) + (qx_22 * ty_22)) - (qy_22 * tx_22));
...
${Pnt__get_AsString(a_77)}`);
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_29, Test_TestCaseBuilder__Delay_1505(builder$0040_29, () => {
        ...
        Expect_isTrue((a_81 = Quaternion_createFromRadians_Z3D1F83EE(Vec_$ctor_Z7AD9E565(0, 0, 1), 0.017453292519943295 * 45), (b_69 = Quaternion_createFromRadians_Z3D1F83EE(Vec_$ctor_Z7AD9E565(0, 0, 1), 0.017453292519943295 * 45), ((tolerance_4 = 1E-10, (a_82 = a_81, (b_70 = b_69, (((Math.abs(a_82.X - b_70.X) <= tolerance_4) && (Math.abs(a_82.Y - b_70.Y) <= tolerance_4)) && (Math.abs(a_82.Z - b_70.Z) <= tolerance_4)) && (Math.abs(a_82.W - b_70.W) <= tolerance_4))))) ? true : ((tolerance_5 = 1E-10, (a_83 = a_81, (b_71 = Quaternion_$ctor_77D16AC0(-b_69.X, -b_69.Y, -b_69.Z, -b_69.W), (((Math.abs(a_83.X - b_71.X) <= tolerance_5) && (Math.abs(a_83.Y - b_71.Y) <= tolerance_5)) && (Math.abs(a_83.Z - b_71.Z) <= tolerance_5)) && (Math.abs(a_83.W - b_71.W) <= tolerance_5))))))))("same quaternions should be rotationally equal");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_35, Test_TestCaseBuilder__Delay_1505(builder$0040_35, () => {
        ...
        Expect_isTrue((a_111 = Quaternion_$ctor_77D16AC0(0, 0, 0, 1), (b_99 = Quaternion_$ctor_77D16AC0(0, 0, 0, 1), ((tolerance_34 = 1E-10, (a_112 = a_111, (b_100 = b_99, (((Math.abs(a_112.X - b_100.X) <= tolerance_34) && (Math.abs(a_112.Y - b_100.Y) <= tolerance_34)) && (Math.abs(a_112.Z - b_100.Z) <= tolerance_34)) && (Math.abs(a_112.W - b_100.W) <= tolerance_34))))) ? true : ((tolerance_35 = 1E-10, (a_113 = a_111, (b_101 = Quaternion_$ctor_77D16AC0(-b_99.X, -b_99.Y, -b_99.Z, -b_99.W), (((Math.abs(a_113.X - b_101.X) <= tolerance_35) && (Math.abs(a_113.Y - b_101.Y) <= tolerance_35)) && (Math.abs(a_113.Z - b_101.Z) <= tolerance_35)) && (Math.abs(a_113.W - b_101.W) <= tolerance_35))))))))("identity quaternions should be equal");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_36, Test_TestCaseBuilder__Delay_1505(builder$0040_36, () => {
        ...
        Expect_isTrue((a_115 = q_64, (b_103 = Quaternion_$ctor_77D16AC0(-q_64.X, -q_64.Y, -q_64.Z, -q_64.W), ((tolerance_38 = 0, (a_116 = a_115, (b_104 = b_103, (((Math.abs(a_116.X - b_104.X) <= tolerance_38) && (Math.abs(a_116.Y - b_104.Y) <= tolerance_38)) && (Math.abs(a_116.Z - b_104.Z) <= tolerance_38)) && (Math.abs(a_116.W - b_104.W) <= tolerance_38))))) ? true : ((tolerance_39 = 0, (a_117 = a_115, (b_105 = Quaternion_$ctor_77D16AC0(-b_103.X, -b_103.Y, -b_103.Z, -b_103.W), (((Math.abs(a_117.X - b_105.X) <= tolerance_39) && (Math.abs(a_117.Y - b_105.Y) <= tolerance_39)) && (Math.abs(a_117.Z - b_105.Z) <= tolerance_39)) && (Math.abs(a_117.W - b_105.W) <= tolerance_39))))))))("q and -q equal with zero tolerance");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_37, Test_TestCaseBuilder__Delay_1505(builder$0040_37, () => {
        ...
        a_122 = Pnt_$ctor_Z7AD9E565_1(((x_82 + (qw_23 * tx_23)) + (qy_23 * tz_23)) - (qz_23 * ty_23), ((y_75 + (qw_23 * ty_23)) + (qz_23 * tx_23)) - (qx_23 * tz_23), ((z_73 + (qw_23 * tz_23)) + (qx_23 * ty_23)) - (qy_23 * tx_23));
        let b_110;
        const p_23 = testPt;
        const q_66 = q2_10;
        const x_83 = p_23.X;
        ...
        b_110 = Pnt_$ctor_Z7AD9E565_1(((x_83 + (qw_24 * tx_24)) + (qy_24 * tz_24)) - (qz_24 * ty_24), ((y_76 + (qw_24 * ty_24)) + (qz_24 * tx_24)) - (qx_24 * tz_24), ((z_74 + (qw_24 * tz_24)) + (qx_24 * ty_24)) - (qy_24 * tx_24));
...
${Pnt__get_AsString(a_122)}`);
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_38, Test_TestCaseBuilder__Delay_1505(builder$0040_38, () => {
        ...
        Expect_isTrue((a_126 = q1_10, (b_114 = Quaternion_$ctor_77D16AC0(-q1_10.X, -q1_10.Y, -q1_10.Z, -q1_10.W), ((tolerance_46 = 1E-10, (a_127 = a_126, (b_115 = b_114, (((Math.abs(a_127.X - b_115.X) <= tolerance_46) && (Math.abs(a_127.Y - b_115.Y) <= tolerance_46)) && (Math.abs(a_127.Z - b_115.Z) <= tolerance_46)) && (Math.abs(a_127.W - b_115.W) <= tolerance_46))))) ? true : ((tolerance_47 = 1E-10, (a_128 = a_126, (b_116 = Quaternion_$ctor_77D16AC0(-b_114.X, -b_114.Y, -b_114.Z, -b_114.W), (((Math.abs(a_128.X - b_116.X) <= tolerance_47) && (Math.abs(a_128.Y - b_116.Y) <= tolerance_47)) && (Math.abs(a_128.Z - b_116.Z) <= tolerance_47)) && (Math.abs(a_128.W - b_116.W) <= tolerance_47))))))))("180° rotation q and -q are equal");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_39, Test_TestCaseBuilder__Delay_1505(builder$0040_39, () => {
        let d_3, x_93, vecFrom_2, vecTo_2, v_8, l_6, li_1, v_10, a_129, b_117, v_11, a_130, b_118, a_131, b_119;
        Expect_floatClose(AccuracyModule_medium, 57.29577951308232 * (2 * ((d_3 = ((x_93 = ((vecFrom_2 = UnitVec_$ctor_Z7AD9E565(1, 0, 0), (vecTo_2 = ((v_8 = Vec_$ctor_Z7AD9E565_2(1, 1E-13, 0), (l_6 = Math.sqrt(((v_8.X * v_8.X) + (v_8.Y * v_8.Y)) + (v_8.Z * v_8.Z)), (!(l_6 > 1E-12) ? failTooSmall("UnitVec.createFromVec", v_8) : undefined, (li_1 = (1 / l_6), UnitVec_$ctor_Z7AD9E565(li_1 * v_8.X, li_1 * v_8.Y, li_1 * v_8.Z)))))), (((v_10 = ((a_129 = vecFrom_2, (b_117 = vecTo_2, Vec_$ctor_Z7AD9E565_1(a_129.X - b_117.X, a_129.Y - b_117.Y, a_129.Z - b_117.Z)))), ((v_10.X * v_10.X) + (v_10.Y * v_10.Y)) + (v_10.Z * v_10.Z))) < 1E-24) ? Quaternion_$ctor_77D16AC0(0, 0, 0, 1) : ((!(((v_11 = ((a_130 = vecFrom_2, (b_118 = vecTo_2, Vec_$ctor_Z7AD9E565_1(a_130.X + b_118.X, a_130.Y + b_118.Y, a_130.Z + b_118.Z)))), ((v_11.X * v_11.X) + (v_11.Y * v_11.Y)) + (v_11.Z * v_11.Z))) > 1E-12) ? fail(`Quaternion.createVecToVec failed to find a rotation axis for (almost) colinear unit-vectors in opposite directions: ${interpolate("%O%P()", [vecFrom_2])} and ${interpolate("%O%P()", [vecTo_2])}`) : undefined, Quaternion_create_77D16AC0((vecFrom_2.Y * vecTo_2.Z) - (vecFrom_2.Z * vecTo_2.Y), (vecFrom_2.Z * vecTo_2.X) - (vecFrom_2.X * vecTo_2.Z), (vecFrom_2.X * vecTo_2.Y) - (vecFrom_2.Y * vecTo_2.X), ((a_131 = vecFrom_2, (b_119 = vecTo_2, ((a_131.X * b_119.X) + (a_131.Y * b_119.Y)) + (a_131.Z * b_119.Z)))) + 1)))))).W, (x_93 > -1) ? ((x_93 < 1) ? x_93 : 1) : -1)), Math.acos(d_3)))), 0, "nearly identical vectors produce near-identity");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_40, Test_TestCaseBuilder__Delay_1505(builder$0040_40, () => {
        let v_13, a_134, b_120, v_14, a_135, b_121, a_136, b_122;
        let q_70;
        const vecFrom_3 = UnitVec_$ctor_Z7AD9E565(1, 0, 0);
        const vecTo_3 = UnitVec_$ctor_Z7AD9E565(1, 0, 0);
        if (((v_13 = ((a_134 = vecFrom_3, (b_120 = vecTo_3, Vec_$ctor_Z7AD9E565_1(a_134.X - b_120.X, a_134.Y - b_120.Y, a_134.Z - b_120.Z)))), ((v_13.X * v_13.X) + (v_13.Y * v_13.Y)) + (v_13.Z * v_13.Z))) < 1E-24) {
            q_70 = Quaternion_$ctor_77D16AC0(0, 0, 0, 1);
        }
        else {
            if (!(((v_14 = ((a_135 = vecFrom_3, (b_121 = vecTo_3, Vec_$ctor_Z7AD9E565_1(a_135.X + b_121.X, a_135.Y + b_121.Y, a_135.Z + b_121.Z)))), ((v_14.X * v_14.X) + (v_14.Y * v_14.Y)) + (v_14.Z * v_14.Z))) > 1E-12)) {
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_44, Test_TestCaseBuilder__Delay_1505(builder$0040_44, () => {
        ...
        Test_TestCaseBuilder__Combine_3A59D1F3(builder$0040_44, Test_TestCaseBuilder__For_Z371464DD(builder$0040_44, rangeDouble(1, 1, 360), (_arg) => {
            ...
            Expect_floatClose(AccuracyModule_medium, Math.sqrt((((result_4.X * result_4.X) + (result_4.Y * result_4.Y)) + (result_4.Z * result_4.Z)) + (result_4.W * result_4.W)), 1, "quaternion should remain unit length after many multiplications");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_45, Test_TestCaseBuilder__Delay_1505(builder$0040_45, () => {
        Expect_floatClose(AccuracyModule_low, Quaternion_toEulerAnglesZYX_Z2A007687(Quaternion_createFromEulerZYX_Z7AD9E565(30, 89.9, 60))[1], 89.9, "near gimbal lock Y");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_46, Test_TestCaseBuilder__Delay_1505(builder$0040_46, () => {
        Expect_floatClose(AccuracyModule_medium, Quaternion_toEulerAnglesZYX_Z2A007687(Quaternion_createFromEulerZYX_Z7AD9E565(30, 90, 60))[1], 90, "gimbal lock Y = 90");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_48, Test_TestCaseBuilder__Delay_1505(builder$0040_48, () => {
        ...
        b_128 = Pnt_$ctor_Z7AD9E565_1(((x_101 + (qw_26 * tx_26)) + (qy_26 * tz_26)) - (qz_26 * ty_26), ((y_91 + (qw_26 * ty_26)) + (qz_26 * tx_26)) - (qx_26 * tz_26), ((z_86 + (qw_26 * tz_26)) + (qx_26 * ty_26)) - (qy_26 * tx_26));
...
${Pnt__get_AsString(a_142)}`);
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_49, Test_TestCaseBuilder__Delay_1505(builder$0040_49, () => {
        ...
        b_132 = Pnt_$ctor_Z7AD9E565_1(((x_103 + (qw_27 * tx_27)) + (qy_27 * tz_27)) - (qz_27 * ty_27), ((y_93 + (qw_27 * ty_27)) + (qz_27 * tx_27)) - (qx_27 * tz_27), ((z_88 + (qw_27 * tz_27)) + (qx_27 * ty_27)) - (qy_27 * tx_27));
...
${Pnt__get_AsString(a_146)}`);
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_50, Test_TestCaseBuilder__Delay_1505(builder$0040_50, () => {
        ...
        b_136 = Pnt_$ctor_Z7AD9E565_1(((x_105 + (qw_28 * tx_28)) + (qy_28 * tz_28)) - (qz_28 * ty_28), ((y_95 + (qw_28 * ty_28)) + (qz_28 * tx_28)) - (qx_28 * tz_28), ((z_90 + (qw_28 * tz_28)) + (qx_28 * ty_28)) - (qy_28 * tx_28));
...
${Pnt__get_AsString(a_150)}`);
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_51, Test_TestCaseBuilder__Delay_1505(builder$0040_51, () => {
        ...
        a_154 = Pnt_$ctor_Z7AD9E565_1(((x_107 + (qw_29 * tx_29)) + (qy_29 * tz_29)) - (qz_29 * ty_29), ((y_97 + (qw_29 * ty_29)) + (qz_29 * tx_29)) - (qx_29 * tz_29), ((z_92 + (qw_29 * tz_29)) + (qx_29 * ty_29)) - (qy_29 * tx_29));
        let b_139;
        const p_29 = a_153;
        const q_82 = q2_12;
        const x_108 = p_29.X;
        ...
        b_139 = Pnt_$ctor_Z7AD9E565_1(((x_108 + (qw_30 * tx_30)) + (qy_30 * tz_30)) - (qz_30 * ty_30), ((y_98 + (qw_30 * ty_30)) + (qz_30 * tx_30)) - (qx_30 * tz_30), ((z_93 + (qw_30 * tz_30)) + (qx_30 * ty_30)) - (qy_30 * tx_30));
...
${Pnt__get_AsString(a_154)}`);
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_52, Test_TestCaseBuilder__Delay_1505(builder$0040_52, () => {
        ...
        let qNormalized;
        const q_83 = Quaternion_create_77D16AC0_1(q1_13.X * 1.001, q1_13.Y * 1.001, q1_13.Z * 1.001, q1_13.W * 1.001);
        qNormalized = Quaternion_create_77D16AC0(q_83.X, q_83.Y, q_83.Z, q_83.W);
        Expect_floatClose(AccuracyModule_high, Math.sqrt((((qNormalized.X * qNormalized.X) + (qNormalized.Y * qNormalized.Y)) + (qNormalized.Z * qNormalized.Z)) + (qNormalized.W * qNormalized.W)), 1, "normalized quaternion has unit length");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_53, Test_TestCaseBuilder__Delay_1505(builder$0040_53, () => {
        ...
        a_158 = Pnt_$ctor_Z7AD9E565_1(((x_110 + (qw_31 * tx_31)) + (qy_31 * tz_31)) - (qz_31 * ty_31), ((y_100 + (qw_31 * ty_31)) + (qz_31 * tx_31)) - (qx_31 * tz_31), ((z_95 + (qw_31 * tz_31)) + (qx_31 * ty_31)) - (qy_31 * tx_31));
        let b_142;
        const p_31 = a_157;
        ...
        b_142 = Pnt_$ctor_Z7AD9E565_1(((x_111 + (qw_32 * tx_32)) + (qy_32 * tz_32)) - (qz_32 * ty_32), ((y_101 + (qw_32 * ty_32)) + (qz_32 * tx_32)) - (qx_32 * tz_32), ((z_96 + (qw_32 * tz_32)) + (qx_32 * ty_32)) - (qy_32 * tx_32));
