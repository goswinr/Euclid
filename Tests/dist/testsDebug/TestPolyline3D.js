...
export const tests = Test_testList("Polyline3D", ofArray([(() => {
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040, Test_TestCaseBuilder__Delay_1505(builder$0040, () => {
        ...
        if ((actual_1 === 0) ? true : !(new Function("try {return this===window;}catch(e){ return false;}"))()) {
            ...
            if (contains(valueType, primitiveTypes, {
                ...
                const arg = int32ToString(0);
                const arg_1 = int32ToString(actual_1);
                errorMsg = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%s</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%s</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(arg)(arg_1)("empty polyline has 0 points");
            }
            else {
                errorMsg = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%A</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%A</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(0)(actual_1)("empty polyline has 0 points");
            }
        ...
        if ((actual_3 === 0) ? true : !(new Function("try {return this===window;}catch(e){ return false;}"))()) {
            ...
            if (contains(valueType_1, primitiveTypes_1, {
                ...
                errorMsg_1 = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%s</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%s</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(arg_6)(arg_1_1)("empty polyline has 0 segments");
            }
            else {
                errorMsg_1 = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%A</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%A</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(0)(actual_3)("empty polyline has 0 segments");
            }
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_1, Test_TestCaseBuilder__Delay_1505(builder$0040_1, () => {
        const pl_1 = Polyline3D_$ctor_Z524259A4(10);
        const actual_5 = Polyline3D__get_PointCount(pl_1) | 0;
        if ((actual_5 === 0) ? true : !(new Function("try {return this===window;}catch(e){ return false;}"))()) {
            ...
            if (contains(valueType_2, primitiveTypes_2, {
                ...
                errorMsg_2 = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%s</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%s</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(arg_7)(arg_1_2)("polyline with capacity has 0 points");
            }
            else {
                errorMsg_2 = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%A</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%A</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(0)(actual_5)("polyline with capacity has 0 points");
            }
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_2, Test_TestCaseBuilder__Delay_1505(builder$0040_2, () => {
        const pts = [Pnt_$ctor_Z7AD9E565(0, 0, 0), Pnt_$ctor_Z7AD9E565(1, 0, 0), Pnt_$ctor_Z7AD9E565(1, 1, 0)];
        const pl_2 = Polyline3D_$ctor_516DFD0A(pts);
        ...
        if ((actual_7 === 3) ? true : !(new Function("try {return this===window;}catch(e){ return false;}"))()) {
            ...
            if (contains(valueType_3, primitiveTypes_3, {
                ...
                errorMsg_3 = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%s</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%s</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(arg_8)(arg_1_3)("polyline has correct point count");
            }
            else {
        ...
        if ((actual_9 === 2) ? true : !(new Function("try {return this===window;}catch(e){ return false;}"))()) {
            ...
            if (contains(valueType_4, primitiveTypes_4, {
                ...
                const arg_9 = int32ToString(2);
                const arg_1_4 = int32ToString(actual_9);
                errorMsg_4 = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%s</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%s</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(arg_9)(arg_1_4)("polyline has correct segment count");
            }
            else {
                errorMsg_4 = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%A</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%A</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(2)(actual_9)("polyline has correct segment count");
            }
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_3, Test_TestCaseBuilder__Delay_1505(builder$0040_3, () => {
        const pts_1 = [Pnt_$ctor_Z7AD9E565(0, 0, 0), Pnt_$ctor_Z7AD9E565(1, 0, 0), Pnt_$ctor_Z7AD9E565(1, 1, 0)];
        const pl_3 = Polyline3D_$ctor_516DFD0A(pts_1);
        const expectedLength = 2;
        Expect_floatClose(tol, Polyline3D__get_Length(pl_3), expectedLength, "polyline length is correct");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_4, Test_TestCaseBuilder__Delay_1505(builder$0040_4, () => {
        const pts_2 = [Pnt_$ctor_Z7AD9E565(0, 0, 0), Pnt_$ctor_Z7AD9E565(1, 1, 1)];
        const pl_4 = Polyline3D_$ctor_516DFD0A(pts_2);
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_5, Test_TestCaseBuilder__Delay_1505(builder$0040_5, () => {
        const pl_5 = Polyline3D_$ctor();
        Expect_floatClose(tol, Polyline3D__get_Length(pl_5), 0, "empty polyline has zero length");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_6, Test_TestCaseBuilder__Delay_1505(builder$0040_6, () => {
        const pts_3 = [Pnt_$ctor_Z7AD9E565(0, 0, 0)];
        const pl_6 = Polyline3D_$ctor_516DFD0A(pts_3);
        Expect_floatClose(tol, Polyline3D__get_Length(pl_6), 0, "single point polyline has zero length");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_7, Test_TestCaseBuilder__Delay_1505(builder$0040_7, () => {
        ...
        const pts_4 = [Pnt_$ctor_Z7AD9E565(0, 0, 0), Pnt_$ctor_Z7AD9E565(1, 0, 0), Pnt_$ctor_Z7AD9E565(1, 1, 0)];
        const pl_7 = Polyline3D_$ctor_516DFD0A(pts_4);
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_8, Test_TestCaseBuilder__Delay_1505(builder$0040_8, () => {
        ...
        const pts_5 = [Pnt_$ctor_Z7AD9E565(0, 0, 0), Pnt_$ctor_Z7AD9E565(1, 0, 0), Pnt_$ctor_Z7AD9E565(1, 1, 0)];
        const pl_8 = Polyline3D_$ctor_516DFD0A(pts_5);
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_9, Test_TestCaseBuilder__Delay_1505(builder$0040_9, () => {
        ...
        const pts_6 = [Pnt_$ctor_Z7AD9E565(0, 0, 0), Pnt_$ctor_Z7AD9E565(1, 0, 0), Pnt_$ctor_Z7AD9E565(1, 1, 0), Pnt_$ctor_Z7AD9E565(0, 1, 0)];
        const pl_9 = Polyline3D_$ctor_516DFD0A(pts_6);
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_10, Test_TestCaseBuilder__Delay_1505(builder$0040_10, () => {
        ...
        const pts_7 = [Pnt_$ctor_Z7AD9E565(0, 0, 0), Pnt_$ctor_Z7AD9E565(1, 0, 0), Pnt_$ctor_Z7AD9E565(1, 1, 0)];
        const pl_10 = Polyline3D_$ctor_516DFD0A(pts_7);
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_11, Test_TestCaseBuilder__Delay_1505(builder$0040_11, () => {
        ...
        const pts_8 = [Pnt_$ctor_Z7AD9E565(0, 0, 0), Pnt_$ctor_Z7AD9E565(1, 0, 0), Pnt_$ctor_Z7AD9E565(1, 1, 0)];
        const pl_11 = Polyline3D_$ctor_516DFD0A(pts_8);
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_12, Test_TestCaseBuilder__Delay_1505(builder$0040_12, () => {
        const pts_9 = [Pnt_$ctor_Z7AD9E565(0, 0, 0), Pnt_$ctor_Z7AD9E565(1, 0, 0), Pnt_$ctor_Z7AD9E565(1, 1, 0)];
        const pl_12 = Polyline3D_$ctor_516DFD0A(pts_9);
        const segs = Polyline3D__get_Segments(pl_12);
        ...
        if ((actual_15 === 2) ? true : !(new Function("try {return this===window;}catch(e){ return false;}"))()) {
            ...
            if (contains(valueType_5, primitiveTypes_5, {
                ...
                const arg_1_5 = int32ToString(actual_15);
                errorMsg_5 = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%s</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%s</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(arg_10)(arg_1_5)("segments count is correct");
            }
            else {
                errorMsg_5 = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%A</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%A</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(2)(actual_15)("segments count is correct");
            }
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_13, Test_TestCaseBuilder__Delay_1505(builder$0040_13, () => {
        const pts_10 = [Pnt_$ctor_Z7AD9E565(0, 0, 0), Pnt_$ctor_Z7AD9E565(1, 0, 0), Pnt_$ctor_Z7AD9E565(1, 1, 0), Pnt_$ctor_Z7AD9E565(0, 0, 0)];
        const pl_13 = Polyline3D_$ctor_516DFD0A(pts_10);
        Expect_isTrue(Polyline3D__get_IsClosed(pl_13))("polyline is closed");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_14, Test_TestCaseBuilder__Delay_1505(builder$0040_14, () => {
        const pts_11 = [Pnt_$ctor_Z7AD9E565(0, 0, 0), Pnt_$ctor_Z7AD9E565(1, 0, 0), Pnt_$ctor_Z7AD9E565(1, 1, 0)];
        const pl_14 = Polyline3D_$ctor_516DFD0A(pts_11);
        Expect_isFalse(Polyline3D__get_IsClosed(pl_14))("polyline is not closed");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_15, Test_TestCaseBuilder__Delay_1505(builder$0040_15, () => {
        const pts_12 = [Pnt_$ctor_Z7AD9E565(0, 0, 0), Pnt_$ctor_Z7AD9E565(1, 0, 0), Pnt_$ctor_Z7AD9E565(1, 1, 0), Pnt_$ctor_Z7AD9E565(0.001, 0, 0)];
        const pl_15 = Polyline3D_$ctor_516DFD0A(pts_12);
        Expect_isTrue(Polyline3D__IsAlmostClosed_5E38073B(pl_15, 0.01))("polyline is almost closed with tolerance 0.01");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_16, Test_TestCaseBuilder__Delay_1505(builder$0040_16, () => {
        const pts_13 = [Pnt_$ctor_Z7AD9E565(0, 0, 0), Pnt_$ctor_Z7AD9E565(1, 0, 0), Pnt_$ctor_Z7AD9E565(1, 1, 0), Pnt_$ctor_Z7AD9E565(0.1, 0, 0)];
        const pl_16 = Polyline3D_$ctor_516DFD0A(pts_13);
        Expect_isFalse(Polyline3D__IsAlmostClosed_5E38073B(pl_16, 0.01))("polyline is not almost closed with tolerance 0.01");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_17, Test_TestCaseBuilder__Delay_1505(builder$0040_17, () => {
        const pts_14 = [Pnt_$ctor_Z7AD9E565(0, 0, 0), Pnt_$ctor_Z7AD9E565(2, 3, 4), Pnt_$ctor_Z7AD9E565(1, 1, 1)];
        const pl_17 = Polyline3D_$ctor_516DFD0A(pts_14);
        const bbox = Polyline3D__get_BoundingBox(pl_17);
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_20, Test_TestCaseBuilder__Delay_1505(builder$0040_20, () => {
        ...
        const pts_17 = [Pnt_$ctor_Z7AD9E565(0, 0, 0), Pnt_$ctor_Z7AD9E565(1, 0, 0), Pnt_$ctor_Z7AD9E565(1, 1, 0)];
        const pl_20 = Polyline3D_$ctor_516DFD0A(pts_17);
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_21, Test_TestCaseBuilder__Delay_1505(builder$0040_21, () => {
        ...
        const pts_18 = [Pnt_$ctor_Z7AD9E565(0, 0, 0), Pnt_$ctor_Z7AD9E565(1, 0, 0), Pnt_$ctor_Z7AD9E565(1, 1, 0)];
        const pl_21 = Polyline3D_$ctor_516DFD0A(pts_18);
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_22, Test_TestCaseBuilder__Delay_1505(builder$0040_22, () => {
        ...
        const pts_19 = [Pnt_$ctor_Z7AD9E565(0, 0, 0), Pnt_$ctor_Z7AD9E565(1, 0, 0), Pnt_$ctor_Z7AD9E565(1, 1, 0), Pnt_$ctor_Z7AD9E565(0.001, 0, 0)];
        const pl_22 = Polyline3D_$ctor_516DFD0A(pts_19);
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_23, Test_TestCaseBuilder__Delay_1505(builder$0040_23, () => {
        const pts_20 = [Pnt_$ctor_Z7AD9E565(0, 0, 0), Pnt_$ctor_Z7AD9E565(1, 0, 0), Pnt_$ctor_Z7AD9E565(1, 1, 0)];
        const pl_23 = Polyline3D_$ctor_516DFD0A(pts_20);
        ...
        if ((actual_23 === expected_21) ? true : !(new Function("try {return this===window;}catch(e){ return false;}"))()) {
            ...
            if (contains(valueType_6, primitiveTypes_6, {
                ...
                const arg_11 = int32ToString(expected_21);
                const arg_1_6 = int32ToString(actual_23);
                errorMsg_6 = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%s</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%s</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(arg_11)(arg_1_6)("point count increased");
            }
            else {
                errorMsg_6 = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%A</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%A</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(expected_21)(actual_23)("point count increased");
            }
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_24, Test_TestCaseBuilder__Delay_1505(builder$0040_24, () => {
        ...
        const pts_21 = [Pnt_$ctor_Z7AD9E565(0, 0, 0), Pnt_$ctor_Z7AD9E565(1, 0, 0), Pnt_$ctor_Z7AD9E565(1, 1, 0)];
        const pl_24 = Polyline3D_$ctor_516DFD0A(pts_21);
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_25, Test_TestCaseBuilder__Delay_1505(builder$0040_25, () => {
        ...
        const pts_22 = [Pnt_$ctor_Z7AD9E565(0, 0, 0), Pnt_$ctor_Z7AD9E565(1, 0, 0), Pnt_$ctor_Z7AD9E565(1, 1, 0), Pnt_$ctor_Z7AD9E565(0, 0, 0)];
        const pl_25 = Polyline3D_$ctor_516DFD0A(pts_22);
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_26, Test_TestCaseBuilder__Delay_1505(builder$0040_26, () => {
        ...
        const pts_23 = [Pnt_$ctor_Z7AD9E565(0, 0, 0), Pnt_$ctor_Z7AD9E565(1, 0, 0), Pnt_$ctor_Z7AD9E565(1, 1, 0), Pnt_$ctor_Z7AD9E565(0, 0, 0)];
        const pl_26 = Polyline3D_$ctor_516DFD0A(pts_23);
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_27, Test_TestCaseBuilder__Delay_1505(builder$0040_27, () => {
        const pl_27 = Polyline3D_$ctor();
        const s = toString(pl_27);
        Expect_stringContains(s, "empty", "ToString contains \'empty\'");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_28, Test_TestCaseBuilder__Delay_1505(builder$0040_28, () => {
        const pts_24 = [Pnt_$ctor_Z7AD9E565(0, 0, 0), Pnt_$ctor_Z7AD9E565(1, 0, 0)];
        const pl_28 = Polyline3D_$ctor_516DFD0A(pts_24);
        const s_1 = toString(pl_28);
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_29, Test_TestCaseBuilder__Delay_1505(builder$0040_29, () => {
        const pts_25 = [Pnt_$ctor_Z7AD9E565(0, 0, 0), Pnt_$ctor_Z7AD9E565(1, 0, 0)];
        const pl_29 = Polyline3D_$ctor_516DFD0A(pts_25);
        const s_2 = Polyline3D__get_AsString(pl_29);
        Expect_stringContains(s_2, "open", "AsString contains \'open\'");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_30, Test_TestCaseBuilder__Delay_1505(builder$0040_30, () => {
        const pts_26 = [Pnt_$ctor_Z7AD9E565(0, 0, 0), Pnt_$ctor_Z7AD9E565(1, 0, 0), Pnt_$ctor_Z7AD9E565(1, 1, 0), Pnt_$ctor_Z7AD9E565(0, 0, 0)];
        const pl_30 = Polyline3D_$ctor_516DFD0A(pts_26);
        const s_3 = Polyline3D__get_AsString(pl_30);
        Expect_stringContains(s_3, "closed", "AsString contains \'closed\'");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_31, Test_TestCaseBuilder__Delay_1505(builder$0040_31, () => {
        const pts_27 = [Pnt_$ctor_Z7AD9E565(0, 0, 0), Pnt_$ctor_Z7AD9E565(1, 0, 0)];
        const pl_31 = Polyline3D_$ctor_516DFD0A(pts_27);
        const f = () => {
            Polyline3D__GetSegment_Z524259A4(pl_31, 5);
        };
        Expect_throws(f, "GetSegment out of range throws");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_32, Test_TestCaseBuilder__Delay_1505(builder$0040_32, () => {
        ...
        Expect_throws(f_1, "FirstPoint on empty polyline throws");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_33, Test_TestCaseBuilder__Delay_1505(builder$0040_33, () => {
        const pts_28 = [Pnt_$ctor_Z7AD9E565(0, 0, 0)];
        const pl_33 = Polyline3D_$ctor_516DFD0A(pts_28);
        const f_2 = () => {
            Polyline3D__get_SecondPoint(pl_33);
        };
        Expect_throws(f_2, "SecondPoint on single point polyline throws");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_34, Test_TestCaseBuilder__Delay_1505(builder$0040_34, () => {
        const pts_29 = [Pnt_$ctor_Z7AD9E565(0, 0, 0)];
        const pl_34 = Polyline3D_$ctor_516DFD0A(pts_29);
        const f_3 = () => {
            Polyline3D__get_LastSegment(pl_34);
        };
        Expect_throws(f_3, "LastSegment on single point polyline throws");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_35, Test_TestCaseBuilder__Delay_1505(builder$0040_35, () => {
        const pts_30 = [Pnt_$ctor_Z7AD9E565(0, 0, 0), Pnt_$ctor_Z7AD9E565(1, 0, 0)];
        const pl_35 = Polyline3D_$ctor_516DFD0A(pts_30);
        const code = Polyline3D__get_AsFSharpCode(pl_35);
        Expect_stringContains(code, "Polyline3D.create", "AsFSharpCode contains \'Polyline3D.create\'");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_36, Test_TestCaseBuilder__Delay_1505(builder$0040_36, () => {
        const pts_31 = [Pnt_$ctor_Z7AD9E565(0, 0, 0), Pnt_$ctor_Z7AD9E565(1, 0, 0), Pnt_$ctor_Z7AD9E565(2, 0, 0), Pnt_$ctor_Z7AD9E565(3, 0, 0)];
        const pl_36 = Polyline3D_$ctor_516DFD0A(pts_31);
        const expectedLength_2 = 3;
        Expect_floatClose(tol, Polyline3D__get_Length(pl_36), expectedLength_2, "length of collinear points");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_37, Test_TestCaseBuilder__Delay_1505(builder$0040_37, () => {
        const pts_32 = [Pnt_$ctor_Z7AD9E565(0, 0, 0), Pnt_$ctor_Z7AD9E565(1, 1, 1), Pnt_$ctor_Z7AD9E565(2, 2, 2)];
        const pl_37 = Polyline3D_$ctor_516DFD0A(pts_32);
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_38, Test_TestCaseBuilder__Delay_1505(builder$0040_38, () => {
        const pts_33 = [Pnt_$ctor_Z7AD9E565(0, 0, 0), Pnt_$ctor_Z7AD9E565(1, 0, 0), Pnt_$ctor_Z7AD9E565(1, 1, 0), Pnt_$ctor_Z7AD9E565(0, 1, 0), Pnt_$ctor_Z7AD9E565(0, 0, 0)];
        const pl_38 = Polyline3D_$ctor_516DFD0A(pts_33);
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_39, Test_TestCaseBuilder__Delay_1505(builder$0040_39, () => {
        const pts_34 = [Pnt_$ctor_Z7AD9E565(0, 0, 0), Pnt_$ctor_Z7AD9E565(1, 0, 0), Pnt_$ctor_Z7AD9E565(1, 1, 0)];
        const pl_39 = Polyline3D_$ctor_516DFD0A(pts_34);
        ...
        if ((actual_28 === 2) ? true : !(new Function("try {return this===window;}catch(e){ return false;}"))()) {
            ...
            if (contains(valueType_7, primitiveTypes_7, {
                ...
                const arg_1_7 = int32ToString(actual_28);
                errorMsg_7 = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%s</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%s</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(arg_12)(arg_1_7)("LastPointIndex is 2");
            }
            else {
                errorMsg_7 = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%A</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%A</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(2)(actual_28)("LastPointIndex is 2");
            }
        ...
        if ((actual_30 === 1) ? true : !(new Function("try {return this===window;}catch(e){ return false;}"))()) {
            ...
            if (contains(valueType_8, primitiveTypes_8, {
                ...
                const arg_1_8 = int32ToString(actual_30);
                errorMsg_8 = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%s</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%s</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(arg_13)(arg_1_8)("LastSegmentIndex is 1");
            }
            else {
                errorMsg_8 = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%A</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%A</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(1)(actual_30)("LastSegmentIndex is 1");
            }
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_40, Test_TestCaseBuilder__Delay_1505(builder$0040_40, () => {
        ...
        const pts_35 = [Pnt_$ctor_Z7AD9E565(0, 0, 0), Pnt_$ctor_Z7AD9E565(1, 0, 0), Pnt_$ctor_Z7AD9E565(1, 1, 0)];
        const pl_40 = Polyline3D_$ctor_516DFD0A(pts_35);
        const moved = Polyline3D__Move_Z394EC5F7(pl_40, Vec_$ctor_Z7AD9E565(5, 3, 2));
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_41, Test_TestCaseBuilder__Delay_1505(builder$0040_41, () => {
        ...
        const pts_36 = [Pnt_$ctor_Z7AD9E565(0, 0, 0), Pnt_$ctor_Z7AD9E565(1, 0, 0)];
        const pl_41 = Polyline3D_$ctor_516DFD0A(pts_36);
        const moved_1 = Polyline3D__MoveX_5E38073B(pl_41, 5);
        Expect_isTrue(((a_64 = Polyline3D__get_FirstPoint(moved_1), (b_64 = Pnt_$ctor_Z7AD9E565(5, 0, 0), (x_40 = (a_64.X - b_64.X), (y_40 = (a_64.Y - b_64.Y), (z_31 = (a_64.Z - b_64.Z), Math.sqrt(((x_40 * x_40) + (y_40 * y_40)) + (z_31 * z_31)))))))) < 1E-09)("MoveX - first point");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_42, Test_TestCaseBuilder__Delay_1505(builder$0040_42, () => {
        ...
        const pts_37 = [Pnt_$ctor_Z7AD9E565(0, 0, 0), Pnt_$ctor_Z7AD9E565(1, 0, 0)];
        const pl_42 = Polyline3D_$ctor_516DFD0A(pts_37);
        const moved_2 = Polyline3D__MoveY_5E38073B(pl_42, 3);
        Expect_isTrue(((a_66 = Polyline3D__get_FirstPoint(moved_2), (b_66 = Pnt_$ctor_Z7AD9E565(0, 3, 0), (x_41 = (a_66.X - b_66.X), (y_41 = (a_66.Y - b_66.Y), (z_32 = (a_66.Z - b_66.Z), Math.sqrt(((x_41 * x_41) + (y_41 * y_41)) + (z_32 * z_32)))))))) < 1E-09)("MoveY - first point");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_43, Test_TestCaseBuilder__Delay_1505(builder$0040_43, () => {
        ...
        const pts_38 = [Pnt_$ctor_Z7AD9E565(0, 0, 0), Pnt_$ctor_Z7AD9E565(1, 0, 0)];
        const pl_43 = Polyline3D_$ctor_516DFD0A(pts_38);
        const moved_3 = Polyline3D__MoveZ_5E38073B(pl_43, 2);
        Expect_isTrue(((a_68 = Polyline3D__get_FirstPoint(moved_3), (b_68 = Pnt_$ctor_Z7AD9E565(0, 0, 2), (x_42 = (a_68.X - b_68.X), (y_42 = (a_68.Y - b_68.Y), (z_33 = (a_68.Z - b_68.Z), Math.sqrt(((x_42 * x_42) + (y_42 * y_42)) + (z_33 * z_33)))))))) < 1E-09)("MoveZ - first point");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_44, Test_TestCaseBuilder__Delay_1505(builder$0040_44, () => {
        ...
        const pts_39 = [Pnt_$ctor_Z7AD9E565(0, 0, 0), Pnt_$ctor_Z7AD9E565(1, 0, 0)];
        const pl_44 = Polyline3D_$ctor_516DFD0A(pts_39);
        const moved_4 = Polyline3D_move(Vec_$ctor_Z7AD9E565(5, 3, 2), pl_44);
        Expect_isTrue(((a_70 = Polyline3D__get_FirstPoint(moved_4), (b_70 = Pnt_$ctor_Z7AD9E565(5, 3, 2), (x_43 = (a_70.X - b_70.X), (y_43 = (a_70.Y - b_70.Y), (z_34 = (a_70.Z - b_70.Z), Math.sqrt(((x_43 * x_43) + (y_43 * y_43)) + (z_34 * z_34)))))))) < 1E-09)("move static - first point");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_45, Test_TestCaseBuilder__Delay_1505(builder$0040_45, () => {
        ...
        const pts_40 = [Pnt_$ctor_Z7AD9E565(0, 0, 0), Pnt_$ctor_Z7AD9E565(1, 0, 0)];
        const pl_46 = Polyline3D_$ctor_516DFD0A(pts_40);
        const moved_5 = Polyline3D_translate(Vec_$ctor_Z7AD9E565(5, 3, 2), pl_46);
        Expect_isTrue(((a_72 = Polyline3D__get_FirstPoint(moved_5), (b_72 = Pnt_$ctor_Z7AD9E565(5, 3, 2), (x_44 = (a_72.X - b_72.X), (y_44 = (a_72.Y - b_72.Y), (z_35 = (a_72.Z - b_72.Z), Math.sqrt(((x_44 * x_44) + (y_44 * y_44)) + (z_35 * z_35)))))))) < 1E-09)("translate static - first point");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_46, Test_TestCaseBuilder__Delay_1505(builder$0040_46, () => {
        ...
        const pts_41 = [Pnt_$ctor_Z7AD9E565(0, 0, 0), Pnt_$ctor_Z7AD9E565(1, 0, 0)];
        const pl_48 = Polyline3D_$ctor_516DFD0A(pts_41);
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_47, Test_TestCaseBuilder__Delay_1505(builder$0040_47, () => {
        ...
        const pts_42 = [Pnt_$ctor_Z7AD9E565(1, 2, 3), Pnt_$ctor_Z7AD9E565(4, 5, 6)];
        const pl_52 = Polyline3D_$ctor_516DFD0A(pts_42);
        const transformed = Polyline3D__Transform_3CAE9522(pl_52, Matrix_get_identity());
        Expect_isTrue(((a_80 = Polyline3D__get_FirstPoint(transformed), (b_80 = Polyline3D__get_FirstPoint(pl_52), (x_48 = (a_80.X - b_80.X), (y_48 = (a_80.Y - b_80.Y), (z_39 = (a_80.Z - b_80.Z), Math.sqrt(((x_48 * x_48) + (y_48 * y_48)) + (z_39 * z_39)))))))) < 1E-09)("Transform identity - first point");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_48, Test_TestCaseBuilder__Delay_1505(builder$0040_48, () => {
        ...
        const pts_43 = [Pnt_$ctor_Z7AD9E565(0, 0, 0), Pnt_$ctor_Z7AD9E565(1, 0, 0)];
        const pl_53 = Polyline3D_$ctor_516DFD0A(pts_43);
        const m = Matrix_createTranslation_Z394EC5F7(Vec_$ctor_Z7AD9E565(5, 3, 2));
        const transformed_1 = Polyline3D__Transform_3CAE9522(pl_53, m);
        Expect_isTrue(((a_82 = Polyline3D__get_FirstPoint(transformed_1), (b_82 = Pnt_$ctor_Z7AD9E565(5, 3, 2), (x_49 = (a_82.X - b_82.X), (y_49 = (a_82.Y - b_82.Y), (z_40 = (a_82.Z - b_82.Z), Math.sqrt(((x_49 * x_49) + (y_49 * y_49)) + (z_40 * z_40)))))))) < 1E-09)("Transform translation - first point");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_49, Test_TestCaseBuilder__Delay_1505(builder$0040_49, () => {
        ...
        const pts_44 = [Pnt_$ctor_Z7AD9E565(0, 0, 0), Pnt_$ctor_Z7AD9E565(1, 0, 0)];
        const pl_54 = Polyline3D_$ctor_516DFD0A(pts_44);
        const m_1 = Matrix_createTranslation_Z394EC5F7(Vec_$ctor_Z7AD9E565(5, 3, 2));
        const transformed_2 = Polyline3D_transform(m_1, pl_54);
        Expect_isTrue(((a_84 = Polyline3D__get_FirstPoint(transformed_2), (b_84 = Pnt_$ctor_Z7AD9E565(5, 3, 2), (x_50 = (a_84.X - b_84.X), (y_50 = (a_84.Y - b_84.Y), (z_41 = (a_84.Z - b_84.Z), Math.sqrt(((x_50 * x_50) + (y_50 * y_50)) + (z_41 * z_41)))))))) < 1E-09)("transform static - first point");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_50, Test_TestCaseBuilder__Delay_1505(builder$0040_50, () => {
        ...
        const pts_45 = [Pnt_$ctor_Z7AD9E565(0, 0, 0), Pnt_$ctor_Z7AD9E565(1, 0, 0)];
        const pl_56 = Polyline3D_$ctor_516DFD0A(pts_45);
        const m_3 = RigidMatrix_createTranslation_Z394EC5F7(Vec_$ctor_Z7AD9E565(5, 3, 2));
        const transformed_3 = Polyline3D__TransformRigid_Z625426AD(pl_56, m_3);
        Expect_isTrue(((a_86 = Polyline3D__get_FirstPoint(transformed_3), (b_86 = Pnt_$ctor_Z7AD9E565(5, 3, 2), (x_51 = (a_86.X - b_86.X), (y_51 = (a_86.Y - b_86.Y), (z_42 = (a_86.Z - b_86.Z), Math.sqrt(((x_51 * x_51) + (y_51 * y_51)) + (z_42 * z_42)))))))) < 1E-09)("TransformRigid - first point");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_51, Test_TestCaseBuilder__Delay_1505(builder$0040_51, () => {
        ...
        const pts_46 = [Pnt_$ctor_Z7AD9E565(0, 0, 0), Pnt_$ctor_Z7AD9E565(1, 0, 0)];
        const pl_57 = Polyline3D_$ctor_516DFD0A(pts_46);
        const m_4 = RigidMatrix_createTranslation_Z394EC5F7(Vec_$ctor_Z7AD9E565(5, 3, 2));
        const transformed_4 = Polyline3D_transformRigid(m_4, pl_57);
        Expect_isTrue(((a_88 = Polyline3D__get_FirstPoint(transformed_4), (b_88 = Pnt_$ctor_Z7AD9E565(5, 3, 2), (x_52 = (a_88.X - b_88.X), (y_52 = (a_88.Y - b_88.Y), (z_43 = (a_88.Z - b_88.Z), Math.sqrt(((x_52 * x_52) + (y_52 * y_52)) + (z_43 * z_43)))))))) < 1E-09)("transformRigid static - first point");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_52, Test_TestCaseBuilder__Delay_1505(builder$0040_52, () => {
        ...
        const pts_47 = [Pnt_$ctor_Z7AD9E565(1, 2, 3), Pnt_$ctor_Z7AD9E565(4, 5, 6)];
        const pl_59 = Polyline3D_$ctor_516DFD0A(pts_47);
        const rotated = Polyline3D__Rotate_Z2A007687(pl_59, Quaternion_$ctor_77D16AC0(0, 0, 0, 1));
        Expect_isTrue(((a_90 = Polyline3D__get_FirstPoint(rotated), (b_90 = Polyline3D__get_FirstPoint(pl_59), (x_54 = (a_90.X - b_90.X), (y_54 = (a_90.Y - b_90.Y), (z_45 = (a_90.Z - b_90.Z), Math.sqrt(((x_54 * x_54) + (y_54 * y_54)) + (z_45 * z_45)))))))) < 1E-09)("Rotate identity - first point");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_53, Test_TestCaseBuilder__Delay_1505(builder$0040_53, () => {
        let a_92, b_92, x_57, y_57, z_48;
        const pts_48 = [Pnt_$ctor_Z7AD9E565(1, 0, 0), Pnt_$ctor_Z7AD9E565(2, 0, 0)];
        const pl_60 = Polyline3D_$ctor_516DFD0A(pts_48);
        let q;
        ...
        const rotated_1 = Polyline3D__Rotate_Z2A007687(pl_60, q);
        Expect_isTrue(((a_92 = Polyline3D__get_FirstPoint(rotated_1), (b_92 = Pnt_$ctor_Z7AD9E565(0, 1, 0), (x_57 = (a_92.X - b_92.X), (y_57 = (a_92.Y - b_92.Y), (z_48 = (a_92.Z - b_92.Z), Math.sqrt(((x_57 * x_57) + (y_57 * y_57)) + (z_48 * z_48)))))))) < 1E-09)("Rotate 90 - first point");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_54, Test_TestCaseBuilder__Delay_1505(builder$0040_54, () => {
        let a_94, b_94, x_60, y_60, z_51;
        const pts_49 = [Pnt_$ctor_Z7AD9E565(1, 0, 0), Pnt_$ctor_Z7AD9E565(2, 0, 0)];
        const pl_61 = Polyline3D_$ctor_516DFD0A(pts_49);
        let q_1;
        ...
        const rotated_2 = Polyline3D_rotateByQuaternion(q_1, pl_61);
        Expect_isTrue(((a_94 = Polyline3D__get_FirstPoint(rotated_2), (b_94 = Pnt_$ctor_Z7AD9E565(0, 1, 0), (x_60 = (a_94.X - b_94.X), (y_60 = (a_94.Y - b_94.Y), (z_51 = (a_94.Z - b_94.Z), Math.sqrt(((x_60 * x_60) + (y_60 * y_60)) + (z_51 * z_51)))))))) < 1E-09)("rotateByQuaternion - first point");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_55, Test_TestCaseBuilder__Delay_1505(builder$0040_55, () => {
        let a_96, b_96, x_63, y_63, z_54;
        const pts_50 = [Pnt_$ctor_Z7AD9E565(0, 0, 0), Pnt_$ctor_Z7AD9E565(2, 0, 0), Pnt_$ctor_Z7AD9E565(2, 2, 0), Pnt_$ctor_Z7AD9E565(0, 2, 0)];
        const pl_63 = Polyline3D_$ctor_516DFD0A(pts_50);
        ...
        q_3 = Quaternion_$ctor_77D16AC0(axis_5.X * sa_2, axis_5.Y * sa_2, axis_5.Z * sa_2, Math.cos(angHalf_2));
        const rotated_3 = Polyline3D__RotateWithCenter_4928E16A(pl_63, center, q_3);
        Expect_isTrue(((a_96 = Polyline3D__get_Center(rotated_3), (b_96 = center, (x_63 = (a_96.X - b_96.X), (y_63 = (a_96.Y - b_96.Y), (z_54 = (a_96.Z - b_96.Z), Math.sqrt(((x_63 * x_63) + (y_63 * y_63)) + (z_54 * z_54)))))))) < 1E-09)("RotateWithCenter - center");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_56, Test_TestCaseBuilder__Delay_1505(builder$0040_56, () => {
        let a_98, b_98, x_66, y_66, z_57;
        const pts_51 = [Pnt_$ctor_Z7AD9E565(0, 0, 0), Pnt_$ctor_Z7AD9E565(2, 0, 0), Pnt_$ctor_Z7AD9E565(2, 2, 0), Pnt_$ctor_Z7AD9E565(0, 2, 0)];
        const pl_64 = Polyline3D_$ctor_516DFD0A(pts_51);
        ...
        q_4 = Quaternion_$ctor_77D16AC0(axis_7.X * sa_3, axis_7.Y * sa_3, axis_7.Z * sa_3, Math.cos(angHalf_3));
        const rotated_4 = Polyline3D_rotateWithCenterByQuaternion(center_1, q_4, pl_64);
        Expect_isTrue(((a_98 = Polyline3D__get_Center(rotated_4), (b_98 = center_1, (x_66 = (a_98.X - b_98.X), (y_66 = (a_98.Y - b_98.Y), (z_57 = (a_98.Z - b_98.Z), Math.sqrt(((x_66 * x_66) + (y_66 * y_66)) + (z_57 * z_57)))))))) < 1E-09)("rotateWithCenterByQuaternion - center");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_57, Test_TestCaseBuilder__Delay_1505(builder$0040_57, () => {
        ...
        const pts_52 = [Pnt_$ctor_Z7AD9E565(1, 2, 3), Pnt_$ctor_Z7AD9E565(2, 4, 6)];
        const pl_66 = Polyline3D_$ctor_516DFD0A(pts_52);
        const scaled = Polyline3D__Scale_5E38073B(pl_66, 2);
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_58, Test_TestCaseBuilder__Delay_1505(builder$0040_58, () => {
        ...
        const pts_53 = [Pnt_$ctor_Z7AD9E565(1, 2, 3), Pnt_$ctor_Z7AD9E565(2, 4, 6)];
        const pl_67 = Polyline3D_$ctor_516DFD0A(pts_53);
        const scaled_1 = Polyline3D_scale(2, pl_67);
        Expect_isTrue(((a_104 = Polyline3D__get_FirstPoint(scaled_1), (b_104 = Pnt_$ctor_Z7AD9E565(2, 4, 6), (x_69 = (a_104.X - b_104.X), (y_69 = (a_104.Y - b_104.Y), (z_60 = (a_104.Z - b_104.Z), Math.sqrt(((x_69 * x_69) + (y_69 * y_69)) + (z_60 * z_60)))))))) < 1E-09)("scale static - first point");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_59, Test_TestCaseBuilder__Delay_1505(builder$0040_59, () => {
        let a_106, b_106, x_70, y_70, z_61;
        const pts_54 = [Pnt_$ctor_Z7AD9E565(1, 0, 0), Pnt_$ctor_Z7AD9E565(2, 0, 0)];
        const pl_69 = Polyline3D_$ctor_516DFD0A(pts_54);
        let r;
        const rad = 0.017453292519943295 * 90;
        r = Rotation2D_$ctor_7B00E9A0(Math.sin(rad), Math.cos(rad));
        const rotated_5 = Polyline3D_rotate2D(r, pl_69);
        Expect_isTrue(((a_106 = Polyline3D__get_FirstPoint(rotated_5), (b_106 = Pnt_$ctor_Z7AD9E565(0, 1, 0), (x_70 = (a_106.X - b_106.X), (y_70 = (a_106.Y - b_106.Y), (z_61 = (a_106.Z - b_106.Z), Math.sqrt(((x_70 * x_70) + (y_70 * y_70)) + (z_61 * z_61)))))))) < 1E-09)("rotate2D - first point");
