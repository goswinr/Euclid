...
export function Matrix_createPlaneToPlane_3B6074E0(fromPlane, toPlane) {
    const f = Matrix__get_Inverse(Matrix_createToPlane_2F29039F(fromPlane));
    const t = Matrix_createToPlane_2F29039F(toPlane);
    return Matrix_multiply_Z11D053C0(f, t);
}
...
export function Matrix_createMirror_2F29039F(p) {
    ...
    const fromPlane = Matrix__get_Inverse(toPlane);
    const zFlip = Matrix_createScale_Z7AD9E565(1, 1, -1);
    return Matrix_multiply_Z11D053C0(fromPlane, Matrix_multiply_Z11D053C0(zFlip, toPlane));
}
