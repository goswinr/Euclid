...
export function Tria2D_isLinear_365C4B06(a, b, c, distanceTolerance = 1E-06) {
    let tupledArg, lnFrom, lnTo, p, lnSqLen, x_3, y_3, u, v_3, dot, t, x$0027, y$0027, u$0027, v$0027, tupledArg_1, lnFrom_1, lnTo_1, p_1, lnSqLen_1, x_4, y_4, u_1, v_4, dot_1, t_1, x$0027_1, y$0027_1, u$0027_1, v$0027_1, tupledArg_2, lnFrom_2, lnTo_2, p_2, lnSqLen_2, x_5, y_5, u_2, v_5, dot_2, t_2, x$0027_2, y$0027_2, u$0027_2, v$0027_2;
    let ab;
    const a_1 = b;
    const b_1 = a;
    ...
    if (((abLenSq < distSq) ? true : (bcLenSq < distSq)) ? true : (caLenSq < distSq)) {
        ...
        if ((dotA > dotB) && (dotA > dotC)) {
            return ((tupledArg = [b, c, a, bcLenSq], (lnFrom = tupledArg[0], (lnTo = tupledArg[1], (p = tupledArg[2], (lnSqLen = tupledArg[3], (x_3 = (lnFrom.X - lnTo.X), (y_3 = (lnFrom.Y - lnTo.Y), (u = (lnFrom.X - p.X), (v_3 = (lnFrom.Y - p.Y), (dot = ((x_3 * u) + (y_3 * v_3)), (t = (dot / lnSqLen), (x$0027 = (lnFrom.X - (x_3 * t)), (y$0027 = (lnFrom.Y - (y_3 * t)), (u$0027 = (x$0027 - p.X), (v$0027 = (y$0027 - p.Y), (u$0027 * u$0027) + (v$0027 * v$0027))))))))))))))))) < distSq;
        }
        else if ((dotB > dotA) && (dotB > dotC)) {
            return ((tupledArg_1 = [c, a, b, caLenSq], (lnFrom_1 = tupledArg_1[0], (lnTo_1 = tupledArg_1[1], (p_1 = tupledArg_1[2], (lnSqLen_1 = tupledArg_1[3], (x_4 = (lnFrom_1.X - lnTo_1.X), (y_4 = (lnFrom_1.Y - lnTo_1.Y), (u_1 = (lnFrom_1.X - p_1.X), (v_4 = (lnFrom_1.Y - p_1.Y), (dot_1 = ((x_4 * u_1) + (y_4 * v_4)), (t_1 = (dot_1 / lnSqLen_1), (x$0027_1 = (lnFrom_1.X - (x_4 * t_1)), (y$0027_1 = (lnFrom_1.Y - (y_4 * t_1)), (u$0027_1 = (x$0027_1 - p_1.X), (v$0027_1 = (y$0027_1 - p_1.Y), (u$0027_1 * u$0027_1) + (v$0027_1 * v$0027_1))))))))))))))))) < distSq;
        }
        else {
            return ((tupledArg_2 = [a, b, c, abLenSq], (lnFrom_2 = tupledArg_2[0], (lnTo_2 = tupledArg_2[1], (p_2 = tupledArg_2[2], (lnSqLen_2 = tupledArg_2[3], (x_5 = (lnFrom_2.X - lnTo_2.X), (y_5 = (lnFrom_2.Y - lnTo_2.Y), (u_2 = (lnFrom_2.X - p_2.X), (v_5 = (lnFrom_2.Y - p_2.Y), (dot_2 = ((x_5 * u_2) + (y_5 * v_5)), (t_2 = (dot_2 / lnSqLen_2), (x$0027_2 = (lnFrom_2.X - (x_5 * t_2)), (y$0027_2 = (lnFrom_2.Y - (y_5 * t_2)), (u$0027_2 = (x$0027_2 - p_2.X), (v$0027_2 = (y$0027_2 - p_2.Y), (u$0027_2 * u$0027_2) + (v$0027_2 * v$0027_2))))))))))))))))) < distSq;
        }
    }
}
...
export function Tria2D_offsetPt_365C4B06(ptToOffset, prev, next, dist) {
    ...
    if (cosine < -0.9998476951563913) {
        ...
        const a_3 = vPrev;
        const b_3 = vNext;
        v_8 = Vc_$ctor_7B00E9A0(a_3.X - b_3.X, a_3.Y - b_3.Y);
        const p = ptToOffset;
        let v_10;
        const v_9 = v_8;
...
export function Tria2D_offset_365C4B06(a, b, c, dist) {
    let pt_1, nPrev_1, nNext_1, cosine_1, v_12, a_7, v_13, b_7, v_14, p, v_16, v_15, p_1, v_18, v_17, a_8, b_8, f_1, pt_4, nPrev_4, nNext_4, cosine_4, v_19, a_9, v_20, b_9, v_21, p_2, v_23, v_22, p_3, v_25, v_24, a_10, b_10, f_3, pt_7, nPrev_7, nNext_7, cosine_7, v_26, a_11, v_27, b_11, v_28, p_4, v_30, v_29, p_5, v_32, v_31, a_12, b_12, f_5;
    let na;
    let v_3;
    let v_1;
    const a_1 = b;
    ...
    const a_4 = na;
    const b_4 = nc;
    cosineA = ((a_4.X * b_4.X) + (a_4.Y * b_4.Y));
    let cosineB;
    const a_5 = na;
    const b_5 = nb;
    ...
    return [(pt_1 = a, (nPrev_1 = na, (nNext_1 = nc, (cosine_1 = cosineA, (cosine_1 < -0.9998476951563913) ? ((v_12 = ((a_7 = ((v_13 = nPrev_1, UnitVc_$ctor_7B00E9A0(-v_13.Y, v_13.X))), (b_7 = ((v_14 = nNext_1, UnitVc_$ctor_7B00E9A0(v_14.Y, -v_14.X))), Vc_$ctor_7B00E9A0(a_7.X + b_7.X, a_7.Y + b_7.Y)))), (p = pt_1, (v_16 = ((v_15 = v_12, Vc_$ctor_7B00E9A0(v_15.X * 28.645, v_15.Y * 28.645))), Pt_$ctor_7B00E9A0(p.X + v_16.X, p.Y + v_16.Y))))) : ((p_1 = pt_1, (v_18 = ((v_17 = ((a_8 = nPrev_1, (b_8 = nNext_1, Vc_$ctor_7B00E9A0(a_8.X + b_8.X, a_8.Y + b_8.Y)))), (f_1 = (dist / (1 + cosine_1)), Vc_$ctor_7B00E9A0(v_17.X * f_1, v_17.Y * f_1)))), Pt_$ctor_7B00E9A0(p_1.X + v_18.X, p_1.Y + v_18.Y)))))))), (pt_4 = b, (nPrev_4 = na, (nNext_4 = nb, (cosine_4 = cosineB, (cosine_4 < -0.9998476951563913) ? ((v_19 = ((a_9 = ((v_20 = nPrev_4, UnitVc_$ctor_7B00E9A0(-v_20.Y, v_20.X))), (b_9 = ((v_21 = nNext_4, UnitVc_$ctor_7B00E9A0(v_21.Y, -v_21.X))), Vc_$ctor_7B00E9A0(a_9.X + b_9.X, a_9.Y + b_9.Y)))), (p_2 = pt_4, (v_23 = ((v_22 = v_19, Vc_$ctor_7B00E9A0(v_22.X * 28.645, v_22.Y * 28.645))), Pt_$ctor_7B00E9A0(p_2.X + v_23.X, p_2.Y + v_23.Y))))) : ((p_3 = pt_4, (v_25 = ((v_24 = ((a_10 = nPrev_4, (b_10 = nNext_4, Vc_$ctor_7B00E9A0(a_10.X + b_10.X, a_10.Y + b_10.Y)))), (f_3 = (dist / (1 + cosine_4)), Vc_$ctor_7B00E9A0(v_24.X * f_3, v_24.Y * f_3)))), Pt_$ctor_7B00E9A0(p_3.X + v_25.X, p_3.Y + v_25.Y)))))))), (pt_7 = c, (nPrev_7 = nb, (nNext_7 = nc, (cosine_7 = cosineC, (cosine_7 < -0.9998476951563913) ? ((v_26 = ((a_11 = ((v_27 = nPrev_7, UnitVc_$ctor_7B00E9A0(-v_27.Y, v_27.X))), (b_11 = ((v_28 = nNext_7, UnitVc_$ctor_7B00E9A0(v_28.Y, -v_28.X))), Vc_$ctor_7B00E9A0(a_11.X + b_11.X, a_11.Y + b_11.Y)))), (p_4 = pt_7, (v_30 = ((v_29 = v_26, Vc_$ctor_7B00E9A0(v_29.X * 28.645, v_29.Y * 28.645))), Pt_$ctor_7B00E9A0(p_4.X + v_30.X, p_4.Y + v_30.Y))))) : ((p_5 = pt_7, (v_32 = ((v_31 = ((a_12 = nPrev_7, (b_12 = nNext_7, Vc_$ctor_7B00E9A0(a_12.X + b_12.X, a_12.Y + b_12.Y)))), (f_5 = (dist / (1 + cosine_7)), Vc_$ctor_7B00E9A0(v_31.X * f_5, v_31.Y * f_5)))), Pt_$ctor_7B00E9A0(p_5.X + v_32.X, p_5.Y + v_32.Y))))))))];
}
...
export function Tria2D_offsetPtVarByNormals_3ED64C5D(ptToOffset, prevN, nextN, prevDist, nextDist) {
    ...
    if (Math.abs(aXb) > 1E-12) {
        const tPrev = ((a_4 = ((a_3 = nextPt, (b_1 = prevPt, Vc_$ctor_7B00E9A0(a_3.X - b_1.X, a_3.Y - b_1.Y)))), (b_2 = nextDir, (a_4.X * b_2.Y) - (a_4.Y * b_2.X)))) / aXb;
        let xPt;
        const p_2 = prevPt;
        let v_4;
        const a_5 = prevDir;
        const f_2 = tPrev;
        v_4 = Vc_$ctor_7B00E9A0(a_5.X * f_2, a_5.Y * f_2);
        xPt = Pt_$ctor_7B00E9A0(p_2.X + v_4.X, p_2.Y + v_4.Y);
        return xPt;
    }
...
export function Tria2D_offsetPtVar_5FDDACFD(ptToOffset, prev, next, distPrev, distNext) {
    ...
    const v_7 = vNext;
    nNext = UnitVc_$ctor_7B00E9A0(-v_7.Y, v_7.X);
    return Tria2D_offsetPtVarByNormals_3ED64C5D(ptToOffset, nPrev, nNext, distPrev, distNext);
}
