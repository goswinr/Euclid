...
export function Euclid_PPlane__PPlane_createThreePoints_Static(origin, xPt, yPt) {
    let a_2, b_2, v_2, x_5, y_3, z_3, l, f, v_3, x_8, y_5, z_5, l_1, f_1;
    let x;
    const a = xPt;
    const b = origin;
    ...
    const a_4 = z_2;
    const b_4 = x;
    y$0027 = Vec_$ctor_Z7AD9E565((a_4.Y * b_4.Z) - (a_4.Z * b_4.Y), (a_4.Z * b_4.X) - (a_4.X * b_4.Z), (a_4.X * b_4.Y) - (a_4.Y * b_4.X));
    return PPlane_$ctor_3CB4665C(origin, xu, (v_2 = y$0027, (x_5 = v_2.X, (y_3 = v_2.Y, (z_3 = v_2.Z, (l = Math.sqrt(((x_5 * x_5) + (y_3 * y_3)) + (z_3 * z_3)), (!(l > 1E-12) ? failUnit3("Vec.Unitized", x_5, y_3, z_3) : undefined, (f = (1 / l), UnitVec_$ctor_Z7AD9E565(f * x_5, f * y_3, f * z_3)))))))), (v_3 = z_2, (x_8 = v_3.X, (y_5 = v_3.Y, (z_5 = v_3.Z, (l_1 = Math.sqrt(((x_8 * x_8) + (y_5 * y_5)) + (z_5 * z_5)), (!(l_1 > 1E-12) ? failUnit3("Vec.Unitized", x_8, y_5, z_5) : undefined, (f_1 = (1 / l_1), UnitVec_$ctor_Z7AD9E565(f_1 * x_8, f_1 * y_5, f_1 * z_5)))))))));
}
...
export function Euclid_PPlane__PPlane_createOriginXaxisYaxis_Static_58CBC093(origin, xAxis, yAxis) {
    let a, b, v, x, y_1, z_1, l, f, v_1, x_3, y_3, z_3, l_1, f_1;
    ...
    const a_2 = z;
    const b_2 = xAxis;
    y = Vec_$ctor_Z7AD9E565_1((a_2.Y * b_2.Z) - (a_2.Z * b_2.Y), (a_2.Z * b_2.X) - (a_2.X * b_2.Z), (a_2.X * b_2.Y) - (a_2.Y * b_2.X));
    return PPlane_$ctor_3CB4665C(origin, xAxis, (v = y, (x = v.X, (y_1 = v.Y, (z_1 = v.Z, (l = Math.sqrt(((x * x) + (y_1 * y_1)) + (z_1 * z_1)), (!(l > 1E-12) ? failUnit3("Vec.Unitized", x, y_1, z_1) : undefined, (f = (1 / l), UnitVec_$ctor_Z7AD9E565(f * x, f * y_1, f * z_1)))))))), (v_1 = z, (x_3 = v_1.X, (y_3 = v_1.Y, (z_3 = v_1.Z, (l_1 = Math.sqrt(((x_3 * x_3) + (y_3 * y_3)) + (z_3 * z_3)), (!(l_1 > 1E-12) ? failUnit3("Vec.Unitized", x_3, y_3, z_3) : undefined, (f_1 = (1 / l_1), UnitVec_$ctor_Z7AD9E565(f_1 * x_3, f_1 * y_3, f_1 * z_3)))))))));
}
...
export function Euclid_PPlane__PPlane_createOriginXaxisYaxis_Static_6181AF53(origin, xAxis, yAxis) {
    ...
    const yu = UnitVec_$ctor_Z7AD9E565(yAxis.X * yf, yAxis.Y * yf, yAxis.Z * yf);
    return Euclid_PPlane__PPlane_createOriginXaxisYaxis_Static_58CBC093(origin, xu, yu);
}
...
export function Euclid_PPlane__PPlane_createOriginNormal_Static_Z2DDF2344(origin, normal) {
    let other, a, b, v, x_2, y_2, z_1, l, f, v_1, x_5, y_4, z_3, l_1, f_1, v_2, x_9, y_7, z_5, l_2, f_2, v_3, x_12, y_9, z_7, l_3, f_3;
    if ((other = UnitVec_$ctor_Z7AD9E565(0, 0, 1), Math.abs((a = other, (b = normal, ((a.X * b.X) + (a.Y * b.Y)) + (a.Z * b.Z)))) > 0.9999619230641713)) {
        ...
        const a_2 = y_1;
        const b_2 = normal;
        x_1 = Vec_$ctor_Z7AD9E565_1((a_2.Y * b_2.Z) - (a_2.Z * b_2.Y), (a_2.Z * b_2.X) - (a_2.X * b_2.Z), (a_2.X * b_2.Y) - (a_2.Y * b_2.X));
        return PPlane_$ctor_3CB4665C(origin, (v = x_1, (x_2 = v.X, (y_2 = v.Y, (z_1 = v.Z, (l = Math.sqrt(((x_2 * x_2) + (y_2 * y_2)) + (z_1 * z_1)), (!(l > 1E-12) ? failUnit3("Vec.Unitized", x_2, y_2, z_1) : undefined, (f = (1 / l), UnitVec_$ctor_Z7AD9E565(f * x_2, f * y_2, f * z_1)))))))), (v_1 = y_1, (x_5 = v_1.X, (y_4 = v_1.Y, (z_3 = v_1.Z, (l_1 = Math.sqrt(((x_5 * x_5) + (y_4 * y_4)) + (z_3 * z_3)), (!(l_1 > 1E-12) ? failUnit3("Vec.Unitized", x_5, y_4, z_3) : undefined, (f_1 = (1 / l_1), UnitVec_$ctor_Z7AD9E565(f_1 * x_5, f_1 * y_4, f_1 * z_3)))))))), normal);
    }
    else {
        let x_8;
...
export function Euclid_PPlane__PPlane_createOriginNormal_Static_5A66521A(origin, normal) {
    ...
    const f = 1 / len;
    const nu = UnitVec_$ctor_Z7AD9E565(normal.X * f, normal.Y * f, normal.Z * f);
    return Euclid_PPlane__PPlane_createOriginNormal_Static_Z2DDF2344(origin, nu);
}
...
export function Euclid_PPlane__PPlane_createOriginNormalXaxis_Static_58CBC093(origin, normal, xAxis) {
    let a, b, v, x_1, y_1, z, l, f, v_1, x_4, y_3, z_2, l_1, f_1;
    ...
    const a_2 = y;
    const b_2 = normal;
    x = Vec_$ctor_Z7AD9E565_1((a_2.Y * b_2.Z) - (a_2.Z * b_2.Y), (a_2.Z * b_2.X) - (a_2.X * b_2.Z), (a_2.X * b_2.Y) - (a_2.Y * b_2.X));
    return PPlane_$ctor_3CB4665C(origin, (v = x, (x_1 = v.X, (y_1 = v.Y, (z = v.Z, (l = Math.sqrt(((x_1 * x_1) + (y_1 * y_1)) + (z * z)), (!(l > 1E-12) ? failUnit3("Vec.Unitized", x_1, y_1, z) : undefined, (f = (1 / l), UnitVec_$ctor_Z7AD9E565(f * x_1, f * y_1, f * z)))))))), (v_1 = y, (x_4 = v_1.X, (y_3 = v_1.Y, (z_2 = v_1.Z, (l_1 = Math.sqrt(((x_4 * x_4) + (y_3 * y_3)) + (z_2 * z_2)), (!(l_1 > 1E-12) ? failUnit3("Vec.Unitized", x_4, y_3, z_2) : undefined, (f_1 = (1 / l_1), UnitVec_$ctor_Z7AD9E565(f_1 * x_4, f_1 * y_3, f_1 * z_2)))))))), normal);
}
...
export function Euclid_PPlane__PPlane_createOriginNormalXaxis_Static_6181AF53(origin, normal, xAxis) {
    ...
    const nf = 1 / ln;
    const xu = UnitVec_$ctor_Z7AD9E565(xAxis.X * xf, xAxis.Y * xf, xAxis.Z * xf);
    const nu = UnitVec_$ctor_Z7AD9E565(normal.X * nf, normal.Y * nf, normal.Z * nf);
    return Euclid_PPlane__PPlane_createOriginNormalXaxis_Static_58CBC093(origin, nu, xu);
}
...
export function Euclid_PPlane__PPlane_transform_Static(m, pl) {
    ...
    const y = v.Y;
    const z = v.Z;
    o = Pnt_$ctor_Z7AD9E565((((m_4.M11 * x) + (m_4.M21 * y)) + (m_4.M31 * z)) + m_4.X41, (((m_4.M12 * x) + (m_4.M22 * y)) + (m_4.M32 * z)) + m_4.Y42, (((m_4.M13 * x) + (m_4.M23 * y)) + (m_4.M33 * z)) + m_4.Z43);
    let x_3;
    const v_4 = pl.Xaxis;
    const m_8 = m;
    const x_1 = v_4.X;
    const y_1 = v_4.Y;
    const z_1 = v_4.Z;
    x_3 = UnitVec_$ctor_Z7AD9E565(((m_8.M11 * x_1) + (m_8.M21 * y_1)) + (m_8.M31 * z_1), ((m_8.M12 * x_1) + (m_8.M22 * y_1)) + (m_8.M32 * z_1), ((m_8.M13 * x_1) + (m_8.M23 * y_1)) + (m_8.M33 * z_1));
    let y_5;
    const v_8 = pl.Yaxis;
    const m_12 = m;
    const x_4 = v_8.X;
    const y_3 = v_8.Y;
    const z_3 = v_8.Z;
    y_5 = UnitVec_$ctor_Z7AD9E565(((m_12.M11 * x_4) + (m_12.M21 * y_3)) + (m_12.M31 * z_3), ((m_12.M12 * x_4) + (m_12.M22 * y_3)) + (m_12.M32 * z_3), ((m_12.M13 * x_4) + (m_12.M23 * y_3)) + (m_12.M33 * z_3));
    let z_7;
    const v_12 = pl.Zaxis;
    const m_16 = m;
    const x_6 = v_12.X;
    const y_6 = v_12.Y;
    const z_5 = v_12.Z;
    z_7 = UnitVec_$ctor_Z7AD9E565(((m_16.M11 * x_6) + (m_16.M21 * y_6)) + (m_16.M31 * z_5), ((m_16.M12 * x_6) + (m_16.M22 * y_6)) + (m_16.M32 * z_5), ((m_16.M13 * x_6) + (m_16.M23 * y_6)) + (m_16.M33 * z_5));
    return PPlane_$ctor_3CB4665C(o, x_3, y_5, z_7);
}
...
export function Euclid_PPlane__PPlane_intersect_Static(a, b) {
    ...
    if (!(((v_1 = v, ((v_1.X * v_1.X) + (v_1.Y * v_1.Y)) + (v_1.Z * v_1.Z))) > 1E-12)) {
        ...
        const ao = a.Origin;
        const t = ((a_4 = ((a_5 = b.Origin, (b_5 = ao, Vec_$ctor_Z7AD9E565(a_5.X - b_5.X, a_5.Y - b_5.Y, a_5.Z - b_5.Z)))), (b_4 = bn, ((a_4.X * b_4.X) + (a_4.Y * b_4.Y)) + (a_4.Z * b_4.Z)))) / nenner;
        let xpt;
        const p = ao;
        let v_2;
        const a_6 = pa;
        ...
        const l = Line3D_$ctor_76A78260(xpt.X, xpt.Y, xpt.Z, xpt.X + v.X, xpt.Y + v.Y, xpt.Z + v.Z);
        return l;
    }
}
