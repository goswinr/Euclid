...
export function Euclid_Line3D__Line3D_ClosestPoints_4CC2E360(lnA, lnB) {
    let ln, ln_1, ln_2, ln_3, ln_4, ln_5, ln_6, ln_7, ln_8, ln_9, pAx, pAy, pAz, vAx, ln_10, vAy, ln_11, vAz, ln_12, t, vAx_1, vAy_1, vAz_1, u, v, w, dotV, lenSq, clPtX, clPtY, clPtZ, ln_13, pAx_2, pAy_2, pAz_2, vAx_2, ln_14, vAy_2, ln_15, vAz_2, ln_16, t_1, vAx_3, vAy_3, vAz_3, u_1, v_1, w_1, dotV_1, lenSq_1, clPtX_1, clPtY_1, clPtZ_1, ln_17;
    let matchValue;
    const lineA = lnA;
    const lineB = lnB;
    ...
    switch (matchValue.tag) {
        case 1: {
            const pB = matchValue.fields[1];
            const pA = matchValue.fields[0];
            return [pA, pB];
        }
        case 2: {
            const pB_1 = matchValue.fields[1];
            const pA_1 = matchValue.fields[0];
            return [pA_1, pB_1];
        }
        case 3: {
            const pB_2 = matchValue.fields[1];
            const pA_2 = matchValue.fields[0];
            return [pA_2, pB_2];
        }
        case 6:
...
export function Euclid_Line3D__Line3D_ClosestParameters_4CC2E360(lnA, lnB) {
    let ln, ln_1, ln_2, ln_3, ln_4, ln_5, ln_6, x_2, vAx, ln_7, vAy, ln_8, vAz, ln_9, u, v, w, dotV, lenSq, ln_10, x_5, vAx_1, ln_11, vAy_1, ln_12, vAz_1, ln_13, u_1, v_1, w_1, dotV_1, lenSq_1;
    let matchValue;
    const lineA = lnA;
    const lineB = lnB;
    ...
    switch (matchValue.tag) {
        case 1: {
            const tB_1 = matchValue.fields[1];
            const tA_1 = matchValue.fields[0];
            return [tA_1, tB_1];
        }
        case 2: {
            const tB_2 = matchValue.fields[1];
            const tA_2 = matchValue.fields[0];
            return [tA_2, tB_2];
        }
        case 3: {
            const tB_3 = matchValue.fields[1];
            const tA_3 = matchValue.fields[0];
            return [tA_3, tB_3];
        }
        case 6:
            return [0, 0];
        case 4:
            return [0, (ln_6 = lnB, (x_2 = ((vAx = ((ln_7 = ln_6, ln_7.ToX - ln_7.FromX)), (vAy = ((ln_8 = ln_6, ln_8.ToY - ln_8.FromY)), (vAz = ((ln_9 = ln_6, ln_9.ToZ - ln_9.FromZ)), (u = (lnA.FromX - ln_6.FromX), (v = (lnA.FromY - ln_6.FromY), (w = (lnA.FromZ - ln_6.FromZ), (dotV = (((vAx * u) + (vAy * v)) + (vAz * w)), (lenSq = (((vAx * vAx) + (vAy * vAy)) + (vAz * vAz)), dotV / lenSq))))))))), (x_2 > 0) ? ((x_2 < 1) ? x_2 : 1) : 0))];
        case 5:
            return [(ln_10 = lnA, (x_5 = ((vAx_1 = ((ln_11 = ln_10, ln_11.ToX - ln_11.FromX)), (vAy_1 = ((ln_12 = ln_10, ln_12.ToY - ln_12.FromY)), (vAz_1 = ((ln_13 = ln_10, ln_13.ToZ - ln_13.FromZ)), (u_1 = (lnB.FromX - ln_10.FromX), (v_1 = (lnB.FromY - ln_10.FromY), (w_1 = (lnB.FromZ - ln_10.FromZ), (dotV_1 = (((vAx_1 * u_1) + (vAy_1 * v_1)) + (vAz_1 * w_1)), (lenSq_1 = (((vAx_1 * vAx_1) + (vAy_1 * vAy_1)) + (vAz_1 * vAz_1)), dotV_1 / lenSq_1))))))))), (x_5 > 0) ? ((x_5 < 1) ? x_5 : 1) : 0)), 0];
        default: {
            const tB = matchValue.fields[1];
            const tA = matchValue.fields[0];
            return [tA, tB];
        }
    }
}
...
export function Euclid_Line3D__Line3D_RayClosestPoints_4CC2E360(lnA, lnB) {
    ...
    switch (matchValue.tag) {
        ...
        default: {
            const u = matchValue.fields[1];
            const t = matchValue.fields[0];
            return [(ln_6 = lnA, (p = t, Pnt_$ctor_Z7AD9E565_1(ln_6.FromX + (((ln_7 = ln_6, ln_7.ToX - ln_7.FromX)) * p), ln_6.FromY + (((ln_8 = ln_6, ln_8.ToY - ln_8.FromY)) * p), ln_6.FromZ + (((ln_9 = ln_6, ln_9.ToZ - ln_9.FromZ)) * p)))), (ln_10 = lnB, (p_1 = u, Pnt_$ctor_Z7AD9E565_1(ln_10.FromX + (((ln_11 = ln_10, ln_11.ToX - ln_11.FromX)) * p_1), ln_10.FromY + (((ln_12 = ln_10, ln_12.ToY - ln_12.FromY)) * p_1), ln_10.FromZ + (((ln_13 = ln_10, ln_13.ToZ - ln_13.FromZ)) * p_1))))];
        }
    }
}
...
export function Euclid_Line3D__Line3D_SqDistanceRayPoint_Z394ECE4D(ln, p) {
    ...
    const t = dot / lenSq;
    const x$0027 = lnFromX - (x * t);
    const y$0027 = lnFromY - (y * t);
    const z$0027 = lnFromZ - (z * t);
    const u$0027 = x$0027 - p.X;
    const v$0027 = y$0027 - p.Y;
    const w$0027 = z$0027 - p.Z;
...
export function Euclid_Line3D__Line3D_offset_Static(distHorizontal, distNormal, l) {
    ...
    shift = Vec_$ctor_Z7AD9E565(a_4.X + b_2.X, a_4.Y + b_2.Y, a_4.Z + b_2.Z);
    const ln_6 = l;
    const v_9 = shift;
...
export function Euclid_Line3D__Line3D_divide_Static(segments, ln) {
    ...
    if (segments === 1) {
        ...
        for (let i = 1; i <= (segments - 1); i++) {
            const t = i / kk;
            setItem(r, i, Pnt_$ctor_Z7AD9E565_1(sx + (x * t), sy + (y * t), sz + (z * t)));
        }
...
export function Euclid_Line3D__Line3D_divideMinLength_Static(minSegmentLength, ln) {
    ...
    return Euclid_Line3D__Line3D_divide_Static(k, ln);
}
...
export function Euclid_Line3D__Line3D_splitMinLength_Static(gap, minSegmentLength, ln) {
    ...
    return Euclid_Line3D__Line3D_split_Static(gap, k, ln);
}
...
export function Euclid_Line3D__Line3D_projectOntoRayParam_Static(rayToProjectOnto, lineToProject) {
    ...
    const w = lineToProject.FromZ - osz;
    const dot = ((ovx * u) + (ovy * v)) + (ovz * w);
    const s = dot / lenSq;
    const u_1 = lineToProject.ToX - osx;
    const v_1 = lineToProject.ToY - osy;
    const w_1 = lineToProject.ToZ - osz;
    const dot_1 = ((ovx * u_1) + (ovy * v_1)) + (ovz * w_1);
    const e = dot_1 / lenSq;
    return [s, e];
}
...
export function Euclid_Line3D__Line3D_doRaysIntersect_Static(lnA, lnB) {
    ...
    const dy = pBy - pAy;
    const dz = pBz - pAz;
    const numerX = (dy * vBz_1) - (dz * vBy_1);
    const numerY = (dz * vBx_1) - (dx * vBz_1);
    const numerZ = (dx * vBy_1) - (dy * vBx_1);
    const numerator = ((numerX * crossX) + (numerY * crossY)) + (numerZ * crossZ);
    tA = (numerator / crossMagSq);
    if ((tA > -1000000000000) && (tA < 1000000000000)) {
        const clPtAx = pAx + (tA * vAx);
        const clPtAy = pAy + (tA * vAy);
        const clPtAz = pAz + (tA * vAz);
        let d;
        const pAx_2 = pBx;
        const pAy_2 = pBy;
        const pAz_2 = pBz;
        ...
        const v = y - pAy_2;
        const w = z - pAz_2;
        const dotV = ((vAx_3 * u) + (vAy_3 * v)) + (vAz_3 * w);
        const lenSq = ((vAx_3 * vAx_3) + (vAy_3 * vAy_3)) + (vAz_3 * vAz_3);
        t = (dotV / lenSq);
        const clPtX = pAx_2 + (vAx_2 * t);
        const clPtY = pAy_2 + (vAy_2 * t);
        const clPtZ = pAz_2 + (vAz_2 * t);
        const vx = clPtX - x;
        const vy = clPtY - y;
        const vz = clPtZ - z;
        d = (((vx * vx) + (vy * vy)) + (vz * vz));
        return d < (1E-06 * 1E-06);
    }
    else {
        return false;
    }
...
export function Euclid_Line3D__Line3D_doIntersectOrOverlap_Static(lnA, lnB) {
    let ln, ln_1, ln_2, ln_3, ln_4, ln_5, ln_6, ln_7, ln_8, ln_9, ln_10, ln_11, a, b, dx, dy, dz, ln_12, pAx, pAy, pAz, vAx, ln_13, vAy, ln_14, vAz, ln_15, x_1, y_1, z_1, t, x_3, vAx_1, vAy_1, vAz_1, u, v, w, dotV, lenSq, clPtX, clPtY, clPtZ, vx, vy, vz, vx_1, vy_1, vz_1, vx_2, vy_2, vz_2, ln_16, pAx_2, pAy_2, pAz_2, vAx_2, ln_17, vAy_2, ln_18, vAz_2, ln_19, x_5, y_4, z_4, t_1, x_7, vAx_3, vAy_3, vAz_3, u_1, v_1, w_1, dotV_1, lenSq_1, clPtX_1, clPtY_1, clPtZ_1, vx_3, vy_3, vz_3, vx_1_1, vy_1_1, vz_1_1, vx_2_1, vy_2_1, vz_2_1;
    let matchValue;
    const lnA_1 = lnA;
    const lnB_1 = lnB;
    ...
    switch (matchValue.tag) {
        ...
        case 4:
            return ((ln_12 = lnB, (pAx = ln_12.FromX, (pAy = ln_12.FromY, (pAz = ln_12.FromZ, (vAx = ((ln_13 = ln_12, ln_13.ToX - ln_13.FromX)), (vAy = ((ln_14 = ln_12, ln_14.ToY - ln_14.FromY)), (vAz = ((ln_15 = ln_12, ln_15.ToZ - ln_15.FromZ)), (x_1 = lnA.FromX, (y_1 = lnA.FromY, (z_1 = lnA.FromZ, (t = ((x_3 = ((vAx_1 = vAx, (vAy_1 = vAy, (vAz_1 = vAz, (u = (x_1 - pAx), (v = (y_1 - pAy), (w = (z_1 - pAz), (dotV = (((vAx_1 * u) + (vAy_1 * v)) + (vAz_1 * w)), (lenSq = (((vAx_1 * vAx_1) + (vAy_1 * vAy_1)) + (vAz_1 * vAz_1)), dotV / lenSq))))))))), (x_3 > 0) ? ((x_3 < 1) ? x_3 : 1) : 0)), (t > -1E-06) ? ((t < 1.000001) ? ((clPtX = (pAx + (vAx * t)), (clPtY = (pAy + (vAy * t)), (clPtZ = (pAz + (vAz * t)), (vx = (clPtX - x_1), (vy = (clPtY - y_1), (vz = (clPtZ - z_1), ((vx * vx) + (vy * vy)) + (vz * vz)))))))) : ((vx_1 = ((pAx + vAx) - x_1), (vy_1 = ((pAy + vAy) - y_1), (vz_1 = ((pAz + vAz) - z_1), ((vx_1 * vx_1) + (vy_1 * vy_1)) + (vz_1 * vz_1)))))) : ((vx_2 = (pAx - x_1), (vy_2 = (pAy - y_1), (vz_2 = (pAz - z_1), ((vx_2 * vx_2) + (vy_2 * vy_2)) + (vz_2 * vz_2))))))))))))))))) < 1E-12;
        case 5:
            return ((ln_16 = lnA, (pAx_2 = ln_16.FromX, (pAy_2 = ln_16.FromY, (pAz_2 = ln_16.FromZ, (vAx_2 = ((ln_17 = ln_16, ln_17.ToX - ln_17.FromX)), (vAy_2 = ((ln_18 = ln_16, ln_18.ToY - ln_18.FromY)), (vAz_2 = ((ln_19 = ln_16, ln_19.ToZ - ln_19.FromZ)), (x_5 = lnB.FromX, (y_4 = lnB.FromY, (z_4 = lnB.FromZ, (t_1 = ((x_7 = ((vAx_3 = vAx_2, (vAy_3 = vAy_2, (vAz_3 = vAz_2, (u_1 = (x_5 - pAx_2), (v_1 = (y_4 - pAy_2), (w_1 = (z_4 - pAz_2), (dotV_1 = (((vAx_3 * u_1) + (vAy_3 * v_1)) + (vAz_3 * w_1)), (lenSq_1 = (((vAx_3 * vAx_3) + (vAy_3 * vAy_3)) + (vAz_3 * vAz_3)), dotV_1 / lenSq_1))))))))), (x_7 > 0) ? ((x_7 < 1) ? x_7 : 1) : 0)), (t_1 > -1E-06) ? ((t_1 < 1.000001) ? ((clPtX_1 = (pAx_2 + (vAx_2 * t_1)), (clPtY_1 = (pAy_2 + (vAy_2 * t_1)), (clPtZ_1 = (pAz_2 + (vAz_2 * t_1)), (vx_3 = (clPtX_1 - x_5), (vy_3 = (clPtY_1 - y_4), (vz_3 = (clPtZ_1 - z_4), ((vx_3 * vx_3) + (vy_3 * vy_3)) + (vz_3 * vz_3)))))))) : ((vx_1_1 = ((pAx_2 + vAx_2) - x_5), (vy_1_1 = ((pAy_2 + vAy_2) - y_4), (vz_1_1 = ((pAz_2 + vAz_2) - z_4), ((vx_1_1 * vx_1_1) + (vy_1_1 * vy_1_1)) + (vz_1_1 * vz_1_1)))))) : ((vx_2_1 = (pAx_2 - x_5), (vy_2_1 = (pAy_2 - y_4), (vz_2_1 = (pAz_2 - z_4), ((vx_2_1 * vx_2_1) + (vy_2_1 * vy_2_1)) + (vz_2_1 * vz_2_1))))))))))))))))) < 1E-12;
        default:
            return true;
    }
}
...
export function Euclid_Line3D__Line3D_tryIntersectOrOverlap_Static(lnA, lnB) {
    let ln, ln_1, ln_2, ln_3, ln_4, ln_5, ln_9, p_1, ln_10, ln_11, ln_12, a, b, dx, dy, dz, ln_13, ln_14, pAx_2, pAy_2, pAz_2, vAx_2, ln_15, vAy_2, ln_16, vAz_2, ln_17, x_3, y_3, z_3, t_1, x_5, vAx_3, vAy_3, vAz_3, u_1, v_1, w_1, dotV_1, lenSq_1, clPtX_1, clPtY_1, clPtZ_1, vx_1, vy_1, vz_1, vx_1_1, vy_1_1, vz_1_1, vx_2, vy_2, vz_2, ln_18, ln_19, pAx_4, pAy_4, pAz_4, vAx_4, ln_20, vAy_4, ln_21, vAz_4, ln_22, x_7, y_6, z_6, t_2, x_9, vAx_5, vAy_5, vAz_5, u_2, v_2, w_2, dotV_2, lenSq_2, clPtX_2, clPtY_2, clPtZ_2, vx_3, vy_3, vz_3, vx_1_2, vy_1_2, vz_1_2, vx_2_1, vy_2_1, vz_2_1, ln_23;
    let matchValue;
    const lineA = lnA;
    const lineB = lnB;
    ...
    switch (matchValue.tag) {
        ...
        case 3: {
            ...
            let vAx;
            const ln_6 = lnA;
            vAx = (ln_6.ToX - ln_6.FromX);
            let vAy;
            const ln_7 = lnA;
            vAy = (ln_7.ToY - ln_7.FromY);
            let vAz;
            const ln_8 = lnA;
            vAz = (ln_8.ToZ - ln_8.FromZ);
            const x = lnB.FromX;
            const y = lnB.FromY;
            const z = lnB.FromZ;
            let t;
            ...
            if (sqDist < 1E-12) {
                ...
                if (matchValue_1 == null) {
                    ...
                    return (ln_9 = lnA, (p_1 = ((s + e) * 0.5), Pnt_$ctor_Z7AD9E565_1(ln_9.FromX + (((ln_10 = ln_9, ln_10.ToX - ln_10.FromX)) * p_1), ln_9.FromY + (((ln_11 = ln_9, ln_11.ToY - ln_11.FromY)) * p_1), ln_9.FromZ + (((ln_12 = ln_9, ln_12.ToZ - ln_12.FromZ)) * p_1))));
                }
            }
            else {
                return undefined;
        ...
        case 4:
            if (((ln_14 = lnB, (pAx_2 = ln_14.FromX, (pAy_2 = ln_14.FromY, (pAz_2 = ln_14.FromZ, (vAx_2 = ((ln_15 = ln_14, ln_15.ToX - ln_15.FromX)), (vAy_2 = ((ln_16 = ln_14, ln_16.ToY - ln_16.FromY)), (vAz_2 = ((ln_17 = ln_14, ln_17.ToZ - ln_17.FromZ)), (x_3 = lnA.FromX, (y_3 = lnA.FromY, (z_3 = lnA.FromZ, (t_1 = ((x_5 = ((vAx_3 = vAx_2, (vAy_3 = vAy_2, (vAz_3 = vAz_2, (u_1 = (x_3 - pAx_2), (v_1 = (y_3 - pAy_2), (w_1 = (z_3 - pAz_2), (dotV_1 = (((vAx_3 * u_1) + (vAy_3 * v_1)) + (vAz_3 * w_1)), (lenSq_1 = (((vAx_3 * vAx_3) + (vAy_3 * vAy_3)) + (vAz_3 * vAz_3)), dotV_1 / lenSq_1))))))))), (x_5 > 0) ? ((x_5 < 1) ? x_5 : 1) : 0)), (t_1 > -1E-06) ? ((t_1 < 1.000001) ? ((clPtX_1 = (pAx_2 + (vAx_2 * t_1)), (clPtY_1 = (pAy_2 + (vAy_2 * t_1)), (clPtZ_1 = (pAz_2 + (vAz_2 * t_1)), (vx_1 = (clPtX_1 - x_3), (vy_1 = (clPtY_1 - y_3), (vz_1 = (clPtZ_1 - z_3), ((vx_1 * vx_1) + (vy_1 * vy_1)) + (vz_1 * vz_1)))))))) : ((vx_1_1 = ((pAx_2 + vAx_2) - x_3), (vy_1_1 = ((pAy_2 + vAy_2) - y_3), (vz_1_1 = ((pAz_2 + vAz_2) - z_3), ((vx_1_1 * vx_1_1) + (vy_1_1 * vy_1_1)) + (vz_1_1 * vz_1_1)))))) : ((vx_2 = (pAx_2 - x_3), (vy_2 = (pAy_2 - y_3), (vz_2 = (pAz_2 - z_3), ((vx_2 * vx_2) + (vy_2 * vy_2)) + (vz_2 * vz_2))))))))))))))))) < 1E-12) {
        ...
        case 5:
            if (((ln_19 = lnA, (pAx_4 = ln_19.FromX, (pAy_4 = ln_19.FromY, (pAz_4 = ln_19.FromZ, (vAx_4 = ((ln_20 = ln_19, ln_20.ToX - ln_20.FromX)), (vAy_4 = ((ln_21 = ln_19, ln_21.ToY - ln_21.FromY)), (vAz_4 = ((ln_22 = ln_19, ln_22.ToZ - ln_22.FromZ)), (x_7 = lnB.FromX, (y_6 = lnB.FromY, (z_6 = lnB.FromZ, (t_2 = ((x_9 = ((vAx_5 = vAx_4, (vAy_5 = vAy_4, (vAz_5 = vAz_4, (u_2 = (x_7 - pAx_4), (v_2 = (y_6 - pAy_4), (w_2 = (z_6 - pAz_4), (dotV_2 = (((vAx_5 * u_2) + (vAy_5 * v_2)) + (vAz_5 * w_2)), (lenSq_2 = (((vAx_5 * vAx_5) + (vAy_5 * vAy_5)) + (vAz_5 * vAz_5)), dotV_2 / lenSq_2))))))))), (x_9 > 0) ? ((x_9 < 1) ? x_9 : 1) : 0)), (t_2 > -1E-06) ? ((t_2 < 1.000001) ? ((clPtX_2 = (pAx_4 + (vAx_4 * t_2)), (clPtY_2 = (pAy_4 + (vAy_4 * t_2)), (clPtZ_2 = (pAz_4 + (vAz_4 * t_2)), (vx_3 = (clPtX_2 - x_7), (vy_3 = (clPtY_2 - y_6), (vz_3 = (clPtZ_2 - z_6), ((vx_3 * vx_3) + (vy_3 * vy_3)) + (vz_3 * vz_3)))))))) : ((vx_1_2 = ((pAx_4 + vAx_4) - x_7), (vy_1_2 = ((pAy_4 + vAy_4) - y_6), (vz_1_2 = ((pAz_4 + vAz_4) - z_6), ((vx_1_2 * vx_1_2) + (vy_1_2 * vy_1_2)) + (vz_1_2 * vz_1_2)))))) : ((vx_2_1 = (pAx_4 - x_7), (vy_2_1 = (pAy_4 - y_6), (vz_2_1 = (pAz_4 - z_6), ((vx_2_1 * vx_2_1) + (vy_2_1 * vy_2_1)) + (vz_2_1 * vz_2_1))))))))))))))))) < 1E-12) {
...
export function Euclid_Line3D__Line3D_tryGetOverlap_Static(lnA, lnB) {
    ...
    if ((((Math.abs(va.X) + Math.abs(va.Y)) + Math.abs(va.Z)) < 1E-06) ? true : (((Math.abs(vb.X) + Math.abs(vb.Y)) + Math.abs(vb.Z)) < 1E-06)) {
        ...
        if (Math.abs(tan) < 0.004363350820701567) {
            ...
            let vAx_1;
            const ln_8 = lnA;
            vAx_1 = (ln_8.ToX - ln_8.FromX);
            let vAy_1;
            const ln_9 = lnA;
            vAy_1 = (ln_9.ToY - ln_9.FromY);
            let vAz_1;
            const ln_10 = lnA;
            vAz_1 = (ln_10.ToZ - ln_10.FromZ);
            const x_2 = lnB.FromX;
            const y_2 = lnB.FromY;
            const z_2 = lnB.FromZ;
            let t;
            ...
            t = (dotV / lenSq);
            const clPtX = pAx + (vAx_1 * t);
            const clPtY = pAy + (vAy_1 * t);
            const clPtZ = pAz + (vAz_1 * t);
            const vx = clPtX - x_2;
            const vy = clPtY - y_2;
            const vz = clPtZ - z_2;
            sqDist = (((vx * vx) + (vy * vy)) + (vz * vz));
...
export function Euclid_Line3D__Line3D_ClosestPointInfinite_Z394ECE4D(ln, p) {
    ...
    const dot = ((x * u) + (y * v)) + (z * w);
    const t = dot / lenSq;
    const x$0027 = ln_1.FromX - (x * t);
    const y$0027 = ln_1.FromY - (y * t);
    const z$0027 = ln_1.FromZ - (z * t);
    return Pnt_$ctor_Z7AD9E565_1(x$0027, y$0027, z$0027);
}
