...
export function Euclid_UnitVc__UnitVc_intersection_Static_54248720(ptA, ptB, vA, vB) {
    let vAx, vAy, vBx, vBy, det, dx, dy, t, u;
    return (vAx = ptB.X, (vAy = ptB.Y, (vBx = vB.X, (vBy = vB.Y, (det = ((vAx * vBy) - (vAy * vBx)), (dx = (vA.X - ptA.X), (dy = (vA.Y - ptA.Y), (t = (((dx * vBy) - (dy * vBx)) / det), (u = (((dx * vAy) - (dy * vAx)) / det), [t, u])))))))));
}
