...
export function Euclid_Pnt__Pnt_rotateXwithCenterBy_Static(cen, r, pt) {
    ...
    const y = pt.Y - cen.Y;
    const z = pt.Z - cen.Z;
    return Pnt_$ctor_Z7AD9E565_1(x + cen.X, ((r.Cos * y) - (r.Sin * z)) + cen.Y, ((r.Sin * y) + (r.Cos * z)) + cen.Z);
}
...
export function Euclid_Pnt__Pnt_rotateYwithCenterBy_Static(cen, r, pt) {
    ...
    const y = pt.Y - cen.Y;
    const z = pt.Z - cen.Z;
    return Pnt_$ctor_Z7AD9E565_1(((r.Sin * z) + (r.Cos * x)) + cen.X, y + cen.Y, ((r.Cos * z) - (r.Sin * x)) + cen.Z);
}
...
export function Euclid_Pnt__Pnt_rotateZwithCenterBy_Static(cen, r, pt) {
    ...
    const y = pt.Y - cen.Y;
    const z = pt.Z - cen.Z;
    return Pnt_$ctor_Z7AD9E565_1(((r.Cos * x) - (r.Sin * y)) + cen.X, ((r.Sin * x) + (r.Cos * y)) + cen.Y, z + cen.Z);
}
...
export function Euclid_Pnt__Pnt_angleInCorner_Static_6180BC13(prevPt, thisPt, nextPt) {
    let a_6, v, x, y, z, l, f, b_6, v_1, x_3, y_2, z_2, l_1, f_1, dot, a_7, b_7, x_6, y_4, z_4, x_7, y_5, z_5;
    let a_1;
    const a = prevPt;
    const b = thisPt;
