...
export function getSimilarityData(ptss) {
    ...
    let ept;
    const p_1 = Pt_$ctor_7B00E9A0(maxX, maxY);
    const v = shift;
    ept = Pt_$ctor_7B00E9A0(p_1.X + v.X, p_1.Y + v.Y);
    return new ObjectToCheck(ept, toArray(delay(() => collect((matchValue) => {
        ...
        if (pts_1.length > 0) {
            ...
            let minX_1 = 1.7976931348623157E+308;
            let minY_1 = 1.7976931348623157E+308;
            let maxX_1 = -1.7976931348623157E+308;
            let maxY_1 = -1.7976931348623157E+308;
            ...
            bb = BRect_$ctor_77D16AC0(minX_1, minY_1, maxX_1, maxY_1);
            return singleton(new GroupInsideObjectToCheck(n, bb, ps));
        }
        else {
            return empty();
        }
