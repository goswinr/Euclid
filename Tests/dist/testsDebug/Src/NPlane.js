...
export class NPlane extends Record {
    ...
    toString() {
        ...
        const n = UnitVec__get_AsString(pl.Normal);
        return `Euclid.NPlane(Origin:${o}| Normal:${n})`;
    }
}
...
export function NPlane__get_AsString(pl) {
    const o = Pnt__get_AsString(pl.Origin);
    const n = UnitVec__get_AsString(pl.Normal);
    return concat("Origin:", o, "| Normal:", ...n);
}
...
export function NPlane_intersect(a, b) {
    let v_1, a_4, a_5, b_5, b_4, p_1, v_3;
    const bn = b.Normal;
    const an = a.Normal;
    const ao = a.Origin;
    let v;
    ...
    if (!(((v_1 = v, ((v_1.X * v_1.X) + (v_1.Y * v_1.Y)) + (v_1.Z * v_1.Z))) > 1E-12)) {
        ...
        return (p_1 = xpt, (v_3 = v, Line3D_$ctor_76A78260(p_1.X, p_1.Y, p_1.Z, p_1.X + v_3.X, p_1.Y + v_3.Y, p_1.Z + v_3.Z)));
    }
}
