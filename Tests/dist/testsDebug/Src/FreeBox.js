...
export class FreeBox {
    ...
    toString() {
        const b = this;
        const sizeX = float(FreeBox__get_SizeX(b));
        const sizeY = float(FreeBox__get_SizeY(b));
        const sizeZ = float(FreeBox__get_SizeZ(b));
        let origin;
        let copyOfStruct = FreeBox__get_Origin(b);
        origin = Pnt__get_AsString(copyOfStruct);
        let xAxis;
        let copyOfStruct_1 = FreeBox__get_Xaxis(b);
        xAxis = Vec__get_AsString(copyOfStruct_1);
        let yAxis;
        let copyOfStruct_2 = FreeBox__get_Yaxis(b);
        yAxis = Vec__get_AsString(copyOfStruct_2);
        let zAxis;
        let copyOfStruct_3 = FreeBox__get_Zaxis(b);
        zAxis = Vec__get_AsString(copyOfStruct_3);
