...
import { sum, contains, ofArray } from "./fable_modules/fable-library-js.5.0.0/List.js";
...
export const tests = Test_testList("Offset3D ", ofArray([Test_testCase("Polyline3D.offset open L-shape in XY plane with Z-up normal", () => {
    let a_2, b_2, x_2, y_2, z_1, a_4, b_4, x_3, y_3, z_2, a_6, b_6, x_4, y_4, z_3;
    const pts = [Pnt_$ctor_Z7AD9E565(0, 0, 0), Pnt_$ctor_Z7AD9E565(10, 0, 0), Pnt_$ctor_Z7AD9E565(10, 10, 0)];
    const pl = Polyline3D_$ctor_516DFD0A(pts);
    const refNormal = UnitVec_$ctor_Z7AD9E565(0, 0, 1);
    const perp = 0;
    const inPlane = 1;
    const result = Polyline3D_offsetWithRef_39D084EF(pl, inPlane, perp, refNormal, false);
    ...
    if ((actual === 3) ? true : !(new Function("try {return this===window;}catch(e){ return false;}"))()) {
        ...
        if (contains(valueType, primitiveTypes, {
            ...
            errorMsg = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%s</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%s</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(arg)(arg_1)("Should have 3 points");
        }
        else {
            errorMsg = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%A</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%A</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(3)(actual)("Should have 3 points");
        }
    ...
    let a_8, b_8, x_7, y_7, z_5, a_10, b_10, x_8, y_8, z_6, a_12, b_12, x_9, y_9, z_7;
    const pts_1 = [Pnt_$ctor_Z7AD9E565(0, 0, 0), Pnt_$ctor_Z7AD9E565(10, 0, 0), Pnt_$ctor_Z7AD9E565(10, 10, 0)];
    const pl_1 = Polyline3D_$ctor_516DFD0A(pts_1);
    const refNormal_1 = UnitVec_$ctor_Z7AD9E565(0, 0, 1);
    const perp_1 = 2;
    const inPlane_1 = 0;
    const result_1 = Polyline3D_offsetWithRef_39D084EF(pl_1, inPlane_1, perp_1, refNormal_1, false);
    recordTestCase("open L-shape with perpendicular offset", pl_1, inPlane_1, perp_1, refNormal_1, result_1);
    ...
    if ((actual_1 === 3) ? true : !(new Function("try {return this===window;}catch(e){ return false;}"))()) {
        ...
        if (contains(valueType_1, primitiveTypes_1, {
            ...
            errorMsg_1 = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%s</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%s</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(arg_6)(arg_1_1)("Should have 3 points");
        }
        else {
            errorMsg_1 = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%A</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%A</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(3)(actual_1)("Should have 3 points");
        }
    ...
    let a_14, b_14, x_12, y_12, z_9, a_16, b_16, x_13, y_13, z_10, a_18, b_18, x_14, y_14, z_11;
    const pts_2 = [Pnt_$ctor_Z7AD9E565(0, 0, 0), Pnt_$ctor_Z7AD9E565(5, 0, 0), Pnt_$ctor_Z7AD9E565(10, 0, 0)];
    const pl_2 = Polyline3D_$ctor_516DFD0A(pts_2);
    const refNormal_2 = UnitVec_$ctor_Z7AD9E565(0, 0, 1);
    const perp_2 = 0;
    const inPlane_2 = 1;
    const result_2 = Polyline3D_offsetWithRef_39D084EF(pl_2, inPlane_2, perp_2, refNormal_2, false);
    recordTestCase("open straight line (colinear)", pl_2, inPlane_2, perp_2, refNormal_2, result_2);
    ...
    if ((actual_2 === 3) ? true : !(new Function("try {return this===window;}catch(e){ return false;}"))()) {
        ...
        if (contains(valueType_2, primitiveTypes_2, {
            ...
            errorMsg_2 = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%s</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%s</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(arg_7)(arg_1_2)("Should have 3 points");
        }
        else {
            errorMsg_2 = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%A</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%A</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(3)(actual_2)("Should have 3 points");
        }
    ...
    let a_20, b_20, x_17, y_17, z_13;
    const pts_3 = [Pnt_$ctor_Z7AD9E565(0, 0, 0), Pnt_$ctor_Z7AD9E565(10, 0, 0), Pnt_$ctor_Z7AD9E565(5, 8.66, 0), Pnt_$ctor_Z7AD9E565(0, 0, 0)];
    const pl_3 = Polyline3D_$ctor_516DFD0A(pts_3);
    const refNormal_3 = UnitVec_$ctor_Z7AD9E565(0, 0, 1);
    const perp_3 = 0;
    const inPlane_3 = 1;
    const result_3 = Polyline3D_offsetWithRef_39D084EF(pl_3, inPlane_3, perp_3, refNormal_3, false);
    recordTestCase("closed triangle", pl_3, inPlane_3, perp_3, refNormal_3, result_3);
    ...
    if ((actual_3 === 4) ? true : !(new Function("try {return this===window;}catch(e){ return false;}"))()) {
        ...
        if (contains(valueType_3, primitiveTypes_3, {
            ...
            errorMsg_3 = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%s</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%s</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(arg_8)(arg_1_3)("Should have 4 points (closed)");
        }
        else {
            errorMsg_3 = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%A</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%A</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(4)(actual_3)("Should have 4 points (closed)");
        }
    ...
    let a_22, b_22, x_20, y_20, z_15, a_24, b_24, x_21, y_21, z_16, a_26, b_26, x_22, y_22, z_17, a_28, b_28, x_23, y_23, z_18;
    const pts_4 = [Pnt_$ctor_Z7AD9E565(0, 0, 0), Pnt_$ctor_Z7AD9E565(10, 0, 0), Pnt_$ctor_Z7AD9E565(10, 10, 0), Pnt_$ctor_Z7AD9E565(0, 10, 0), Pnt_$ctor_Z7AD9E565(0, 0, 0)];
    const pl_4 = Polyline3D_$ctor_516DFD0A(pts_4);
    const refNormal_4 = UnitVec_$ctor_Z7AD9E565(0, 0, 1);
    const perp_4 = 0;
    const inPlane_4 = 1;
    const result_4 = Polyline3D_offsetWithRef_39D084EF(pl_4, inPlane_4, perp_4, refNormal_4, false);
    recordTestCase("closed square inward", pl_4, inPlane_4, perp_4, refNormal_4, result_4);
    ...
    if ((actual_4 === 5) ? true : !(new Function("try {return this===window;}catch(e){ return false;}"))()) {
        ...
        if (contains(valueType_4, primitiveTypes_4, {
            ...
            const arg_9 = int32ToString(5);
            const arg_1_4 = int32ToString(actual_4);
            errorMsg_4 = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%s</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%s</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(arg_9)(arg_1_4)("Should have 5 points (closed)");
        }
        else {
            errorMsg_4 = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%A</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%A</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(5)(actual_4)("Should have 5 points (closed)");
        }
    ...
    let a_30, b_30, x_26, y_26, z_20, a_32, b_32, x_27, y_27, z_21, a_34, b_34, x_28, y_28, z_22, a_36, b_36, x_29, y_29, z_23;
    const pts_5 = [Pnt_$ctor_Z7AD9E565(0, 0, 0), Pnt_$ctor_Z7AD9E565(10, 0, 0), Pnt_$ctor_Z7AD9E565(10, 10, 0), Pnt_$ctor_Z7AD9E565(0, 10, 0), Pnt_$ctor_Z7AD9E565(0, 0, 0)];
    const pl_5 = Polyline3D_$ctor_516DFD0A(pts_5);
    const refNormal_5 = UnitVec_$ctor_Z7AD9E565(0, 0, 1);
    const perp_5 = 0;
    const inPlane_5 = -1;
    const result_5 = Polyline3D_offsetWithRef_39D084EF(pl_5, inPlane_5, perp_5, refNormal_5, false);
    recordTestCase("closed square outward", pl_5, inPlane_5, perp_5, refNormal_5, result_5);
    ...
    if ((actual_5 === 5) ? true : !(new Function("try {return this===window;}catch(e){ return false;}"))()) {
        ...
        if (contains(valueType_5, primitiveTypes_5, {
            ...
            errorMsg_5 = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%s</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%s</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(arg_10)(arg_1_5)("Should have 5 points (closed)");
        }
        else {
            errorMsg_5 = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%A</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%A</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(5)(actual_5)("Should have 5 points (closed)");
        }
    ...
    const pts_6 = [Pnt_$ctor_Z7AD9E565(0, 0, 0), Pnt_$ctor_Z7AD9E565(10, 0, 0), Pnt_$ctor_Z7AD9E565(10, 10, 0)];
    const pl_6 = Polyline3D_$ctor_516DFD0A(pts_6);
    ...
    if ((actual_6 === 3) ? true : !(new Function("try {return this===window;}catch(e){ return false;}"))()) {
        ...
        if (contains(valueType_6, primitiveTypes_6, {
            ...
            errorMsg_6 = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%s</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%s</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(arg_11)(arg_1_6)("Should still have 3 points (loop closes and opens)");
        }
        else {
            errorMsg_6 = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%A</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%A</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(3)(actual_6)("Should still have 3 points (loop closes and opens)");
        }
        throw new Exception(errorMsg_6);
    }
}), Test_testCase("Polyline3D.offset 3D polyline not in XY plane", () => {
    const pts_7 = [Pnt_$ctor_Z7AD9E565(0, 0, 0), Pnt_$ctor_Z7AD9E565(10, 0, 0), Pnt_$ctor_Z7AD9E565(10, 0, 10)];
    const pl_7 = Polyline3D_$ctor_516DFD0A(pts_7);
    ...
    if ((actual_7 === 3) ? true : !(new Function("try {return this===window;}catch(e){ return false;}"))()) {
        ...
        if (contains(valueType_7, primitiveTypes_7, {
            ...
            errorMsg_7 = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%s</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%s</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(arg_12)(arg_1_7)("Should have 3 points");
        }
        else {
            errorMsg_7 = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%A</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%A</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(3)(actual_7)("Should have 3 points");
        }
        throw new Exception(errorMsg_7);
    }
}), Test_testCase("Polyline3D.offset combined in-plane and perpendicular", () => {
    let a_38, b_38, x_36, y_36, z_27, a_40, b_40, x_37, y_37, z_28;
    const pts_8 = [Pnt_$ctor_Z7AD9E565(0, 0, 0), Pnt_$ctor_Z7AD9E565(10, 0, 0)];
    const pl_8 = Polyline3D_$ctor_516DFD0A(pts_8);
    ...
    if ((actual_8 === 2) ? true : !(new Function("try {return this===window;}catch(e){ return false;}"))()) {
        ...
        if (contains(valueType_8, primitiveTypes_8, {
            ...
            errorMsg_8 = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%s</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%s</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(arg_13)(arg_1_8)("Should have 2 points");
        }
        else {
            errorMsg_8 = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%A</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%A</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(2)(actual_8)("Should have 2 points");
        }
    ...
    let a_42, b_42, x_40, y_40, z_30, a_44, b_44, x_41, y_41, z_31, a_46, b_46, x_42, y_42, z_32;
    ...
    if ((actual_9 === 3) ? true : !(new Function("try {return this===window;}catch(e){ return false;}"))()) {
        ...
        if (contains(valueType_9, primitiveTypes_9, {
            ...
            const arg_14 = int32ToString(3);
            const arg_1_9 = int32ToString(actual_9);
            errorMsg_9 = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%s</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%s</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(arg_14)(arg_1_9)("Should have 3 points");
        }
        else {
            errorMsg_9 = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%A</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%A</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(3)(actual_9)("Should have 3 points");
        }
    ...
    const pts_10 = [Pnt_$ctor_Z7AD9E565(0, 0, 0), Pnt_$ctor_Z7AD9E565(10, 0, 0)];
    const pl_10 = Polyline3D_$ctor_516DFD0A(pts_10);
    ...
    if ((actual_10 === 2) ? true : !(new Function("try {return this===window;}catch(e){ return false;}"))()) {
        ...
        if (contains(valueType_10, primitiveTypes_10, {
            ...
            const arg_15 = int32ToString(2);
            const arg_1_10 = int32ToString(actual_10);
            errorMsg_10 = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%s</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%s</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(arg_15)(arg_1_10)("Should have 2 points");
        }
        else {
            errorMsg_10 = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%A</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%A</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(2)(actual_10)("Should have 2 points");
        }
        throw new Exception(errorMsg_10);
    }
}), Test_testCase("Polyline3D.offset fails with less than 2 points", () => {
    const pts_11 = [Pnt_$ctor_Z7AD9E565(0, 0, 0)];
    const pl_11 = Polyline3D_$ctor_516DFD0A(pts_11);
    ...
    const pts_12 = [Pnt_$ctor_Z7AD9E565(0, 0, 0), Pnt_$ctor_Z7AD9E565(10, 0, 0)];
    const pl_12 = Polyline3D_$ctor_516DFD0A(pts_12);
    ...
    const d = 1;
    const offset1 = Polyline3D_offsetWithRef_39D084EF(pl_13, d, 0, refNormal_13, false);
    const offset2 = Polyline3D_offsetWithRef_39D084EF(offset1, -d, 0, refNormal_13, false);
    ...
    if ((actual_11 === expected_11) ? true : !(new Function("try {return this===window;}catch(e){ return false;}"))()) {
        ...
        if (contains(valueType_11, primitiveTypes_11, {
            ...
            const arg_16 = int32ToString(expected_11);
            const arg_1_11 = int32ToString(actual_11);
            errorMsg_11 = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%s</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%s</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(arg_16)(arg_1_11)("same count after roundtrip");
        }
        else {
            errorMsg_11 = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%A</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%A</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(expected_11)(actual_11)("same count after roundtrip");
        }
    ...
    const d_1 = 1.5;
    const offset1_1 = Polyline3D_offsetWithRef_39D084EF(pl_14, -d_1, 0, refNormal_14, false);
    const offset2_1 = Polyline3D_offsetWithRef_39D084EF(offset1_1, d_1, 0, refNormal_14, false);
    ...
    if ((actual_12 === expected_12) ? true : !(new Function("try {return this===window;}catch(e){ return false;}"))()) {
        ...
        if (contains(valueType_12, primitiveTypes_12, {
            ...
            const arg_17 = int32ToString(expected_12);
            const arg_1_12 = int32ToString(actual_12);
            errorMsg_12 = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%s</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%s</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(arg_17)(arg_1_12)("same count after roundtrip");
        }
        else {
            errorMsg_12 = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%A</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%A</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(expected_12)(actual_12)("same count after roundtrip");
        }
    ...
    const d_2 = 1;
    const offset1_2 = Polyline3D_offsetWithRef_39D084EF(pl_15, d_2, 0, refNormal_15, false);
    const offset2_2 = Polyline3D_offsetWithRef_39D084EF(offset1_2, -d_2, 0, refNormal_15, false);
    ...
    if ((actual_13 === expected_13) ? true : !(new Function("try {return this===window;}catch(e){ return false;}"))()) {
        ...
        if (contains(valueType_13, primitiveTypes_13, {
            ...
            const arg_18 = int32ToString(expected_13);
            const arg_1_13 = int32ToString(actual_13);
            errorMsg_13 = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%s</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%s</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(arg_18)(arg_1_13)("same count after roundtrip");
        }
        else {
            errorMsg_13 = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%A</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%A</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(expected_13)(actual_13)("same count after roundtrip");
        }
    ...
    const d_3 = 0.5;
    const offset1_3 = Polyline3D_offsetWithRef_39D084EF(pl_16, d_3, 0, refNormal_16, false);
    const offset2_3 = Polyline3D_offsetWithRef_39D084EF(offset1_3, -d_3, 0, refNormal_16, false);
    ...
    if ((actual_14 === expected_14) ? true : !(new Function("try {return this===window;}catch(e){ return false;}"))()) {
        ...
        if (contains(valueType_14, primitiveTypes_14, {
            ...
            const arg_19 = int32ToString(expected_14);
            const arg_1_14 = int32ToString(actual_14);
            errorMsg_14 = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%s</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%s</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(arg_19)(arg_1_14)("same count after roundtrip (triangle)");
        }
        else {
            errorMsg_14 = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%A</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%A</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(expected_14)(actual_14)("same count after roundtrip (triangle)");
        }
    ...
    const d_4 = 2;
    const offset1_4 = Polyline3D_offsetWithRef_39D084EF(pl_17, 0, d_4, refNormal_17, false);
    const offset2_4 = Polyline3D_offsetWithRef_39D084EF(offset1_4, 0, -d_4, refNormal_17, false);
    ...
    if ((actual_15 === expected_15) ? true : !(new Function("try {return this===window;}catch(e){ return false;}"))()) {
        ...
        if (contains(valueType_15, primitiveTypes_15, {
            ...
            const arg_20 = int32ToString(expected_15);
            const arg_1_15 = int32ToString(actual_15);
            errorMsg_15 = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%s</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%s</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(arg_20)(arg_1_15)("same count after roundtrip");
        }
        else {
            errorMsg_15 = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%A</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%A</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(expected_15)(actual_15)("same count after roundtrip");
        }
    ...
    const dIn = 1;
    const dPerp = 2;
    const offset1_5 = Polyline3D_offsetWithRef_39D084EF(pl_18, dIn, dPerp, refNormal_18, false);
    const offset2_5 = Polyline3D_offsetWithRef_39D084EF(offset1_5, -dIn, -dPerp, refNormal_18, false);
    ...
    if ((actual_16 === expected_16) ? true : !(new Function("try {return this===window;}catch(e){ return false;}"))()) {
        ...
        if (contains(valueType_16, primitiveTypes_16, {
            ...
            const arg_21 = int32ToString(expected_16);
            ...
            errorMsg_16 = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%A</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%A</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(expected_16)(actual_16)("same count after combined roundtrip");
        }
    ...
    const pts_19 = Array.from(toList(delay(() => collect((i_6) => {
        ...
        return singleton(Pnt_$ctor_Z7AD9E565(r * Math.cos(angle), r * Math.sin(angle), 0));
    }, rangeDouble(0, 1, 4)))));
    ...
    const d_5 = 1;
    const offset1_6 = Polyline3D_offsetWithRef_39D084EF(pl_19, d_5, 0, refNormal_19, false);
    const offset2_6 = Polyline3D_offsetWithRef_39D084EF(offset1_6, -d_5, 0, refNormal_19, false);
    ...
    if ((actual_17 === expected_17) ? true : !(new Function("try {return this===window;}catch(e){ return false;}"))()) {
        ...
        if (contains(valueType_17, primitiveTypes_17, {
            ...
            const arg_22 = int32ToString(expected_17);
            const arg_1_17 = int32ToString(actual_17);
            errorMsg_17 = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%s</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%s</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(arg_22)(arg_1_17)("same count after roundtrip (pentagon)");
        }
        else {
            errorMsg_17 = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%A</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%A</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(expected_17)(actual_17)("same count after roundtrip (pentagon)");
        }
    ...
    const pts_20 = Array.from(toList(delay(() => collect((i_8) => {
        ...
        return singleton(Pnt_$ctor_Z7AD9E565(r_1 * Math.cos(angle_1), r_1 * Math.sin(angle_1), 0));
    }, rangeDouble(0, 1, 5)))));
    ...
    const perp_6 = 0;
    const inPlane_6 = 1.5;
    const offset1_7 = Polyline3D_offsetWithRef_39D084EF(pl_20, inPlane_6, perp_6, refNormal_20, false);
    recordTestCase("hexagon", pl_20, inPlane_6, perp_6, refNormal_20, offset1_7);
    const offset2_7 = Polyline3D_offsetWithRef_39D084EF(offset1_7, -inPlane_6, perp_6, refNormal_20, false);
    ...
    if ((actual_18 === expected_18) ? true : !(new Function("try {return this===window;}catch(e){ return false;}"))()) {
        ...
        if (contains(valueType_18, primitiveTypes_18, {
            ...
            const arg_23 = int32ToString(expected_18);
            ...
            errorMsg_18 = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%A</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%A</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(expected_18)(actual_18)("same count after roundtrip (hexagon)");
        }
    ...
    const d_6 = 1;
    const offset1_8 = Polyline3D_offsetWithRef_39D084EF(pl_21, d_6, 0, refNormal_21, false);
    const offset2_8 = Polyline3D_offsetWithRef_39D084EF(offset1_8, -d_6, 0, refNormal_21, false);
    ...
    if ((actual_19 === expected_19) ? true : !(new Function("try {return this===window;}catch(e){ return false;}"))()) {
        ...
        if (contains(valueType_19, primitiveTypes_19, {
            ...
            const arg_24 = int32ToString(expected_19);
            const arg_1_19 = int32ToString(actual_19);
            errorMsg_19 = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%s</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%s</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(arg_24)(arg_1_19)("same count after roundtrip (zigzag)");
        }
        else {
            errorMsg_19 = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%A</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%A</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(expected_19)(actual_19)("same count after roundtrip (zigzag)");
        }
    ...
    const d_7 = 1;
    const offset1_9 = Polyline3D_offsetWithRef_39D084EF(pl_22, d_7, 0, refNormal_22, false);
    const offset2_9 = Polyline3D_offsetWithRef_39D084EF(offset1_9, -d_7, 0, refNormal_22, false);
    ...
    if ((actual_20 === expected_20) ? true : !(new Function("try {return this===window;}catch(e){ return false;}"))()) {
        ...
        if (contains(valueType_20, primitiveTypes_20, {
            ...
            const arg_25 = int32ToString(expected_20);
            const arg_1_20 = int32ToString(actual_20);
            errorMsg_20 = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%s</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%s</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(arg_25)(arg_1_20)("same count after roundtrip (staircase)");
        }
        else {
            errorMsg_20 = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%A</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%A</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(expected_20)(actual_20)("same count after roundtrip (staircase)");
        }
    ...
    const d_8 = 1;
    const offset1_10 = Polyline3D_offsetWithRef_39D084EF(pl_23, d_8, 0, refNormal_23, false);
    recordTestCase("square with colinear point", pl_23, d_8, 0, refNormal_23, offset1_10);
    const offset2_10 = Polyline3D_offsetWithRef_39D084EF(offset1_10, -d_8, 0, refNormal_23, false);
    ...
    if ((actual_21 === expected_21) ? true : !(new Function("try {return this===window;}catch(e){ return false;}"))()) {
        ...
        if (contains(valueType_21, primitiveTypes_21, {
            ...
            const arg_26 = int32ToString(expected_21);
            const arg_1_21 = int32ToString(actual_21);
            errorMsg_21 = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%s</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%s</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(arg_26)(arg_1_21)("same count after roundtrip (colinear)");
        }
        else {
            errorMsg_21 = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%A</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%A</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(expected_21)(actual_21)("same count after roundtrip (colinear)");
        }
    ...
    if ((actual_22 === 5) ? true : !(new Function("try {return this===window;}catch(e){ return false;}"))()) {
        ...
        if (contains(valueType_22, primitiveTypes_22, {
            ...
            const arg_27 = int32ToString(5);
            const arg_1_22 = int32ToString(actual_22);
            errorMsg_22 = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%s</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%s</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(arg_27)(arg_1_22)("Should have 5 points");
        }
        else {
            errorMsg_22 = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%A</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%A</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(5)(actual_22)("Should have 5 points");
        }
    ...
    const perp_7 = 0;
    const inPlane_7 = 1;
    const offset1_11 = Polyline3D_offsetWithRef_39D084EF(pl_25, inPlane_7, perp_7, refNormal_25, false);
    recordTestCase("XZ plane square", pl_25, inPlane_7, perp_7, refNormal_25, offset1_11);
    const offset2_11 = Polyline3D_offsetWithRef_39D084EF(offset1_11, -inPlane_7, perp_7, refNormal_25, false);
    ...
    if ((actual_23 === expected_23) ? true : !(new Function("try {return this===window;}catch(e){ return false;}"))()) {
        ...
        if (contains(valueType_23, primitiveTypes_23, {
            ...
            errorMsg_23 = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%s</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%s</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(arg_28)(arg_1_23)("same count after roundtrip (XZ plane)");
        }
        else {
            errorMsg_23 = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%A</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%A</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(expected_23)(actual_23)("same count after roundtrip (XZ plane)");
        }
    ...
    const perp_8 = 0;
    const inPlane_8 = 1;
    const offset1_12 = Polyline3D_offsetWithRef_39D084EF(pl_26, inPlane_8, perp_8, refNormal_26, false);
    recordTestCase("YZ plane square", pl_26, inPlane_8, perp_8, refNormal_26, offset1_12);
    const offset2_12 = Polyline3D_offsetWithRef_39D084EF(offset1_12, -inPlane_8, perp_8, refNormal_26, false);
    ...
    if ((actual_24 === expected_24) ? true : !(new Function("try {return this===window;}catch(e){ return false;}"))()) {
        ...
        if (contains(valueType_24, primitiveTypes_24, {
            ...
            const arg_29 = int32ToString(expected_24);
            const arg_1_24 = int32ToString(actual_24);
            errorMsg_24 = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%s</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%s</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(arg_29)(arg_1_24)("same count after roundtrip (YZ plane)");
        }
        else {
            errorMsg_24 = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%A</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%A</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(expected_24)(actual_24)("same count after roundtrip (YZ plane)");
        }
    ...
    const perp_9 = 0;
    const inPlane_9 = 0.5;
    const offset1_13 = Polyline3D_offsetWithRef_39D084EF(pl_27, inPlane_9, perp_9, refNormal_27, false);
    recordTestCase("tilted plane triangle", pl_27, inPlane_9, perp_9, refNormal_27, offset1_13);
    const offset2_13 = Polyline3D_offsetWithRef_39D084EF(offset1_13, -inPlane_9, perp_9, refNormal_27, false);
    ...
    if ((actual_25 === expected_25) ? true : !(new Function("try {return this===window;}catch(e){ return false;}"))()) {
        ...
        if (contains(valueType_25, primitiveTypes_25, {
            ...
            const arg_30 = int32ToString(expected_25);
            const arg_1_25 = int32ToString(actual_25);
            errorMsg_25 = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%s</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%s</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(arg_30)(arg_1_25)("same count after roundtrip (tilted plane)");
        }
        else {
            errorMsg_25 = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%A</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%A</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(expected_25)(actual_25)("same count after roundtrip (tilted plane)");
        }
    ...
    const d_9 = 1;
    const result_13 = Polyline3D_offsetWithRef_39D084EF(pl_28, d_9, 0, refNormal_28, false);
    recordTestCase("3D spiral staircase", pl_28, d_9, 0, refNormal_28, result_13);
    ...
    if ((actual_26 === expected_26) ? true : !(new Function("try {return this===window;}catch(e){ return false;}"))()) {
        ...
        if (contains(valueType_26, primitiveTypes_26, {
            ...
            const arg_31 = int32ToString(expected_26);
            const arg_1_26 = int32ToString(actual_26);
            errorMsg_26 = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%s</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%s</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(arg_31)(arg_1_26)("Should have same point count");
        }
        else {
            errorMsg_26 = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%A</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%A</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(expected_26)(actual_26)("Should have same point count");
        }
        throw new Exception(errorMsg_26);
    }
    const totalDist = sum(toList(delay(() => map((i_17) => {
    ...
    Expect_isTrue(totalDist > 0.1)("Offset should produce different points");
}), Test_testCase("Polyline3D.offset closed rectangle specific values", () => {
    let a_84, b_84, x_102, y_101, z_72, a_86, b_86, x_103, y_102, z_73, a_88, b_88, x_104, y_103, z_74, a_90, b_90, x_105, y_104, z_75;
    const pts_29 = [Pnt_$ctor_Z7AD9E565(0, 0, 0), Pnt_$ctor_Z7AD9E565(20, 0, 0), Pnt_$ctor_Z7AD9E565(20, 10, 0), Pnt_$ctor_Z7AD9E565(0, 10, 0), Pnt_$ctor_Z7AD9E565(0, 0, 0)];
    const pl_29 = Polyline3D_$ctor_516DFD0A(pts_29);
    ...
    if ((actual_27 === 5) ? true : !(new Function("try {return this===window;}catch(e){ return false;}"))()) {
        ...
        if (contains(valueType_27, primitiveTypes_27, {
            ...
            const arg_32 = int32ToString(5);
            const arg_1_27 = int32ToString(actual_27);
            errorMsg_27 = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%s</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%s</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(arg_32)(arg_1_27)("Should have 5 points");
        }
        else {
            errorMsg_27 = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%A</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%A</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(5)(actual_27)("Should have 5 points");
        }
    ...
    const d_10 = 3;
    const result_15 = Polyline3D_offsetWithRef_39D084EF(pl_30, d_10, 0, refNormal_30, false);
    recordTestCase("open 3-point line distance check", pl_30, d_10, 0, refNormal_30, result_15);
    let dist0;
    ...
    Expect_floatClose(tol, dist0, d_10, `First point should be ${d_10} away, got ${dist0}`);
    Expect_floatClose(tol, dist2, d_10, `Last point should be ${d_10} away, got ${dist2}`);
}), Test_testCase("Polyline3D.offset with loop flag on open L returns closed behavior", () => {
    let a_96, b_96, x_112, y_111, z_80;
    const pts_31 = [Pnt_$ctor_Z7AD9E565(0, 0, 0), Pnt_$ctor_Z7AD9E565(10, 0, 0), Pnt_$ctor_Z7AD9E565(10, 10, 0)];
    const pl_31 = Polyline3D_$ctor_516DFD0A(pts_31);
    const refNormal_31 = UnitVec_$ctor_Z7AD9E565(0, 0, 1);
    const d_11 = 1;
    const resultLoop = Polyline3D_offsetWithRef_39D084EF(pl_31, d_11, 0, refNormal_31, true);
    recordTestCase("open L with loop=true", pl_31, d_11, 0, refNormal_31, resultLoop);
    const resultOpen = Polyline3D_offsetWithRef_39D084EF(pl_31, d_11, 0, refNormal_31, false);
    recordTestCase("open L with loop=false", pl_31, d_11, 0, refNormal_31, resultOpen);
    ...
    if ((actual_28 === 3) ? true : !(new Function("try {return this===window;}catch(e){ return false;}"))()) {
        ...
        if (contains(valueType_28, primitiveTypes_28, {
            ...
            const arg_33 = int32ToString(3);
            const arg_1_28 = int32ToString(actual_28);
            errorMsg_28 = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%s</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%s</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(arg_33)(arg_1_28)("Loop result should have 3 points");
        }
        else {
            errorMsg_28 = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%A</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%A</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(3)(actual_28)("Loop result should have 3 points");
        }
    ...
    if ((actual_29 === 3) ? true : !(new Function("try {return this===window;}catch(e){ return false;}"))()) {
        ...
        if (contains(valueType_29, primitiveTypes_29, {
            ...
            const arg_34 = int32ToString(3);
            const arg_1_29 = int32ToString(actual_29);
            errorMsg_29 = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%s</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%s</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(arg_34)(arg_1_29)("Open result should have 3 points");
        }
        else {
            errorMsg_29 = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%A</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%A</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(3)(actual_29)("Open result should have 3 points");
        }
    ...
    const d_12 = 10;
    const offset1_14 = Polyline3D_offsetWithRef_39D084EF(pl_32, d_12, 0, refNormal_32, false);
    const offset2_14 = Polyline3D_offsetWithRef_39D084EF(offset1_14, -d_12, 0, refNormal_32, false);
    ...
    if ((actual_30 === expected_30) ? true : !(new Function("try {return this===window;}catch(e){ return false;}"))()) {
        ...
        if (contains(valueType_30, primitiveTypes_30, {
            ...
            const arg_35 = int32ToString(expected_30);
            const arg_1_30 = int32ToString(actual_30);
            errorMsg_30 = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%s</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%s</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(arg_35)(arg_1_30)("same count after roundtrip (large offset)");
        }
        else {
            errorMsg_30 = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%A</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%A</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(expected_30)(actual_30)("same count after roundtrip (large offset)");
        }
    ...
    const d_13 = 0.001;
    const offset1_15 = Polyline3D_offsetWithRef_39D084EF(pl_33, d_13, 0, refNormal_33, false);
    const offset2_15 = Polyline3D_offsetWithRef_39D084EF(offset1_15, -d_13, 0, refNormal_33, false);
    ...
    if ((actual_31 === expected_31) ? true : !(new Function("try {return this===window;}catch(e){ return false;}"))()) {
        ...
        let valueType_31;
        let copyOfStruct_32 = actual_31;
        valueType_31 = int32_type;
        ...
        if (contains(valueType_31, primitiveTypes_31, {
            ...
            const arg_36 = int32ToString(expected_31);
            const arg_1_31 = int32ToString(actual_31);
            ...
            errorMsg_31 = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%A</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%A</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(expected_31)(actual_31)("same count after roundtrip (small offset)");
        }
    ...
    const pts_34 = [Pnt_$ctor_Z7AD9E565(0, 0, 0), Pnt_$ctor_Z7AD9E565(10, 0, 0), Pnt_$ctor_Z7AD9E565(10, 10, 0), Pnt_$ctor_Z7AD9E565(0, 10, 0), Pnt_$ctor_Z7AD9E565(0, 0, 0)];
    const pl_34 = Polyline3D_$ctor_516DFD0A(pts_34);
    const result_16 = Polyline3D_offset_1FF60F20(pl_34, 1, 0, false);
    ...
    const pts_35 = [Pnt_$ctor_Z7AD9E565(0, 0, 0), Pnt_$ctor_Z7AD9E565(0, 10, 0), Pnt_$ctor_Z7AD9E565(10, 10, 0), Pnt_$ctor_Z7AD9E565(10, 0, 0), Pnt_$ctor_Z7AD9E565(0, 0, 0)];
    const pl_35 = Polyline3D_$ctor_516DFD0A(pts_35);
    const result_17 = Polyline3D_offset_1FF60F20(pl_35, 1, 0, false);
    ...
    const pts_36 = [Pnt_$ctor_Z7AD9E565(0, 0, 0), Pnt_$ctor_Z7AD9E565(10, 0, 0), Pnt_$ctor_Z7AD9E565(10, 10, 0), Pnt_$ctor_Z7AD9E565(0, 10, 0), Pnt_$ctor_Z7AD9E565(0, 0, 0)];
    const pl_36 = Polyline3D_$ctor_516DFD0A(pts_36);
    const result_18 = Polyline3D_offset_1FF60F20(pl_36, -1, 0, false);
    ...
    const pts_37 = [Pnt_$ctor_Z7AD9E565(0, 0, 0), Pnt_$ctor_Z7AD9E565(0, 10, 0), Pnt_$ctor_Z7AD9E565(10, 10, 0), Pnt_$ctor_Z7AD9E565(10, 0, 0), Pnt_$ctor_Z7AD9E565(0, 0, 0)];
    const pl_37 = Polyline3D_$ctor_516DFD0A(pts_37);
    const result_19 = Polyline3D_offset_1FF60F20(pl_37, -1, 0, false);
    ...
    const pts_38 = [Pnt_$ctor_Z7AD9E565(0, 0, 0), Pnt_$ctor_Z7AD9E565(10, 0, 0), Pnt_$ctor_Z7AD9E565(10, 10, 0), Pnt_$ctor_Z7AD9E565(0, 10, 0), Pnt_$ctor_Z7AD9E565(0, 0, 0)];
    const pl_38 = Polyline3D_$ctor_516DFD0A(pts_38);
    const result_20 = Polyline3D_offset_1FF60F20(pl_38, 0, 2, false);
    ...
    const pts_39 = [Pnt_$ctor_Z7AD9E565(0, 0, 0), Pnt_$ctor_Z7AD9E565(0, 10, 0), Pnt_$ctor_Z7AD9E565(10, 10, 0), Pnt_$ctor_Z7AD9E565(10, 0, 0), Pnt_$ctor_Z7AD9E565(0, 0, 0)];
    const pl_39 = Polyline3D_$ctor_516DFD0A(pts_39);
    const result_21 = Polyline3D_offset_1FF60F20(pl_39, 0, 2, false);
    ...
    const pts_40 = [Pnt_$ctor_Z7AD9E565(0, 0, 0), Pnt_$ctor_Z7AD9E565(10, 0, 0), Pnt_$ctor_Z7AD9E565(10, 10, 0), Pnt_$ctor_Z7AD9E565(0, 10, 0), Pnt_$ctor_Z7AD9E565(0, 0, 0)];
    const pl_40 = Polyline3D_$ctor_516DFD0A(pts_40);
    const result_22 = Polyline3D_offset_1FF60F20(pl_40, 0, -2, false);
    ...
    const pts_41 = [Pnt_$ctor_Z7AD9E565(0, 0, 0), Pnt_$ctor_Z7AD9E565(0, 10, 0), Pnt_$ctor_Z7AD9E565(10, 10, 0), Pnt_$ctor_Z7AD9E565(10, 0, 0), Pnt_$ctor_Z7AD9E565(0, 0, 0)];
    const pl_41 = Polyline3D_$ctor_516DFD0A(pts_41);
    const result_23 = Polyline3D_offset_1FF60F20(pl_41, 0, -2, false);
