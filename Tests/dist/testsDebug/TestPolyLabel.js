...
export const tests = Test_testList("PolyLabel", ofArray([(() => {
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040, Test_TestCaseBuilder__Delay_1505(builder$0040, () => {
        ...
        const pl = Polyline2D_$ctor_Z5FD8CF3C(Array.from(pts));
        const patternInput = Polyline2D__FindLablePoint_5E38073B(pl, 1E-06);
        const p = patternInput[0];
        const d = patternInput[1];
        ...
        Expect_floatClose(AccuracyModule_low, d, 0.5, "distance = 0.5");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_1, Test_TestCaseBuilder__Delay_1505(builder$0040_1, () => {
        ...
        const pl_1 = Polyline2D_$ctor_Z5FD8CF3C(Array.from(pts_1));
        const patternInput_1 = Polyline2D__FindLablePoint_5E38073B(pl_1, 0.001);
        const p_1 = patternInput_1[0];
        const d_1 = patternInput_1[1];
        ...
        Expect_floatClose(AccuracyModule_low, d_1, 1, "distance = min half-side");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_2, Test_TestCaseBuilder__Delay_1505(builder$0040_2, () => {
        ...
        const pl_2 = Polyline2D_$ctor_Z5FD8CF3C(Array.from(pts_2));
        const patternInput_2 = Polyline2D__FindLablePoint_5E38073B(pl_2, 0.0001);
        const p_2 = patternInput_2[0];
        const d_2 = patternInput_2[1];
        const per = (5 + 3) + 4;
        ...
        Expect_floatClose(AccuracyModule_low, d_2, 1, "inradius for 3-4-5 triangle is 1");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_3, Test_TestCaseBuilder__Delay_1505(builder$0040_3, () => {
        ...
        const p1 = patternInput_3[0];
        const d1 = patternInput_3[1];
        const patternInput_4 = Polyline2D__FindLablePoint_5E38073B(pl_3, 0.0001);
        const p2 = patternInput_4[0];
        const d2 = patternInput_4[1];
        Expect_isTrue(d2 >= (d1 - 1E-06))("distance monotonic");
        Expect_isTrue(((a_8 = p2, (b_8 = Pt_$ctor_7B00E9A0(1, 1), (vx_3 = (a_8.X - b_8.X), (vy_3 = (a_8.Y - b_8.Y), Math.sqrt((vx_3 * vx_3) + (vy_3 * vy_3))))))) < (((a_10 = p1, (b_10 = Pt_$ctor_7B00E9A0(1, 1), (vx_4 = (a_10.X - b_10.X), (vy_4 = (a_10.Y - b_10.Y), Math.sqrt((vx_4 * vx_4) + (vy_4 * vy_4))))))) + 0.01))("higher precision closer to center or similar");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_4, Test_TestCaseBuilder__Delay_1505(builder$0040_4, () => {
        ...
        const pl_4 = Polyline2D_$ctor_Z5FD8CF3C(Array.from(pts_4));
        const patternInput_5 = Polyline2D__FindLablePoint_5E38073B(pl_4, 0.0001);
        const p_3 = patternInput_5[0];
        const d_3 = patternInput_5[1];
        ...
        Expect_floatClose(AccuracyModule_low, d_3, h / 3, "inradius eq tri");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_5, Test_TestCaseBuilder__Delay_1505(builder$0040_5, () => {
        ...
        const pl_5 = Polyline2D_$ctor_Z5FD8CF3C(Array.from(pts_5));
        const patternInput_6 = Polyline2D__FindLablePoint_5E38073B(pl_5, 0.001);
        const p_4 = patternInput_6[0];
        const d_4 = patternInput_6[1];
        ...
        Expect_floatClose(AccuracyModule_low, d_4, 0.1, "half of minor side");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_6, Test_TestCaseBuilder__Delay_1505(builder$0040_6, () => {
        ...
        const pl_6 = Polyline2D_$ctor_Z5FD8CF3C(Array.from(pts_6));
        const patternInput_7 = Polyline2D__FindLablePoint_5E38073B(pl_6, 0.0001);
        const p_5 = patternInput_7[0];
        const d_5 = patternInput_7[1];
        ...
        Expect_floatClose(AccuracyModule_medium, d_5, 1 / Math.sqrt(2), "diamond inradius");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_7, Test_TestCaseBuilder__Delay_1505(builder$0040_7, () => {
        ...
        const pl_7 = Polyline2D_$ctor_Z5FD8CF3C(Array.from(pts_7));
        const patternInput_8 = Polyline2D__FindLablePoint_5E38073B(pl_7, 0.001);
