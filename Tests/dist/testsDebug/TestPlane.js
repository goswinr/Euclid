...
export const tests = Test_testList("Planes", ofArray([Test_testList("NPlane - Construction", ofArray([(() => {
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040, Test_TestCaseBuilder__Delay_1505(builder$0040, () => {
        ...
        const normal = Vec_$ctor_Z7AD9E565(0, 0, 1);
        const plane = NPlane_create_5A66521A(origin, normal);
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_1, Test_TestCaseBuilder__Delay_1505(builder$0040_1, () => {
        let a_5, v_5, v_3;
        const origin_1 = Pnt_$ctor_Z7AD9E565(0, 0, 0);
        const normal_1 = Vec_$ctor_Z7AD9E565(0, 0, 10);
        const plane_1 = NPlane_create_5A66521A(origin_1, normal_1);
        Expect_isTrue((a_5 = ((v_5 = ((v_3 = plane_1.Normal, Vec_$ctor_Z7AD9E565_1(v_3.X, v_3.Y, v_3.Z))), Math.sqrt(((v_5.X * v_5.X) + (v_5.Y * v_5.Y)) + (v_5.Z * v_5.Z)))), Math.abs(a_5 - 1) < 1E-09))("Normal should be unit length");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_3, Test_TestCaseBuilder__Delay_1505(builder$0040_3, () => {
        ...
        const normal_3 = UnitVec_$ctor_Z7AD9E565(0, 0, 1);
        const plane_2 = NPlane_$ctor_Z2DDF2344(origin_3, normal_3);
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_7, Test_TestCaseBuilder__Delay_1505(builder$0040_7, () => {
        const plane_5 = NPlane_create_5A66521A(Pnt_$ctor_Z7AD9E565(0, 0, 0), Vec_$ctor_Z7AD9E565(0, 0, 1));
        const pt_1 = Pnt_$ctor_Z7AD9E565(5, 5, 10);
        let dist;
        const pl = plane_5;
        ...
        dist = (((a_35.X * b_35.X) + (a_35.Y * b_35.Y)) + (a_35.Z * b_35.Z));
        const actual = dist;
        if ((actual === 10) ? true : !(new Function("try {return this===window;}catch(e){ return false;}"))()) {
            ...
            if (contains(valueType, primitiveTypes, {
                ...
                const arg_5 = (10).toString();
                const arg_1_2 = actual.toString();
                errorMsg = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%s</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%s</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(arg_5)(arg_1_2)("Distance should be 10");
            }
            else {
                errorMsg = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%A</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%A</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(10)(actual)("Distance should be 10");
            }
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_8, Test_TestCaseBuilder__Delay_1505(builder$0040_8, () => {
        const plane_6 = NPlane_create_5A66521A(Pnt_$ctor_Z7AD9E565(0, 0, 0), Vec_$ctor_Z7AD9E565(0, 0, 1));
        const pt_3 = Pnt_$ctor_Z7AD9E565(5, 5, -10);
        let dist_1;
        const pl_1 = plane_6;
        ...
        dist_1 = (((a_37.X * b_37.X) + (a_37.Y * b_37.Y)) + (a_37.Z * b_37.Z));
        const actual_1 = dist_1;
        if ((actual_1 === -10) ? true : !(new Function("try {return this===window;}catch(e){ return false;}"))()) {
            ...
            if (contains(valueType_1, primitiveTypes_1, {
                ...
                const arg_1_4 = actual_1.toString();
                errorMsg_1 = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%s</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%s</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(arg_7)(arg_1_4)("Distance should be -10 (signed)");
            }
            else {
                errorMsg_1 = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%A</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%A</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(-10)(actual_1)("Distance should be -10 (signed)");
            }
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_9, Test_TestCaseBuilder__Delay_1505(builder$0040_9, () => {
        const plane_7 = NPlane_create_5A66521A(Pnt_$ctor_Z7AD9E565(0, 0, 5), Vec_$ctor_Z7AD9E565(0, 0, 1));
        const pt_5 = Pnt_$ctor_Z7AD9E565(10, 10, 5);
        let dist_2;
        const pl_2 = plane_7;
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_10, Test_TestCaseBuilder__Delay_1505(builder$0040_10, () => {
        let a_45, b_44, x_17, y_13, z_11;
        const plane_8 = NPlane_create_5A66521A(Pnt_$ctor_Z7AD9E565(0, 0, 0), Vec_$ctor_Z7AD9E565(0, 0, 1));
        const pt_7 = Pnt_$ctor_Z7AD9E565(5, 5, 10);
        let closest;
        const pl_3 = plane_8;
        const pt_8 = pt_7;
        const p = pt_8;
        let v_17;
        const a_43 = pl_3.Normal;
        let f_2;
        const pl_4 = pl_3;
        const a_42 = pl_4.Normal;
        let b_42;
        const a_41 = pt_8;
        const b_41 = pl_4.Origin;
        b_42 = Vec_$ctor_Z7AD9E565_2(a_41.X - b_41.X, a_41.Y - b_41.Y, a_41.Z - b_41.Z);
        f_2 = (((a_42.X * b_42.X) + (a_42.Y * b_42.Y)) + (a_42.Z * b_42.Z));
        v_17 = Vec_$ctor_Z7AD9E565_2(a_43.X * f_2, a_43.Y * f_2, a_43.Z * f_2);
        closest = Pnt_$ctor_Z7AD9E565_1(p.X - v_17.X, p.Y - v_17.Y, p.Z - v_17.Z);
        Expect_isTrue(((a_45 = closest, (b_44 = Pnt_$ctor_Z7AD9E565(5, 5, 0), (x_17 = (a_45.X - b_44.X), (y_13 = (a_45.Y - b_44.Y), (z_11 = (a_45.Z - b_44.Z), Math.sqrt(((x_17 * x_17) + (y_13 * y_13)) + (z_11 * z_11)))))))) < 1E-09)("Closest point should be (5, 5, 0)");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_11, Test_TestCaseBuilder__Delay_1505(builder$0040_11, () => {
        ...
        const p_1 = pt_11;
        let v_18;
        const a_48 = pl_5.Normal;
        let f_3;
        const pl_6 = pl_5;
        const a_47 = pl_6.Normal;
        let b_46;
        const a_46 = pt_11;
        const b_45 = pl_6.Origin;
        b_46 = Vec_$ctor_Z7AD9E565_2(a_46.X - b_45.X, a_46.Y - b_45.Y, a_46.Z - b_45.Z);
        f_3 = (((a_47.X * b_46.X) + (a_47.Y * b_46.Y)) + (a_47.Z * b_46.Z));
        v_18 = Vec_$ctor_Z7AD9E565_2(a_48.X * f_3, a_48.Y * f_3, a_48.Z * f_3);
        closest_1 = Pnt_$ctor_Z7AD9E565_1(p_1.X - v_18.X, p_1.Y - v_18.Y, p_1.Z - v_18.Z);
        Expect_isTrue(((a_50 = closest_1, (b_48 = pt_10, (x_18 = (a_50.X - b_48.X), (y_14 = (a_50.Y - b_48.Y), (z_12 = (a_50.Z - b_48.Z), Math.sqrt(((x_18 * x_18) + (y_14 * y_14)) + (z_12 * z_12)))))))) < 1E-09)("Closest point should be same as input");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_12, Test_TestCaseBuilder__Delay_1505(builder$0040_12, () => {
        ...
        const pt_13 = Pnt_$ctor_Z7AD9E565(5, 5, 10);
        let newPlane;
        const pl_7 = plane_10;
        const pt_14 = pt_13;
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_13, Test_TestCaseBuilder__Delay_1505(builder$0040_13, () => {
        ...
        const a_58 = NPlane_create_5A66521A(Pnt_$ctor_Z7AD9E565(0, 0, 0), Vec_$ctor_Z7AD9E565(0, 0, 1));
        const b_55 = NPlane_create_5A66521A(Pnt_$ctor_Z7AD9E565(0, 0, 10), Vec_$ctor_Z7AD9E565(0, 0, 1));
        const angle = 57.29577951308232 * ((a_61 = a_58.Normal, (b_58 = b_55.Normal, (dot = ((a_62 = a_61, (b_59 = b_58, ((a_62.X * b_59.X) + (a_62.Y * b_59.Y)) + (a_62.Z * b_59.Z)))), (dotAbs = Math.abs(dot), (dotAbs < 0.98) ? Math.acos(dotAbs) : ((dot < 0) ? (2 * Math.asin(((x_20 = (b_58.X - -a_61.X), (y_16 = (b_58.Y - -a_61.Y), (z_14 = (b_58.Z - -a_61.Z), Math.sqrt(((x_20 * x_20) + (y_16 * y_16)) + (z_14 * z_14)))))) * 0.5)) : (2 * Math.asin(((x_21 = (b_58.X - a_61.X), (y_17 = (b_58.Y - a_61.Y), (z_15 = (b_58.Z - a_61.Z), Math.sqrt(((x_21 * x_21) + (y_17 * y_17)) + (z_15 * z_15)))))) * 0.5))))))));
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_14, Test_TestCaseBuilder__Delay_1505(builder$0040_14, () => {
        ...
        const a_64 = NPlane_create_5A66521A(Pnt_$ctor_Z7AD9E565(0, 0, 0), Vec_$ctor_Z7AD9E565(0, 0, 1));
        const b_61 = NPlane_create_5A66521A(Pnt_$ctor_Z7AD9E565(0, 0, 0), Vec_$ctor_Z7AD9E565(1, 0, 0));
        const angle_1 = 57.29577951308232 * ((a_67 = a_64.Normal, (b_64 = b_61.Normal, (dot_1 = ((a_68 = a_67, (b_65 = b_64, ((a_68.X * b_65.X) + (a_68.Y * b_65.Y)) + (a_68.Z * b_65.Z)))), (dotAbs_1 = Math.abs(dot_1), (dotAbs_1 < 0.98) ? Math.acos(dotAbs_1) : ((dot_1 < 0) ? (2 * Math.asin(((x_22 = (b_64.X - -a_67.X), (y_18 = (b_64.Y - -a_67.Y), (z_16 = (b_64.Z - -a_67.Z), Math.sqrt(((x_22 * x_22) + (y_18 * y_18)) + (z_16 * z_16)))))) * 0.5)) : (2 * Math.asin(((x_23 = (b_64.X - a_67.X), (y_19 = (b_64.Y - a_67.Y), (z_17 = (b_64.Z - a_67.Z), Math.sqrt(((x_23 * x_23) + (y_19 * y_19)) + (z_17 * z_17)))))) * 0.5))))))));
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_15, Test_TestCaseBuilder__Delay_1505(builder$0040_15, () => {
        ...
        const vec = Vec_$ctor_Z7AD9E565(1, 0, 0);
        const angle_2 = 90 - (57.29577951308232 * ((a_72 = ((v_25 = vec, (x_24 = v_25.X, (y_20 = v_25.Y, (z_18 = v_25.Z, (l_2 = Math.sqrt(((x_24 * x_24) + (y_20 * y_20)) + (z_18 * z_18)), (!(l_2 > 1E-12) ? failUnit3("Vec.Unitized", x_24, y_20, z_18) : undefined, (f_5 = (1 / l_2), UnitVec_$ctor_Z7AD9E565(f_5 * x_24, f_5 * y_20, f_5 * z_18))))))))), (b_69 = plane_11.Normal, (dot_2 = ((a_73 = a_72, (b_70 = b_69, ((a_73.X * b_70.X) + (a_73.Y * b_70.Y)) + (a_73.Z * b_70.Z)))), (dotAbs_2 = Math.abs(dot_2), (dotAbs_2 < 0.98) ? Math.acos(dotAbs_2) : ((dot_2 < 0) ? (2 * Math.asin(((x_27 = (b_69.X - -a_72.X), (y_22 = (b_69.Y - -a_72.Y), (z_20 = (b_69.Z - -a_72.Z), Math.sqrt(((x_27 * x_27) + (y_22 * y_22)) + (z_20 * z_20)))))) * 0.5)) : (2 * Math.asin(((x_28 = (b_69.X - a_72.X), (y_23 = (b_69.Y - a_72.Y), (z_21 = (b_69.Z - a_72.Z), Math.sqrt(((x_28 * x_28) + (y_23 * y_23)) + (z_21 * z_21)))))) * 0.5)))))))));
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_19, Test_TestCaseBuilder__Delay_1505(builder$0040_19, () => {
        ...
        const a_90 = NPlane_create_5A66521A(Pnt_$ctor_Z7AD9E565(0, 0, 0), Vec_$ctor_Z7AD9E565(0, 0, 1));
        const b_87 = NPlane_create_5A66521A(Pnt_$ctor_Z7AD9E565(0, 0, 0), Vec_$ctor_Z7AD9E565(0, 0, 1));
        Expect_isTrue((pl_15 = a_90, (other = b_87, (Math.abs((a_91 = other.Normal, (b_88 = pl_15.Normal, ((a_91.X * b_88.X) + (a_91.Y * b_88.Y)) + (a_91.Z * b_88.Z)))) > 0.9999904807207345) && (((pl_16 = pl_15, (a_93 = pl_16.Normal, (b_90 = ((a_92 = other.Origin, (b_89 = pl_16.Origin, Vec_$ctor_Z7AD9E565_2(a_92.X - b_89.X, a_92.Y - b_89.Y, a_92.Z - b_89.Z)))), ((a_93.X * b_90.X) + (a_93.Y * b_90.Y)) + (a_93.Z * b_90.Z))))) < 1E-06))))("Same plane should be coincident");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_21, Test_TestCaseBuilder__Delay_1505(builder$0040_21, () => {
        ...
        const a_98 = NPlane_create_5A66521A(Pnt_$ctor_Z7AD9E565(0, 0, 0), Vec_$ctor_Z7AD9E565(0, 0, 1));
        const b_95 = NPlane_create_5A66521A(Pnt_$ctor_Z7AD9E565(0, 0, 10), Vec_$ctor_Z7AD9E565(0, 0, 1));
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_22, Test_TestCaseBuilder__Delay_1505(builder$0040_22, () => {
        ...
        const a_102 = NPlane_create_5A66521A(Pnt_$ctor_Z7AD9E565(0, 0, 0), Vec_$ctor_Z7AD9E565(0, 0, 1));
        const b_99 = NPlane_create_5A66521A(Pnt_$ctor_Z7AD9E565(0, 0, 0), Vec_$ctor_Z7AD9E565(1, 0, 0));
        Expect_isFalse((pl_21 = a_102, (other_6 = b_99, (Math.abs((a_103 = other_6.Normal, (b_100 = pl_21.Normal, ((a_103.X * b_100.X) + (a_103.Y * b_100.Y)) + (a_103.Z * b_100.Z)))) > 0.9999904807207345) && (((pl_22 = pl_21, (a_105 = pl_22.Normal, (b_102 = ((a_104 = other_6.Origin, (b_101 = pl_22.Origin, Vec_$ctor_Z7AD9E565_2(a_104.X - b_101.X, a_104.Y - b_101.Y, a_104.Z - b_101.Z)))), ((a_105.X * b_102.X) + (a_105.Y * b_102.Y)) + (a_105.Z * b_102.Z))))) < 1E-06))))("Non-parallel planes should not be coincident");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_24, Test_TestCaseBuilder__Delay_1505(builder$0040_24, () => {
        ...
        const a_112 = NPlane_create_5A66521A(Pnt_$ctor_Z7AD9E565(0, 0, 0), Vec_$ctor_Z7AD9E565(0, 0, 1));
        const b_109 = NPlane_create_5A66521A(Pnt_$ctor_Z7AD9E565(0, 0, 0), Vec_$ctor_Z7AD9E565(0, 1, 0));
        const matchValue = NPlane_intersect(a_112, b_109);
        if (matchValue == null) {
            ...
            Expect_isTrue(((a_115 = ((ln_10 = line_2, Pnt_$ctor_Z7AD9E565_1(ln_10.FromX, ln_10.FromY, ln_10.FromZ))), (b_112 = Pnt_$ctor_Z7AD9E565_1(0, 0, 0), (x_44 = (a_115.X - b_112.X), (y_36 = (a_115.Y - b_112.Y), (z_34 = (a_115.Z - b_112.Z), Math.sqrt(((x_44 * x_44) + (y_36 * y_36)) + (z_34 * z_34)))))))) < 1E-09)("Intersection line should pass through origin");
            Test_TestCaseBuilder__Zero(builder$0040_24);
        }
    }));
})(), (() => {
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_25, Test_TestCaseBuilder__Delay_1505(builder$0040_25, () => {
        const a_116 = NPlane_create_5A66521A(Pnt_$ctor_Z7AD9E565(0, 0, 0), Vec_$ctor_Z7AD9E565(0, 0, 1));
        const b_113 = NPlane_create_5A66521A(Pnt_$ctor_Z7AD9E565(0, 0, 10), Vec_$ctor_Z7AD9E565(0, 0, 1));
        const matchValue_1 = NPlane_intersect(a_116, b_113);
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_26, Test_TestCaseBuilder__Delay_1505(builder$0040_26, () => {
        ...
        const line_3 = Line3D_$ctor_5A6659A0(Pnt_$ctor_Z7AD9E565(0, 0, 0), Pnt_$ctor_Z7AD9E565(0, 0, 10));
        const matchValue_2 = NPlane_intersectLineParameter(line_3, plane_15);
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_27, Test_TestCaseBuilder__Delay_1505(builder$0040_27, () => {
        ...
        const line_4 = Line3D_$ctor_5A6659A0(Pnt_$ctor_Z7AD9E565(0, 0, 0), Pnt_$ctor_Z7AD9E565(10, 0, 0));
        const matchValue_3 = NPlane_intersectLineParameter(line_4, plane_16);
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_28, Test_TestCaseBuilder__Delay_1505(builder$0040_28, () => {
        ...
        const line_5 = Line3D_$ctor_5A6659A0(Pnt_$ctor_Z7AD9E565(0, 0, 0), Pnt_$ctor_Z7AD9E565(0, 0, 10));
        const matchValue_4 = NPlane_intersectRay(line_5, plane_17);
        if (matchValue_4 == null) {
            throw new Exception("Should have intersection");
            Test_TestCaseBuilder__Zero(builder$0040_28);
        }
        else {
            const pt_21 = matchValue_4;
            Expect_isTrue(((a_120 = pt_21, (b_117 = Pnt_$ctor_Z7AD9E565(0, 0, 5), (x_45 = (a_120.X - b_117.X), (y_37 = (a_120.Y - b_117.Y), (z_35 = (a_120.Z - b_117.Z), Math.sqrt(((x_45 * x_45) + (y_37 * y_37)) + (z_35 * z_35)))))))) < 1E-09)("Intersection should be at (0, 0, 5)");
            Test_TestCaseBuilder__Zero(builder$0040_28);
        }
    }));
})(), (() => {
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_29, Test_TestCaseBuilder__Delay_1505(builder$0040_29, () => {
        let ln_15, pl_29, n_2, nenner, a_121, ln_16, ln_17, ln_18, ln_19, b_118, t_1, a_123, a_122, b_119, ln_20, b_120, x_46;
        const plane_18 = NPlane_create_5A66521A(Pnt_$ctor_Z7AD9E565(0, 0, 5), Vec_$ctor_Z7AD9E565(0, 0, 1));
        const line_6 = Line3D_$ctor_5A6659A0(Pnt_$ctor_Z7AD9E565(0, 0, 0), Pnt_$ctor_Z7AD9E565(0, 0, 10));
        Expect_isTrue((ln_15 = line_6, (pl_29 = plane_18, (n_2 = pl_29.Normal, (nenner = ((a_121 = ((ln_16 = ln_15, Vec_$ctor_Z7AD9E565_2((ln_17 = ln_16, ln_17.ToX - ln_17.FromX), (ln_18 = ln_16, ln_18.ToY - ln_18.FromY), (ln_19 = ln_16, ln_19.ToZ - ln_19.FromZ)))), (b_118 = n_2, ((a_121.X * b_118.X) + (a_121.Y * b_118.Y)) + (a_121.Z * b_118.Z)))), (t_1 = (((a_123 = ((a_122 = pl_29.Origin, (b_119 = ((ln_20 = ln_15, Pnt_$ctor_Z7AD9E565_1(ln_20.FromX, ln_20.FromY, ln_20.FromZ))), Vec_$ctor_Z7AD9E565_2(a_122.X - b_119.X, a_122.Y - b_119.Y, a_122.Z - b_119.Z)))), (b_120 = n_2, ((a_123.X * b_120.X) + (a_123.Y * b_120.Y)) + (a_123.Z * b_120.Z)))) / nenner), (x_46 = t_1, (-1E-06 < x_46) && (x_46 < 1.000001))))))))("Line should intersect plane");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_30, Test_TestCaseBuilder__Delay_1505(builder$0040_30, () => {
        let ln_22, pl_31, n_3, nenner_1, a_124, ln_23, ln_24, ln_25, ln_26, b_121, t_2, a_126, a_125, b_122, ln_27, b_123, x_47;
        const plane_19 = NPlane_create_5A66521A(Pnt_$ctor_Z7AD9E565(0, 0, 5), Vec_$ctor_Z7AD9E565(0, 0, 1));
        const line_7 = Line3D_$ctor_5A6659A0(Pnt_$ctor_Z7AD9E565(0, 0, 0), Pnt_$ctor_Z7AD9E565(0, 0, 3));
        Expect_isFalse((ln_22 = line_7, (pl_31 = plane_19, (n_3 = pl_31.Normal, (nenner_1 = ((a_124 = ((ln_23 = ln_22, Vec_$ctor_Z7AD9E565_2((ln_24 = ln_23, ln_24.ToX - ln_24.FromX), (ln_25 = ln_23, ln_25.ToY - ln_25.FromY), (ln_26 = ln_23, ln_26.ToZ - ln_26.FromZ)))), (b_121 = n_3, ((a_124.X * b_121.X) + (a_124.Y * b_121.Y)) + (a_124.Z * b_121.Z)))), (t_2 = (((a_126 = ((a_125 = pl_31.Origin, (b_122 = ((ln_27 = ln_22, Pnt_$ctor_Z7AD9E565_1(ln_27.FromX, ln_27.FromY, ln_27.FromZ))), Vec_$ctor_Z7AD9E565_2(a_125.X - b_122.X, a_125.Y - b_122.Y, a_125.Z - b_122.Z)))), (b_123 = n_3, ((a_126.X * b_123.X) + (a_126.Y * b_123.Y)) + (a_126.Z * b_123.Z)))) / nenner_1), (x_47 = t_2, (-1E-06 < x_47) && (x_47 < 1.000001))))))))("Line should not intersect plane");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_33, Test_TestCaseBuilder__Delay_1505(builder$0040_33, () => {
        let a_137, b_133, a_136, b_132, p_4, v_37, a_138, f_8, p_5, v_38, a_139, f_9, a_141, b_135, x_51, y_41, z_39;
        const plane_22 = NPlane_create_5A66521A(Pnt_$ctor_Z7AD9E565(0, 0, 0), Vec_$ctor_Z7AD9E565(0, 0, 1));
        const dirPt = Pnt_$ctor_Z7AD9E565(0, 0, 10);
        let offset_1;
        const pl_36 = plane_22;
        offset_1 = ((((a_137 = pl_36.Normal, (b_133 = ((a_136 = dirPt, (b_132 = pl_36.Origin, Vec_$ctor_Z7AD9E565_2(a_136.X - b_132.X, a_136.Y - b_132.Y, a_136.Z - b_132.Z)))), ((a_137.X * b_133.X) + (a_137.Y * b_133.Y)) + (a_137.Z * b_133.Z)))) >= 0) ? NPlane_$ctor_Z2DDF2344((p_4 = pl_36.Origin, (v_37 = ((a_138 = pl_36.Normal, (f_8 = 5, Vec_$ctor_Z7AD9E565_2(a_138.X * f_8, a_138.Y * f_8, a_138.Z * f_8)))), Pnt_$ctor_Z7AD9E565_1(p_4.X + v_37.X, p_4.Y + v_37.Y, p_4.Z + v_37.Z))), pl_36.Normal) : NPlane_$ctor_Z2DDF2344((p_5 = pl_36.Origin, (v_38 = ((a_139 = pl_36.Normal, (f_9 = 5, Vec_$ctor_Z7AD9E565_2(a_139.X * f_9, a_139.Y * f_9, a_139.Z * f_9)))), Pnt_$ctor_Z7AD9E565_1(p_5.X - v_38.X, p_5.Y - v_38.Y, p_5.Z - v_38.Z))), pl_36.Normal));
        Expect_isTrue(((a_141 = offset_1.Origin, (b_135 = Pnt_$ctor_Z7AD9E565(0, 0, 5), (x_51 = (a_141.X - b_135.X), (y_41 = (a_141.Y - b_135.Y), (z_39 = (a_141.Z - b_135.Z), Math.sqrt(((x_51 * x_51) + (y_41 * y_41)) + (z_39 * z_39)))))))) < 1E-09)("Should offset towards dirPt");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_34, Test_TestCaseBuilder__Delay_1505(builder$0040_34, () => {
        let a_143, b_137, a_142, b_136, p_6, v_39, a_144, f_10, p_7, v_40, a_145, f_11, a_147, b_139, x_52, y_42, z_40;
        const plane_23 = NPlane_create_5A66521A(Pnt_$ctor_Z7AD9E565(0, 0, 0), Vec_$ctor_Z7AD9E565(0, 0, 1));
        const dirPt_3 = Pnt_$ctor_Z7AD9E565(0, 0, -10);
        let offset_2;
        const pl_38 = plane_23;
        offset_2 = ((((a_143 = pl_38.Normal, (b_137 = ((a_142 = dirPt_3, (b_136 = pl_38.Origin, Vec_$ctor_Z7AD9E565_2(a_142.X - b_136.X, a_142.Y - b_136.Y, a_142.Z - b_136.Z)))), ((a_143.X * b_137.X) + (a_143.Y * b_137.Y)) + (a_143.Z * b_137.Z)))) >= 0) ? NPlane_$ctor_Z2DDF2344((p_6 = pl_38.Origin, (v_39 = ((a_144 = pl_38.Normal, (f_10 = 5, Vec_$ctor_Z7AD9E565_2(a_144.X * f_10, a_144.Y * f_10, a_144.Z * f_10)))), Pnt_$ctor_Z7AD9E565_1(p_6.X + v_39.X, p_6.Y + v_39.Y, p_6.Z + v_39.Z))), pl_38.Normal) : NPlane_$ctor_Z2DDF2344((p_7 = pl_38.Origin, (v_40 = ((a_145 = pl_38.Normal, (f_11 = 5, Vec_$ctor_Z7AD9E565_2(a_145.X * f_11, a_145.Y * f_11, a_145.Z * f_11)))), Pnt_$ctor_Z7AD9E565_1(p_7.X - v_40.X, p_7.Y - v_40.Y, p_7.Z - v_40.Z))), pl_38.Normal));
        Expect_isTrue(((a_147 = offset_2.Origin, (b_139 = Pnt_$ctor_Z7AD9E565(0, 0, -5), (x_52 = (a_147.X - b_139.X), (y_42 = (a_147.Y - b_139.Y), (z_40 = (a_147.Z - b_139.Z), Math.sqrt(((x_52 * x_52) + (y_42 * y_42)) + (z_40 * z_40)))))))) < 1E-09)("Should offset away from dirPt");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_37, Test_TestCaseBuilder__Delay_1505(builder$0040_37, () => {
        let p_9, v_50, a_158, b_149, x_55, y_45, z_43;
        const plane_26 = NPlane_create_5A66521A(Pnt_$ctor_Z7AD9E565(0, 0, 0), Vec_$ctor_Z7AD9E565(0, 0, 1));
        let moved_1;
        const pl_44 = plane_26;
        moved_1 = NPlane_$ctor_Z2DDF2344((p_9 = pl_44.Origin, (v_50 = Vec_$ctor_Z7AD9E565(5, 5, 5), Pnt_$ctor_Z7AD9E565_1(p_9.X + v_50.X, p_9.Y + v_50.Y, p_9.Z + v_50.Z))), pl_44.Normal);
        Expect_isTrue(((a_158 = moved_1.Origin, (b_149 = Pnt_$ctor_Z7AD9E565(5, 5, 5), (x_55 = (a_158.X - b_149.X), (y_45 = (a_158.Y - b_149.Y), (z_43 = (a_158.Z - b_149.Z), Math.sqrt(((x_55 * x_55) + (y_45 * y_45)) + (z_43 * z_43)))))))) < 1E-09)("Origin should be moved");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_38, Test_TestCaseBuilder__Delay_1505(builder$0040_38, () => {
        const a_159 = NPlane_create_5A66521A(Pnt_$ctor_Z7AD9E565(0, 0, 0), Vec_$ctor_Z7AD9E565(0, 0, 1));
        const b_150 = NPlane_create_5A66521A(Pnt_$ctor_Z7AD9E565(0, 0, 0), Vec_$ctor_Z7AD9E565(0, 0, 1));
        Expect_isTrue(NPlane_equals(0, a_159, b_150))("Exact planes should be equal");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_40, Test_TestCaseBuilder__Delay_1505(builder$0040_40, () => {
        ...
        const xAxis = Vec_$ctor_Z7AD9E565(1, 0, 0);
        const yAxis = Vec_$ctor_Z7AD9E565(0, 1, 0);
        const plane_27 = Euclid_PPlane__PPlane_createOriginXaxisYaxis_Static_6181AF53(origin_4, xAxis, yAxis);
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_45, Test_TestCaseBuilder__Delay_1505(builder$0040_45, () => {
        let a_179, b_170;
        const xy = PPlane_$ctor_3CB4665C(Pnt_$ctor_Z7AD9E565_1(0, 0, 0), UnitVec_$ctor_Z7AD9E565(1, 0, 0), UnitVec_$ctor_Z7AD9E565(0, 1, 0), UnitVec_$ctor_Z7AD9E565(0, 0, 1));
        const top = PPlane_$ctor_3CB4665C(Pnt_$ctor_Z7AD9E565_1(0, 0, 0), UnitVec_$ctor_Z7AD9E565(1, 0, 0), UnitVec_$ctor_Z7AD9E565(0, 1, 0), UnitVec_$ctor_Z7AD9E565(0, 0, 1));
        Expect_isTrue((a_179 = xy, (b_170 = top, ((((((((Math.abs(a_179.Origin.X - b_170.Origin.X) <= 0) && (Math.abs(a_179.Origin.Y - b_170.Origin.Y) <= 0)) && (Math.abs(a_179.Origin.Z - b_170.Origin.Z) <= 0)) && (Math.abs(a_179.Xaxis.X - b_170.Xaxis.X) <= 0)) && (Math.abs(a_179.Xaxis.Y - b_170.Xaxis.Y) <= 0)) && (Math.abs(a_179.Xaxis.Z - b_170.Xaxis.Z) <= 0)) && (Math.abs(a_179.Yaxis.X - b_170.Yaxis.X) <= 0)) && (Math.abs(a_179.Yaxis.Y - b_170.Yaxis.Y) <= 0)) && (Math.abs(a_179.Yaxis.Z - b_170.Yaxis.Z) <= 0))))("WorldTop should equal WorldXY");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_46, Test_TestCaseBuilder__Delay_1505(builder$0040_46, () => {
        const plane_29 = PPlane_$ctor_3CB4665C(Pnt_$ctor_Z7AD9E565_1(0, 0, 0), UnitVec_$ctor_Z7AD9E565(1, 0, 0), UnitVec_$ctor_Z7AD9E565(0, 1, 0), UnitVec_$ctor_Z7AD9E565(0, 0, 1));
        const pt_22 = Pnt_$ctor_Z7AD9E565(5, 5, 10);
        let dist_9;
        const pl_45 = plane_29;
        ...
        dist_9 = (((a_181.X * b_172.X) + (a_181.Y * b_172.Y)) + (a_181.Z * b_172.Z));
        const actual_2 = dist_9;
        if ((actual_2 === 10) ? true : !(new Function("try {return this===window;}catch(e){ return false;}"))()) {
            ...
            if (contains(valueType_2, primitiveTypes_2, {
                ...
                const arg_33 = (10).toString();
                const arg_1_30 = actual_2.toString();
                errorMsg_2 = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%s</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%s</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(arg_33)(arg_1_30)("Distance should be 10");
            }
            else {
                errorMsg_2 = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%A</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%A</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(10)(actual_2)("Distance should be 10");
            }
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_47, Test_TestCaseBuilder__Delay_1505(builder$0040_47, () => {
        let a_186, b_174, x_71, y_61, z_58;
        ...
        let p_13;
        let p_12;
        const p_11 = p_10.Origin;
        let v_66;
        const a_182 = p_10.Xaxis;
        v_66 = Vec_$ctor_Z7AD9E565_2(a_182.X * 0, a_182.Y * 0, a_182.Z * 0);
        p_12 = Pnt_$ctor_Z7AD9E565_1(p_11.X + v_66.X, p_11.Y + v_66.Y, p_11.Z + v_66.Z);
        let v_67;
        const a_183 = p_10.Yaxis;
        v_67 = Vec_$ctor_Z7AD9E565_2(a_183.X * 0, a_183.Y * 0, a_183.Z * 0);
        p_13 = Pnt_$ctor_Z7AD9E565_1(p_12.X + v_67.X, p_12.Y + v_67.Y, p_12.Z + v_67.Z);
        let v_68;
        const a_184 = p_10.Zaxis;
        v_68 = Vec_$ctor_Z7AD9E565_2(a_184.X * 0, a_184.Y * 0, a_184.Z * 0);
        pt_24 = Pnt_$ctor_Z7AD9E565_1(p_13.X + v_68.X, p_13.Y + v_68.Y, p_13.Z + v_68.Z);
        Expect_isTrue(((a_186 = pt_24, (b_174 = plane_30.Origin, (x_71 = (a_186.X - b_174.X), (y_61 = (a_186.Y - b_174.Y), (z_58 = (a_186.Z - b_174.Z), Math.sqrt(((x_71 * x_71) + (y_61 * y_61)) + (z_58 * z_58)))))))) < 1E-09)("Should return Origin at (0, 0, 0)");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_48, Test_TestCaseBuilder__Delay_1505(builder$0040_48, () => {
        let a_191, b_176, x_75, y_65, z_62;
        const plane_31 = PPlane_$ctor_3CB4665C(Pnt_$ctor_Z7AD9E565_1(0, 0, 0), UnitVec_$ctor_Z7AD9E565(1, 0, 0), UnitVec_$ctor_Z7AD9E565(0, 1, 0), UnitVec_$ctor_Z7AD9E565(0, 0, 1));
        let pt_25;
        const p_14 = plane_31;
        let p_17;
        let p_16;
        const p_15 = p_14.Origin;
        let v_69;
        const a_187 = p_14.Xaxis;
        v_69 = Vec_$ctor_Z7AD9E565_2(a_187.X * 5, a_187.Y * 5, a_187.Z * 5);
        p_16 = Pnt_$ctor_Z7AD9E565_1(p_15.X + v_69.X, p_15.Y + v_69.Y, p_15.Z + v_69.Z);
        let v_70;
        const a_188 = p_14.Yaxis;
        v_70 = Vec_$ctor_Z7AD9E565_2(a_188.X * 3, a_188.Y * 3, a_188.Z * 3);
        p_17 = Pnt_$ctor_Z7AD9E565_1(p_16.X + v_70.X, p_16.Y + v_70.Y, p_16.Z + v_70.Z);
        let v_71;
        const a_189 = p_14.Zaxis;
        v_71 = Vec_$ctor_Z7AD9E565_2(a_189.X * 2, a_189.Y * 2, a_189.Z * 2);
        pt_25 = Pnt_$ctor_Z7AD9E565_1(p_17.X + v_71.X, p_17.Y + v_71.Y, p_17.Z + v_71.Z);
        Expect_isTrue(((a_191 = pt_25, (b_176 = Pnt_$ctor_Z7AD9E565(5, 3, 2), (x_75 = (a_191.X - b_176.X), (y_65 = (a_191.Y - b_176.Y), (z_62 = (a_191.Z - b_176.Z), Math.sqrt(((x_75 * x_75) + (y_65 * y_65)) + (z_62 * z_62)))))))) < 1E-09)("Should evaluate correctly");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_49, Test_TestCaseBuilder__Delay_1505(builder$0040_49, () => {
        let a_195, b_178, x_79, y_69, z_66;
        const plane_32 = PPlane_$ctor_3CB4665C(Pnt_$ctor_Z7AD9E565_1(0, 0, 0), UnitVec_$ctor_Z7AD9E565(1, 0, 0), UnitVec_$ctor_Z7AD9E565(0, 1, 0), UnitVec_$ctor_Z7AD9E565(0, 0, 1));
        let pt_26;
        const p_18 = plane_32;
        let p_20;
        const p_19 = p_18.Origin;
        let v_72;
        const a_192 = p_18.Xaxis;
        v_72 = Vec_$ctor_Z7AD9E565_2(a_192.X * 5, a_192.Y * 5, a_192.Z * 5);
        p_20 = Pnt_$ctor_Z7AD9E565_1(p_19.X + v_72.X, p_19.Y + v_72.Y, p_19.Z + v_72.Z);
        let v_73;
        const a_193 = p_18.Yaxis;
        v_73 = Vec_$ctor_Z7AD9E565_2(a_193.X * 3, a_193.Y * 3, a_193.Z * 3);
        pt_26 = Pnt_$ctor_Z7AD9E565_1(p_20.X + v_73.X, p_20.Y + v_73.Y, p_20.Z + v_73.Z);
        Expect_isTrue(((a_195 = pt_26, (b_178 = Pnt_$ctor_Z7AD9E565(5, 3, 0), (x_79 = (a_195.X - b_178.X), (y_69 = (a_195.Y - b_178.Y), (z_66 = (a_195.Z - b_178.Z), Math.sqrt(((x_79 * x_79) + (y_69 * y_69)) + (z_66 * z_66)))))))) < 1E-09)("Should evaluate in XY only");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_50, Test_TestCaseBuilder__Delay_1505(builder$0040_50, () => {
        let a_197, b_180, a_198, b_181, a_199, b_182;
        const plane_33 = PPlane_$ctor_3CB4665C(Pnt_$ctor_Z7AD9E565_1(0, 0, 0), UnitVec_$ctor_Z7AD9E565(1, 0, 0), UnitVec_$ctor_Z7AD9E565(0, 1, 0), UnitVec_$ctor_Z7AD9E565(0, 0, 1));
        const pt_27 = Pnt_$ctor_Z7AD9E565(5, 3, 2);
        let patternInput;
        const pl_46 = plane_33;
        let v_74;
        const a_196 = pt_27;
        ...
        const z_70 = patternInput[2];
        const y_73 = patternInput[1];
        const x_83 = patternInput[0];
        const actual_3 = x_83;
        if ((actual_3 === 5) ? true : !(new Function("try {return this===window;}catch(e){ return false;}"))()) {
            ...
            if (contains(valueType_3, primitiveTypes_3, {
                ...
                const arg_35 = (5).toString();
                const arg_1_32 = actual_3.toString();
                errorMsg_3 = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%s</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%s</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(arg_35)(arg_1_32)("X parameter should be 5");
            }
            else {
                errorMsg_3 = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%A</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%A</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(5)(actual_3)("X parameter should be 5");
            }
        ...
        if ((actual_4 === 3) ? true : !(new Function("try {return this===window;}catch(e){ return false;}"))()) {
            ...
            if (contains(valueType_4, primitiveTypes_4, {
                ...
                const arg_36 = (3).toString();
                const arg_1_33 = actual_4.toString();
                errorMsg_4 = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%s</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%s</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(arg_36)(arg_1_33)("Y parameter should be 3");
            }
            else {
                errorMsg_4 = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%A</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%A</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(3)(actual_4)("Y parameter should be 3");
            }
        ...
        if ((actual_5 === 2) ? true : !(new Function("try {return this===window;}catch(e){ return false;}"))()) {
            ...
            if (contains(valueType_5, primitiveTypes_5, {
                ...
                const arg_37 = (2).toString();
                const arg_1_34 = actual_5.toString();
                errorMsg_5 = toText(printf("<span style=\'color:black\'>Expected:</span> <br /><div style=\'margin-left:20px; color:crimson\'>%s</div><br /><span style=\'color:black\'>Actual:</span> </br ><div style=\'margin-left:20px;color:crimson\'>%s</div><br /><span style=\'color:black\'>Message:</span> </br ><div style=\'margin-left:20px; color:crimson\'>%s</div>"))(arg_37)(arg_1_34)("Z parameter should be 2");
            }
            else {
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_51, Test_TestCaseBuilder__Delay_1505(builder$0040_51, () => {
        ...
        const a_200 = PPlane_$ctor_3CB4665C(Pnt_$ctor_Z7AD9E565_1(0, 0, 0), UnitVec_$ctor_Z7AD9E565(1, 0, 0), UnitVec_$ctor_Z7AD9E565(0, 1, 0), UnitVec_$ctor_Z7AD9E565(0, 0, 1));
        const b_183 = Euclid_PPlane__PPlane_createOriginXaxisYaxis_Static_6181AF53(Pnt_$ctor_Z7AD9E565(0, 0, 10), Vec_$ctor_Z7AD9E565_1(1, 0, 0), Vec_$ctor_Z7AD9E565_1(0, 1, 0));
        const angle_6 = 57.29577951308232 * ((a_203 = a_200.Zaxis, (b_186 = b_183.Zaxis, (dot_6 = ((a_204 = a_203, (b_187 = b_186, ((a_204.X * b_187.X) + (a_204.Y * b_187.Y)) + (a_204.Z * b_187.Z)))), (dotAbs_6 = Math.abs(dot_6), (dotAbs_6 < 0.98) ? Math.acos(dotAbs_6) : ((dot_6 < 0) ? (2 * Math.asin(((x_90 = (b_186.X - -a_203.X), (y_80 = (b_186.Y - -a_203.Y), (z_74 = (b_186.Z - -a_203.Z), Math.sqrt(((x_90 * x_90) + (y_80 * y_80)) + (z_74 * z_74)))))) * 0.5)) : (2 * Math.asin(((x_91 = (b_186.X - a_203.X), (y_81 = (b_186.Y - a_203.Y), (z_75 = (b_186.Z - a_203.Z), Math.sqrt(((x_91 * x_91) + (y_81 * y_81)) + (z_75 * z_75)))))) * 0.5))))))));
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_52, Test_TestCaseBuilder__Delay_1505(builder$0040_52, () => {
        let v_75, a_209, b_192, dot_7, a_210, b_193, dotAbs_7, x_99, y_89, z_83, x_100, y_90, z_84;
        const a_206 = PPlane_$ctor_3CB4665C(Pnt_$ctor_Z7AD9E565_1(0, 0, 0), UnitVec_$ctor_Z7AD9E565(1, 0, 0), UnitVec_$ctor_Z7AD9E565(0, 1, 0), UnitVec_$ctor_Z7AD9E565(0, 0, 1));
        const b_189 = PPlane_$ctor_3CB4665C(Pnt_$ctor_Z7AD9E565_1(0, 0, 0), UnitVec_$ctor_Z7AD9E565(1, 0, 0), UnitVec_$ctor_Z7AD9E565(0, 0, 1), (v_75 = UnitVec_$ctor_Z7AD9E565(0, 1, 0), UnitVec_$ctor_Z7AD9E565(-v_75.X, -v_75.Y, -v_75.Z)));
        const angle_7 = 57.29577951308232 * ((a_209 = a_206.Zaxis, (b_192 = b_189.Zaxis, (dot_7 = ((a_210 = a_209, (b_193 = b_192, ((a_210.X * b_193.X) + (a_210.Y * b_193.Y)) + (a_210.Z * b_193.Z)))), (dotAbs_7 = Math.abs(dot_7), (dotAbs_7 < 0.98) ? Math.acos(dotAbs_7) : ((dot_7 < 0) ? (2 * Math.asin(((x_99 = (b_192.X - -a_209.X), (y_89 = (b_192.Y - -a_209.Y), (z_83 = (b_192.Z - -a_209.Z), Math.sqrt(((x_99 * x_99) + (y_89 * y_89)) + (z_83 * z_83)))))) * 0.5)) : (2 * Math.asin(((x_100 = (b_192.X - a_209.X), (y_90 = (b_192.Y - a_209.Y), (z_84 = (b_192.Z - a_209.Z), Math.sqrt(((x_100 * x_100) + (y_90 * y_90)) + (z_84 * z_84)))))) * 0.5))))))));
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_53, Test_TestCaseBuilder__Delay_1505(builder$0040_53, () => {
        ...
        const vec_2 = Vec_$ctor_Z7AD9E565(1, 0, 0);
        const angle_8 = 90 - (57.29577951308232 * ((a_214 = ((v_77 = vec_2, (x_104 = v_77.X, (y_94 = v_77.Y, (z_88 = v_77.Z, (l_6 = Math.sqrt(((x_104 * x_104) + (y_94 * y_94)) + (z_88 * z_88)), (!(l_6 > 1E-12) ? failUnit3("Vec.Unitized", x_104, y_94, z_88) : undefined, (f_21 = (1 / l_6), UnitVec_$ctor_Z7AD9E565(f_21 * x_104, f_21 * y_94, f_21 * z_88))))))))), (b_197 = plane_34.Zaxis, (dot_8 = ((a_215 = a_214, (b_198 = b_197, ((a_215.X * b_198.X) + (a_215.Y * b_198.Y)) + (a_215.Z * b_198.Z)))), (dotAbs_8 = Math.abs(dot_8), (dotAbs_8 < 0.98) ? Math.acos(dotAbs_8) : ((dot_8 < 0) ? (2 * Math.asin(((x_107 = (b_197.X - -a_214.X), (y_96 = (b_197.Y - -a_214.Y), (z_90 = (b_197.Z - -a_214.Z), Math.sqrt(((x_107 * x_107) + (y_96 * y_96)) + (z_90 * z_90)))))) * 0.5)) : (2 * Math.asin(((x_108 = (b_197.X - a_214.X), (y_97 = (b_197.Y - a_214.Y), (z_91 = (b_197.Z - a_214.Z), Math.sqrt(((x_108 * x_108) + (y_97 * y_97)) + (z_91 * z_91)))))) * 0.5)))))))));
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_54, Test_TestCaseBuilder__Delay_1505(builder$0040_54, () => {
        ...
        const line_8 = Line3D_$ctor_5A6659A0(Pnt_$ctor_Z7AD9E565_1(0, 0, 0), Pnt_$ctor_Z7AD9E565(10, 0, 0));
        let angle_9;
        const ln_28 = line_8;
        let x_112;
        const ln_29 = ln_28;
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_55, Test_TestCaseBuilder__Delay_1505(builder$0040_55, () => {
        ...
        const a_222 = PPlane_$ctor_3CB4665C(Pnt_$ctor_Z7AD9E565_1(0, 0, 0), UnitVec_$ctor_Z7AD9E565(1, 0, 0), UnitVec_$ctor_Z7AD9E565(0, 1, 0), UnitVec_$ctor_Z7AD9E565(0, 0, 1));
        const b_205 = PPlane_$ctor_3CB4665C(Pnt_$ctor_Z7AD9E565_1(0, 0, 0), UnitVec_$ctor_Z7AD9E565(1, 0, 0), UnitVec_$ctor_Z7AD9E565(0, 1, 0), UnitVec_$ctor_Z7AD9E565(0, 0, 1));
        Expect_isTrue((pl_51 = a_222, (other_10 = b_205, (Math.abs((a_223 = other_10.Zaxis, (b_206 = pl_51.Zaxis, ((a_223.X * b_206.X) + (a_223.Y * b_206.Y)) + (a_223.Z * b_206.Z)))) > 0.9999904807207345) && (((pl_52 = pl_51, (a_225 = pl_52.Zaxis, (b_208 = ((a_224 = other_10.Origin, (b_207 = pl_52.Origin, Vec_$ctor_Z7AD9E565_2(a_224.X - b_207.X, a_224.Y - b_207.Y, a_224.Z - b_207.Z)))), ((a_225.X * b_208.X) + (a_225.Y * b_208.Y)) + (a_225.Z * b_208.Z))))) < 1E-06))))("Same plane should be coincident");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_56, Test_TestCaseBuilder__Delay_1505(builder$0040_56, () => {
        ...
        const a_226 = Euclid_PPlane__PPlane_createOriginXaxisYaxis_Static_6181AF53(Pnt_$ctor_Z7AD9E565_1(0, 0, 0), Vec_$ctor_Z7AD9E565_1(1, 0, 0), Vec_$ctor_Z7AD9E565_1(0, 1, 0));
        const b_209 = Euclid_PPlane__PPlane_createOriginXaxisYaxis_Static_6181AF53(Pnt_$ctor_Z7AD9E565(10, 10, 0), Vec_$ctor_Z7AD9E565_1(1, 0, 0), Vec_$ctor_Z7AD9E565_1(0, 1, 0));
        Expect_isTrue((pl_53 = a_226, (other_12 = b_209, (Math.abs((a_227 = other_12.Zaxis, (b_210 = pl_53.Zaxis, ((a_227.X * b_210.X) + (a_227.Y * b_210.Y)) + (a_227.Z * b_210.Z)))) > 0.9999904807207345) && (((pl_54 = pl_53, (a_229 = pl_54.Zaxis, (b_212 = ((a_228 = other_12.Origin, (b_211 = pl_54.Origin, Vec_$ctor_Z7AD9E565_2(a_228.X - b_211.X, a_228.Y - b_211.Y, a_228.Z - b_211.Z)))), ((a_229.X * b_212.X) + (a_229.Y * b_212.Y)) + (a_229.Z * b_212.Z))))) < 1E-06))))("Planes at same height should be coincident");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_57, Test_TestCaseBuilder__Delay_1505(builder$0040_57, () => {
        ...
        const a_230 = PPlane_$ctor_3CB4665C(Pnt_$ctor_Z7AD9E565_1(0, 0, 0), UnitVec_$ctor_Z7AD9E565(1, 0, 0), UnitVec_$ctor_Z7AD9E565(0, 1, 0), UnitVec_$ctor_Z7AD9E565(0, 0, 1));
        const b_213 = Euclid_PPlane__PPlane_createOriginXaxisYaxis_Static_6181AF53(Pnt_$ctor_Z7AD9E565(10, 10, 0), Vec_$ctor_Z7AD9E565_1(1, 0, 0), Vec_$ctor_Z7AD9E565_1(0, 1, 0));
        Expect_isTrue((pl_55 = a_230, (other_14 = b_213, (Math.abs((a_233 = other_14.Zaxis, (b_216 = pl_55.Zaxis, ((a_233.X * b_216.X) + (a_233.Y * b_216.Y)) + (a_233.Z * b_216.Z)))) > 0.9999904807207345) && (((pl_56 = pl_55, (a_235 = pl_56.Zaxis, (b_218 = ((a_234 = other_14.Origin, (b_217 = pl_56.Origin, Vec_$ctor_Z7AD9E565_2(a_234.X - b_217.X, a_234.Y - b_217.Y, a_234.Z - b_217.Z)))), ((a_235.X * b_218.X) + (a_235.Y * b_218.Y)) + (a_235.Z * b_218.Z))))) < 1E-06))))("Static method should work");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_58, Test_TestCaseBuilder__Delay_1505(builder$0040_58, () => {
        ...
        const newOrigin = Pnt_$ctor_Z7AD9E565_2(o.X * 2, o.Y * 2, o.Z * 2);
        scaled_1 = PPlane_$ctor_3CB4665C(newOrigin, pl_58.Xaxis, pl_58.Yaxis, pl_58.Zaxis);
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_59, Test_TestCaseBuilder__Delay_1505(builder$0040_59, () => {
        ...
        const plane_37 = PPlane_$ctor_3CB4665C(Pnt_$ctor_Z7AD9E565_1(0, 0, 0), UnitVec_$ctor_Z7AD9E565(1, 0, 0), UnitVec_$ctor_Z7AD9E565(0, 1, 0), UnitVec_$ctor_Z7AD9E565(0, 0, 1));
        let moved_2;
        const pl_60 = plane_37;
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_60, Test_TestCaseBuilder__Delay_1505(builder$0040_60, () => {
        let p_22, v_87, a_245, b_228, x_135, y_123, z_117;
        const plane_38 = PPlane_$ctor_3CB4665C(Pnt_$ctor_Z7AD9E565_1(0, 0, 0), UnitVec_$ctor_Z7AD9E565(1, 0, 0), UnitVec_$ctor_Z7AD9E565(0, 1, 0), UnitVec_$ctor_Z7AD9E565(0, 0, 1));
        let moved_3;
        const pl_62 = plane_38;
        moved_3 = PPlane_$ctor_3CB4665C((p_22 = pl_62.Origin, (v_87 = Vec_$ctor_Z7AD9E565(5, 5, 5), Pnt_$ctor_Z7AD9E565_1(p_22.X + v_87.X, p_22.Y + v_87.Y, p_22.Z + v_87.Z))), pl_62.Xaxis, pl_62.Yaxis, pl_62.Zaxis);
        Expect_isTrue(((a_245 = moved_3.Origin, (b_228 = Pnt_$ctor_Z7AD9E565(5, 5, 5), (x_135 = (a_245.X - b_228.X), (y_123 = (a_245.Y - b_228.Y), (z_117 = (a_245.Z - b_228.Z), Math.sqrt(((x_135 * x_135) + (y_123 * y_123)) + (z_117 * z_117)))))))) < 1E-09)("Origin should be moved");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_61, Test_TestCaseBuilder__Delay_1505(builder$0040_61, () => {
        let a_248, b_231;
        const a_246 = PPlane_$ctor_3CB4665C(Pnt_$ctor_Z7AD9E565_1(0, 0, 0), UnitVec_$ctor_Z7AD9E565(1, 0, 0), UnitVec_$ctor_Z7AD9E565(0, 1, 0), UnitVec_$ctor_Z7AD9E565(0, 0, 1));
        const b_229 = PPlane_$ctor_3CB4665C(Pnt_$ctor_Z7AD9E565_1(0, 0, 0), UnitVec_$ctor_Z7AD9E565(1, 0, 0), UnitVec_$ctor_Z7AD9E565(0, 1, 0), UnitVec_$ctor_Z7AD9E565(0, 0, 1));
        Expect_isTrue((a_248 = a_246, (b_231 = b_229, ((((((((Math.abs(a_248.Origin.X - b_231.Origin.X) <= 0) && (Math.abs(a_248.Origin.Y - b_231.Origin.Y) <= 0)) && (Math.abs(a_248.Origin.Z - b_231.Origin.Z) <= 0)) && (Math.abs(a_248.Xaxis.X - b_231.Xaxis.X) <= 0)) && (Math.abs(a_248.Xaxis.Y - b_231.Xaxis.Y) <= 0)) && (Math.abs(a_248.Xaxis.Z - b_231.Xaxis.Z) <= 0)) && (Math.abs(a_248.Yaxis.X - b_231.Yaxis.X) <= 0)) && (Math.abs(a_248.Yaxis.Y - b_231.Yaxis.Y) <= 0)) && (Math.abs(a_248.Yaxis.Z - b_231.Yaxis.Z) <= 0))))("Exact planes should be equal");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_63, Test_TestCaseBuilder__Delay_1505(builder$0040_63, () => {
        let a_256, b_239;
        const a_254 = PPlane_$ctor_3CB4665C(Pnt_$ctor_Z7AD9E565_1(0, 0, 0), UnitVec_$ctor_Z7AD9E565(1, 0, 0), UnitVec_$ctor_Z7AD9E565(0, 1, 0), UnitVec_$ctor_Z7AD9E565(0, 0, 1));
        const b_237 = Euclid_PPlane__PPlane_createOriginXaxisYaxis_Static_6181AF53(Pnt_$ctor_Z7AD9E565(1, 1, 1), Vec_$ctor_Z7AD9E565_1(1, 0, 0), Vec_$ctor_Z7AD9E565_1(0, 1, 0));
        Expect_isTrue((a_256 = a_254, (b_239 = b_237, ((((((((Math.abs(a_256.Origin.X - b_239.Origin.X) > 0.5) ? true : (Math.abs(a_256.Origin.Y - b_239.Origin.Y) > 0.5)) ? true : (Math.abs(a_256.Origin.Z - b_239.Origin.Z) > 0.5)) ? true : (Math.abs(a_256.Xaxis.X - b_239.Xaxis.X) > 0.5)) ? true : (Math.abs(a_256.Xaxis.Y - b_239.Xaxis.Y) > 0.5)) ? true : (Math.abs(a_256.Xaxis.Z - b_239.Xaxis.Z) > 0.5)) ? true : (Math.abs(a_256.Yaxis.X - b_239.Yaxis.X) > 0.5)) ? true : (Math.abs(a_256.Yaxis.Y - b_239.Yaxis.Y) > 0.5)) ? true : (Math.abs(a_256.Yaxis.Z - b_239.Yaxis.Z) > 0.5))))("Different planes should not be equal");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_64, Test_TestCaseBuilder__Delay_1505(builder$0040_64, () => {
        let a_261, b_243, x_151, y_139, z_133;
        const plane_39 = PPlane_$ctor_3CB4665C(Pnt_$ctor_Z7AD9E565_1(0, 0, 0), UnitVec_$ctor_Z7AD9E565(1, 0, 0), UnitVec_$ctor_Z7AD9E565(0, 1, 0), UnitVec_$ctor_Z7AD9E565(0, 0, 1));
        const pt_32 = Pnt_$ctor_Z7AD9E565(5, 5, 10);
        let closest_2;
        const pl_63 = plane_39;
        const pt_33 = pt_32;
        const p_23 = pt_33;
        let v_88;
        const a_259 = pl_63.Zaxis;
        let f_22;
        const pl_64 = pl_63;
        const a_258 = pl_64.Zaxis;
        let b_241;
        const a_257 = pt_33;
        const b_240 = pl_64.Origin;
        b_241 = Vec_$ctor_Z7AD9E565_2(a_257.X - b_240.X, a_257.Y - b_240.Y, a_257.Z - b_240.Z);
        f_22 = (((a_258.X * b_241.X) + (a_258.Y * b_241.Y)) + (a_258.Z * b_241.Z));
        v_88 = Vec_$ctor_Z7AD9E565_2(a_259.X * f_22, a_259.Y * f_22, a_259.Z * f_22);
        closest_2 = Pnt_$ctor_Z7AD9E565_1(p_23.X - v_88.X, p_23.Y - v_88.Y, p_23.Z - v_88.Z);
        Expect_isTrue(((a_261 = closest_2, (b_243 = Pnt_$ctor_Z7AD9E565(5, 5, 0), (x_151 = (a_261.X - b_243.X), (y_139 = (a_261.Y - b_243.Y), (z_133 = (a_261.Z - b_243.Z), Math.sqrt(((x_151 * x_151) + (y_139 * y_139)) + (z_133 * z_133)))))))) < 1E-09)("Closest point should be (5, 5, 0)");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_65, Test_TestCaseBuilder__Delay_1505(builder$0040_65, () => {
        let a_266, b_247, x_155, y_143, z_137;
        const plane_40 = PPlane_$ctor_3CB4665C(Pnt_$ctor_Z7AD9E565_1(0, 0, 0), UnitVec_$ctor_Z7AD9E565(1, 0, 0), UnitVec_$ctor_Z7AD9E565(0, 1, 0), UnitVec_$ctor_Z7AD9E565(0, 0, 1));
        const pt_35 = Pnt_$ctor_Z7AD9E565(5, 5, 10);
        let newPlane_1;
        const pl_65 = plane_40;
        let o_1;
        const pl_66 = pl_65;
        const pt_37 = pt_35;
        const p_24 = pt_37;
        let v_89;
        const a_264 = pl_66.Zaxis;
        let f_23;
        const pl_67 = pl_66;
        const a_263 = pl_67.Zaxis;
        let b_245;
        const a_262 = pt_37;
        const b_244 = pl_67.Origin;
        b_245 = Vec_$ctor_Z7AD9E565_2(a_262.X - b_244.X, a_262.Y - b_244.Y, a_262.Z - b_244.Z);
        f_23 = (((a_263.X * b_245.X) + (a_263.Y * b_245.Y)) + (a_263.Z * b_245.Z));
        v_89 = Vec_$ctor_Z7AD9E565_2(a_264.X * f_23, a_264.Y * f_23, a_264.Z * f_23);
        o_1 = Pnt_$ctor_Z7AD9E565_1(p_24.X - v_89.X, p_24.Y - v_89.Y, p_24.Z - v_89.Z);
        newPlane_1 = PPlane_$ctor_3CB4665C(o_1, pl_65.Xaxis, pl_65.Yaxis, pl_65.Zaxis);
        Expect_isTrue(((a_266 = newPlane_1.Origin, (b_247 = Pnt_$ctor_Z7AD9E565(5, 5, 0), (x_155 = (a_266.X - b_247.X), (y_143 = (a_266.Y - b_247.Y), (z_137 = (a_266.Z - b_247.Z), Math.sqrt(((x_155 * x_155) + (y_143 * y_143)) + (z_137 * z_137)))))))) < 1E-09)("New plane origin should be at closest point");
