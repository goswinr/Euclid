...
export const tests = Test_testList("Basic Vector and Point Types", ofArray([Test_testList("Pt (2D Point)", ofArray([(() => {
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_1, Test_TestCaseBuilder__Delay_1505(builder$0040_1, () => {
        ...
        const pt2 = Pt_$ctor_7B00E9A0(3, 4);
        let dist;
        const a_1 = pt1;
        const b_1 = pt2;
        ...
        Expect_floatClose(tol, dist, 5, "distance is 5.0");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_2, Test_TestCaseBuilder__Delay_1505(builder$0040_2, () => {
        const pt1_1 = Pt_$ctor_7B00E9A0(0, 0);
        const pt2_1 = Pt_$ctor_7B00E9A0(3, 4);
        let distSq;
        const a_3 = pt1_1;
        const b_3 = pt2_1;
        const vx_1 = a_3.X - b_3.X;
        const vy_1 = a_3.Y - b_3.Y;
        distSq = ((vx_1 * vx_1) + (vy_1 * vy_1));
        Expect_floatClose(tol, distSq, 25, "distanceSq is 25.0");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_3, Test_TestCaseBuilder__Delay_1505(builder$0040_3, () => {
        const pt_1 = Pt_$ctor_7B00E9A0(1, 2);
        const vc = Vc_$ctor_7B00E9A0(3, 4);
        let result;
        const p = pt_1;
        const v = vc;
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_4, Test_TestCaseBuilder__Delay_1505(builder$0040_4, () => {
        const pt1_2 = Pt_$ctor_7B00E9A0(5, 7);
        const pt2_2 = Pt_$ctor_7B00E9A0(2, 3);
        let vc_1;
        const a_4 = pt1_2;
        const b_4 = pt2_2;
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_6, Test_TestCaseBuilder__Delay_1505(builder$0040_6, () => {
        const vc_3 = Vc_$ctor_7B00E9A0(3, 4);
        let len;
        const v_1 = vc_3;
        const x = v_1.X;
        const y = v_1.Y;
        len = Math.sqrt((x * x) + (y * y));
        Expect_floatClose(tol, len, 5, "length is 5.0");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_7, Test_TestCaseBuilder__Delay_1505(builder$0040_7, () => {
        const vc_4 = Vc_$ctor_7B00E9A0(3, 4);
        let lenSq;
        const v_2 = vc_4;
        const x_1 = v_2.X;
        const y_1 = v_2.Y;
        lenSq = ((x_1 * x_1) + (y_1 * y_1));
        Expect_floatClose(tol, lenSq, 25, "lengthSq is 25.0");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_8, Test_TestCaseBuilder__Delay_1505(builder$0040_8, () => {
        const vc1 = Vc_$ctor_7B00E9A0(1, 2);
        const vc2 = Vc_$ctor_7B00E9A0(3, 4);
        let result_1;
        const a_5 = vc1;
        const b_5 = vc2;
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_9, Test_TestCaseBuilder__Delay_1505(builder$0040_9, () => {
        const vc1_1 = Vc_$ctor_7B00E9A0(5, 7);
        const vc2_1 = Vc_$ctor_7B00E9A0(2, 3);
        let result_2;
        const a_6 = vc1_1;
        const b_6 = vc2_1;
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_10, Test_TestCaseBuilder__Delay_1505(builder$0040_10, () => {
        const vc_5 = Vc_$ctor_7B00E9A0(2, 3);
        let result_3;
        const v_3 = vc_5;
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_11, Test_TestCaseBuilder__Delay_1505(builder$0040_11, () => {
        const vc_6 = Vc_$ctor_7B00E9A0(6, 8);
        let result_4;
        const v_4 = vc_6;
        if (!(Math.abs(2) > 1E-12)) {
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_14, Test_TestCaseBuilder__Delay_1505(builder$0040_14, () => {
        ...
        Expect_throws(f_2, "throws on zero vector");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_15, Test_TestCaseBuilder__Delay_1505(builder$0040_15, () => {
        ...
        Expect_throws(f_3, "throws on very small vector");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_18, Test_TestCaseBuilder__Delay_1505(builder$0040_18, () => {
        const pnt1 = Pnt_$ctor_Z7AD9E565(0, 0, 0);
        const pnt2 = Pnt_$ctor_Z7AD9E565(1, 2, 2);
        let dist_1;
        const a_8 = pnt1;
        const b_8 = pnt2;
        const x_20 = a_8.X - b_8.X;
        const y_13 = a_8.Y - b_8.Y;
        const z = a_8.Z - b_8.Z;
        dist_1 = Math.sqrt(((x_20 * x_20) + (y_13 * y_13)) + (z * z));
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_19, Test_TestCaseBuilder__Delay_1505(builder$0040_19, () => {
        const pnt1_1 = Pnt_$ctor_Z7AD9E565(0, 0, 0);
        const pnt2_1 = Pnt_$ctor_Z7AD9E565(1, 2, 2);
        let distSq_1;
        const a_10 = pnt1_1;
        const b_10 = pnt2_1;
        const x_21 = a_10.X - b_10.X;
        const y_14 = a_10.Y - b_10.Y;
        const z_1 = a_10.Z - b_10.Z;
        distSq_1 = (((x_21 * x_21) + (y_14 * y_14)) + (z_1 * z_1));
        Expect_floatClose(tol, distSq_1, 9, "distanceSq is 9.0");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_20, Test_TestCaseBuilder__Delay_1505(builder$0040_20, () => {
        const pnt_1 = Pnt_$ctor_Z7AD9E565(1, 2, 3);
        const vec = Vec_$ctor_Z7AD9E565(4, 5, 6);
        let result_5;
        const p_1 = pnt_1;
        const v_7 = vec;
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_21, Test_TestCaseBuilder__Delay_1505(builder$0040_21, () => {
        const pnt1_2 = Pnt_$ctor_Z7AD9E565(5, 7, 9);
        const pnt2_2 = Pnt_$ctor_Z7AD9E565(2, 3, 4);
        let vec_1;
        const a_11 = pnt1_2;
        const b_11 = pnt2_2;
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_23, Test_TestCaseBuilder__Delay_1505(builder$0040_23, () => {
        const vec_3 = Vec_$ctor_Z7AD9E565(2, 3, 6);
        let len_1;
        const v_8 = vec_3;
        len_1 = Math.sqrt(((v_8.X * v_8.X) + (v_8.Y * v_8.Y)) + (v_8.Z * v_8.Z));
        Expect_floatClose(tol, len_1, 7, "length is 7.0");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_24, Test_TestCaseBuilder__Delay_1505(builder$0040_24, () => {
        const vec_4 = Vec_$ctor_Z7AD9E565(2, 3, 6);
        let lenSq_1;
        const v_9 = vec_4;
        lenSq_1 = (((v_9.X * v_9.X) + (v_9.Y * v_9.Y)) + (v_9.Z * v_9.Z));
        Expect_floatClose(tol, lenSq_1, 49, "lengthSq is 49.0");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_25, Test_TestCaseBuilder__Delay_1505(builder$0040_25, () => {
        const vec1 = Vec_$ctor_Z7AD9E565(1, 2, 3);
        const vec2 = Vec_$ctor_Z7AD9E565(4, 5, 6);
        let result_6;
        const a_12 = vec1;
        const b_12 = vec2;
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_26, Test_TestCaseBuilder__Delay_1505(builder$0040_26, () => {
        const vec1_1 = Vec_$ctor_Z7AD9E565(5, 7, 9);
        const vec2_1 = Vec_$ctor_Z7AD9E565(2, 3, 4);
        let result_7;
        const a_13 = vec1_1;
        const b_13 = vec2_1;
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_27, Test_TestCaseBuilder__Delay_1505(builder$0040_27, () => {
        const vec_5 = Vec_$ctor_Z7AD9E565(2, 3, 4);
        let result_8;
        const a_14 = vec_5;
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_28, Test_TestCaseBuilder__Delay_1505(builder$0040_28, () => {
        const vec_6 = Vec_$ctor_Z7AD9E565(6, 8, 10);
        let result_9;
        const v_10 = vec_6;
        if (!(Math.abs(2) > 1E-12)) {
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_29, Test_TestCaseBuilder__Delay_1505(builder$0040_29, () => {
        const vec1_2 = Vec_$ctor_Z7AD9E565(1, 0, 0);
        const vec2_2 = Vec_$ctor_Z7AD9E565(0, 1, 0);
        let cross;
        const a_15 = vec1_2;
        const b_14 = vec2_2;
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_30, Test_TestCaseBuilder__Delay_1505(builder$0040_30, () => {
        const vec1_3 = Vec_$ctor_Z7AD9E565(1, 2, 3);
        const vec2_3 = Vec_$ctor_Z7AD9E565(4, 5, 6);
        let dot;
        const a_16 = vec1_3;
        const b_15 = vec2_3;
        dot = (((a_16.X * b_15.X) + (a_16.Y * b_15.Y)) + (a_16.Z * b_15.Z));
        Expect_floatClose(tol, dot, 32, "dot is 32.0");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_33, Test_TestCaseBuilder__Delay_1505(builder$0040_33, () => {
        ...
        Expect_throws(f_7, "throws on zero vector");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_34, Test_TestCaseBuilder__Delay_1505(builder$0040_34, () => {
        ...
        Expect_throws(f_8, "throws on very small vector");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_36, Test_TestCaseBuilder__Delay_1505(builder$0040_36, () => {
        let uvec1;
        const l_10 = Math.sqrt(((1 * 1) + (0 * 0)) + (0 * 0));
        if (!(l_10 > 1E-12)) {
            failUnit3("UnitVec.create", 1, 0, 0);
        }
        const li_5 = 1 / l_10;
        uvec1 = UnitVec_$ctor_Z7AD9E565(li_5 * 1, li_5 * 0, li_5 * 0);
        let uvec2;
        const l_11 = Math.sqrt(((1 * 1) + (1 * 1)) + (0 * 0));
        if (!(l_11 > 1E-12)) {
            failUnit3("UnitVec.create", 1, 1, 0);
        }
        const li_6 = 1 / l_11;
        uvec2 = UnitVec_$ctor_Z7AD9E565(li_6 * 1, li_6 * 1, li_6 * 0);
        let dot_1;
        const a_17 = uvec1;
        const b_16 = uvec2;
        dot_1 = (((a_17.X * b_16.X) + (a_17.Y * b_16.Y)) + (a_17.Z * b_16.Z));
        Expect_floatClose(tolMed, dot_1, 1 / Math.sqrt(2), "dot is 1/sqrt(2)");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_37, Test_TestCaseBuilder__Delay_1505(builder$0040_37, () => {
        ...
        const li_7 = 1 / l_12;
        uvec1_1 = UnitVec_$ctor_Z7AD9E565(li_7 * 1, li_7 * 0, li_7 * 0);
        let uvec2_1;
        ...
        const li_8 = 1 / l_13;
        uvec2_1 = UnitVec_$ctor_Z7AD9E565(li_8 * 0, li_8 * 1, li_8 * 0);
        let cross_1;
        const a_18 = uvec1_1;
        const b_17 = uvec2_1;
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_38, Test_TestCaseBuilder__Delay_1505(builder$0040_38, () => {
        let v_13, x_51, y_33;
        const vc_8 = Vc_$ctor_7B00E9A0(0, 0);
        Expect_floatClose(tol, (v_13 = vc_8, (x_51 = v_13.X, (y_33 = v_13.Y, Math.sqrt((x_51 * x_51) + (y_33 * y_33))))), 0, "length is 0.0");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_39, Test_TestCaseBuilder__Delay_1505(builder$0040_39, () => {
        let v_14;
        const vec_8 = Vec_$ctor_Z7AD9E565(0, 0, 0);
        Expect_floatClose(tol, (v_14 = vec_8, Math.sqrt(((v_14.X * v_14.X) + (v_14.Y * v_14.Y)) + (v_14.Z * v_14.Z))), 0, "length is 0.0");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_40, Test_TestCaseBuilder__Delay_1505(builder$0040_40, () => {
        let v_15, x_52, y_34;
        const vc_9 = Vc_$ctor_7B00E9A0(1E-10, 1E-10);
        Expect_isTrue(((v_15 = vc_9, (x_52 = v_15.X, (y_34 = v_15.Y, Math.sqrt((x_52 * x_52) + (y_34 * y_34)))))) < 1E-09)("length is very small");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_41, Test_TestCaseBuilder__Delay_1505(builder$0040_41, () => {
        let v_16;
        const vec_9 = Vec_$ctor_Z7AD9E565(1E-10, 1E-10, 1E-10);
        Expect_isTrue(((v_16 = vec_9, Math.sqrt(((v_16.X * v_16.X) + (v_16.Y * v_16.Y)) + (v_16.Z * v_16.Z)))) < 1E-09)("length is very small");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_42, Test_TestCaseBuilder__Delay_1505(builder$0040_42, () => {
        const pt1_3 = Pt_$ctor_7B00E9A0(1, 2);
        const pt2_3 = Pt_$ctor_7B00E9A0(1, 2);
        let dist_2;
        const a_20 = pt1_3;
        const b_19 = pt2_3;
        const vx_2 = a_20.X - b_19.X;
        const vy_2 = a_20.Y - b_19.Y;
        dist_2 = Math.sqrt((vx_2 * vx_2) + (vy_2 * vy_2));
        Expect_floatClose(tol, dist_2, 0, "identical points have zero distance");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_43, Test_TestCaseBuilder__Delay_1505(builder$0040_43, () => {
        const pnt1_3 = Pnt_$ctor_Z7AD9E565(1, 2, 3);
        const pnt2_3 = Pnt_$ctor_Z7AD9E565(1, 2, 3);
        let dist_3;
        const a_22 = pnt1_3;
        const b_21 = pnt2_3;
        const x_53 = a_22.X - b_21.X;
        const y_35 = a_22.Y - b_21.Y;
        const z_20 = a_22.Z - b_21.Z;
        dist_3 = Math.sqrt(((x_53 * x_53) + (y_35 * y_35)) + (z_20 * z_20));
        Expect_floatClose(tol, dist_3, 0, "identical points have zero distance");
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_44, Test_TestCaseBuilder__Delay_1505(builder$0040_44, () => {
        const vc_10 = Vc_$ctor_7B00E9A0(3, 4);
        let neg;
        const v_17 = vc_10;
    ...
    return Test_TestCaseBuilder__Run_3A5B6456(builder$0040_45, Test_TestCaseBuilder__Delay_1505(builder$0040_45, () => {
        const vec_10 = Vec_$ctor_Z7AD9E565(3, 4, 5);
        let neg_1;
        const a_23 = vec_10;
