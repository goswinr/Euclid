...
(*
doesn't make sense in 3D, only 2D:



    /// <summary> Returns the intersection or closest approach point of two rays if it is within the given parameter range for line A.</summary>
    /// <param name="pAx"> The X coordinate of the start point on the first line.</param>
    /// <param name="pAy"> The Y coordinate of the start point on the first line.</param>
    /// <param name="pAz"> The Z coordinate of the start point on the first line.</param>
    /// <param name="pBx"> The X coordinate of the start point on the second line.</param>
    ...
    /// <returns> A point if lineA has an intersection/closest-approach parameter in the range (inclusive min and max value).
    ///  None if the lines are parallel or the parameter is outside of the range.
    /// </returns>
    static member inline tryIntersectInRangeA (pAx:float, pAy:float, pAz:float, pBx:float, pBy:float, pBz:float,
                                                vAx:float, vAy:float, vAz:float, vBx:float, vBy:float, vBz:float,
                                                minParameterA, maxParameterA): Pnt option =
        let crossX = vAy * vBz - vAz * vBy
        let crossY = vAz * vBx - vAx * vBz
        let crossZ = vAx * vBy - vAy * vBx
        let crossMagSq = crossX * crossX + crossY * crossY + crossZ * crossZ
    ...
    /// None if the lines are parallel or the parameter is outside of the range.
    /// </returns>
    static member inline tryIntersectInRangeA (pA:Pnt, pB:Pnt, vA:Vec, vB:Vec, minParameterA, maxParameterA): Pnt option =
        XLine3D.tryIntersectInRangeA (pA.X, pA.Y, pA.Z, pB.X, pB.Y, pB.Z, vA.X, vA.Y, vA.Z, vB.X, vB.Y, vB.Z, minParameterA, maxParameterA)
    ...
    /// None if the lines are parallel or the parameter is outside of the range.
    /// </returns>
    static member inline tryIntersectInRangeA (lineA: Line3D, lineB: Line3D, minParameterA, maxParameterA): Pnt option =
        XLine3D.tryIntersectInRangeA(lineA.FromX, lineA.FromY, lineA.FromZ, lineB.FromX, lineB.FromY, lineB.FromZ, lineA.VectorX, lineA.VectorY, lineA.VectorZ, lineB.VectorX, lineB.VectorY, lineB.VectorZ, minParameterA, maxParameterA)



    /// <summary> Returns the intersection or closest approach point of two rays if it is within the given parameter ranges for line A and line B.</summary>
    /// <param name="pAx"> The X coordinate of the start point on the first line.</param>
    /// <param name="pAy"> The Y coordinate of the start point on the first line.</param>
    /// <param name="pAz"> The Z coordinate of the start point on the first line.</param>
    /// <param name="pBx"> The X coordinate of the start point on the second line.</param>
    ...
    /// <returns> A point if both lines have an intersection/closest-approach parameter in the range (inclusive min and max value).
    ///  None if the lines are parallel or at least one parameter is outside of the range.
    /// </returns>
    static member inline tryIntersectInRanges (pAx:float, pAy:float, pAz:float, pBx:float, pBy:float, pBz:float,
                                                vAx:float, vAy:float, vAz:float, vBx:float, vBy:float, vBz:float,
                                                minParameterA, maxParameterA, minParameterB, maxParameterB): Pnt option =
        let crossX = vAy * vBz - vAz * vBy
        let crossY = vAz * vBx - vAx * vBz
        let crossZ = vAx * vBy - vAy * vBx
        let crossMagSq = crossX * crossX + crossY * crossY + crossZ * crossZ
    ...
    /// <param name="minParameterB"> The minimum parameter value of the range, inclusive.</param>
    /// <param name="maxParameterB"> The maximum parameter value of the range, inclusive.</param>
    /// <returns> A point if both lines have an intersection/closest-approach parameter in the range (inclusive
    /// min and max value). None if the lines are parallel or at least one parameter is outside of the range.
    /// </returns>
    static member inline tryIntersectInRanges (pA:Pnt, pB:Pnt, vA:Vec, vB:Vec, minParameterA, maxParameterA, minParameterB, maxParameterB): Pnt option =
        XLine3D.tryIntersectInRanges (pA.X, pA.Y, pA.Z, pB.X, pB.Y, pB.Z, vA.X, vA.Y, vA.Z, vB.X, vB.Y, vB.Z, minParameterA, maxParameterA, minParameterB, maxParameterB)
    ...
    /// min and max value). None if the lines are parallel or at least one parameter is outside of the range.
    /// </returns>
    static member inline tryIntersectInRanges (lineA: Line3D, lineB: Line3D, minParameterA, maxParameterA, minParameterB, maxParameterB): Pnt option =
        XLine3D.tryIntersectInRanges(lineA.FromX, lineA.FromY, lineA.FromZ, lineB.FromX, lineB.FromY, lineB.FromZ, lineA.VectorX, lineA.VectorY, lineA.VectorZ, lineB.VectorX, lineB.VectorY, lineB.VectorZ, minParameterA, maxParameterA, minParameterB, maxParameterB)


    /// <summary> Checks if two 3D-lines both have closest approach parameters within the given ranges for each line.</summary>
    /// <param name="pAx"> The X coordinate of the start point on the first line.</param>
    /// <param name="pAy"> The Y coordinate of the start point on the first line.</param>
    /// <param name="pAz"> The Z coordinate of the start point on the first line.</param>
    /// <param name="pBx"> The X coordinate of the start point on the second line.</param>
    ...
    /// <param name="minParameterB"> The minimum parameter value of the range, inclusive.</param>
    /// <param name="maxParameterB"> The maximum parameter value of the range, inclusive.</param>
    /// <returns> TRUE if both lines have a closest approach parameter in the range (inclusive min and max value).
    ///  FALSE if the lines are parallel, coincident or at least one closest approach parameter is outside of the range.
    /// </returns>
    static member inline isWithinRanges (pAx:float, pAy:float, pAz:float, pBx:float, pBy:float, pBz:float,
                                         vAx:float, vAy:float, vAz:float, vBx:float, vBy:float, vBz:float,
    ...
    ///  FALSE if the lines are parallel, coincident or at least one closest approach parameter is outside of the range.
    /// </returns>
    static member inline isWithinRanges (pA:Pnt, pB:Pnt, vA:Vec, vB:Vec, minParameterA, maxParameterA, minParameterB, maxParameterB): bool =
        XLine3D.isWithinRanges (pA.X, pA.Y, pA.Z, pB.X, pB.Y, pB.Z, vA.X, vA.Y, vA.Z, vB.X, vB.Y, vB.Z, minParameterA, maxParameterA, minParameterB, maxParameterB)
    ...
    ///  FALSE if the lines are parallel, coincident or at least one closest approach parameter is outside of the range.
    /// </returns>
    static member inline isWithinRanges (lineA: Line3D, lineB: Line3D, minParameterA, maxParameterA, minParameterB, maxParameterB ): bool =
        XLine3D.isWithinRanges(lineA.FromX, lineA.FromY, lineA.FromZ, lineB.FromX, lineB.FromY, lineB.FromZ,
                               lineA.VectorX, lineA.VectorY, lineA.VectorZ,
                               lineB.VectorX, lineB.VectorY, lineB.VectorZ,
                               minParameterA, maxParameterA, minParameterB, maxParameterB)

    /// <summary> Returns the closest approach point on line A of two rays
    /// if the parameter on line A is within the given range.</summary>
    /// <param name="pAx"> The X coordinate of the start point on the first line.</param>
    /// <param name="pAy"> The Y coordinate of the start point on the first line.</param>
    /// <param name="pAz"> The Z coordinate of the start point on the first line.</param>
    /// <param name="pBx"> The X coordinate of the start point on the second line.</param>
    ...
    /// <param name="minParameterA"> The minimum parameter value of the range, inclusive.</param>
    /// <param name="maxParameterA"> The maximum parameter value of the range, inclusive.</param>
    /// <returns> A point if lineA has a closest approach parameter in the range (inclusive min and max value).
    ///  None if the lines are parallel, coincident or the closest approach parameter is outside of the range.
    /// </returns>
    static member inline tryClosestPntInRangeA (pAx:float, pAy:float, pAz:float, pBx:float, pBy:float, pBz:float,
                                                vAx:float, vAy:float, vAz:float, vBx:float, vBy:float, vBz:float,
                                                minParameterA, maxParameterA): Pnt option =
        let crossX = vAy * vBz - vAz * vBy
        let crossY = vAz * vBx - vAx * vBz
    ...
    /// None if the lines are parallel, coincident or the closest approach parameter is outside of the range.
    /// </returns>
    static member inline tryClosestPntInRangeA (pA:Pnt, pB:Pnt, vA:Vec, vB:Vec, minParameterA, maxParameterA): Pnt option =
        XLine3D.tryClosestPntInRangeA (pA.X, pA.Y, pA.Z, pB.X, pB.Y, pB.Z, vA.X, vA.Y, vA.Z, vB.X, vB.Y, vB.Z, minParameterA, maxParameterA)
    ...
    /// None if the lines are parallel, coincident or the closest approach parameter is outside of the range.
    /// </returns>
    static member inline tryClosestPntInRangeA (lineA: Line3D, lineB: Line3D, minParameterA, maxParameterA): Pnt option =
        XLine3D.tryClosestPntInRangeA(lineA.FromX, lineA.FromY, lineA.FromZ, lineB.FromX, lineB.FromY, lineB.FromZ,
                                      lineA.VectorX, lineA.VectorY, lineA.VectorZ,
                                      lineB.VectorX, lineB.VectorY, lineB.VectorZ,
                                      minParameterA, maxParameterA)



    /// <summary> Returns the closest approach point on line A of two rays
    ///  if parameters on both lines are within the given ranges.</summary>
    /// <param name="pAx"> The X coordinate of the start point on the first line.</param>
    /// <param name="pAy"> The Y coordinate of the start point on the first line.</param>
    /// <param name="pAz"> The Z coordinate of the start point on the first line.</param>
    /// <param name="pBx"> The X coordinate of the start point on the second line.</param>
    ...
    /// <param name="minParameterB"> The minimum parameter value of the range, inclusive.</param>
    /// <param name="maxParameterB"> The maximum parameter value of the range, inclusive.</param>
    /// <returns> A point if both lines have a closest approach parameter in the range (inclusive min and max value).
    ///  None if the lines are parallel, coincident or at least one closest approach parameter is outside of the range.
    /// </returns>
    static member inline tryClosestPntOnAInRanges (pAx:float, pAy:float, pAz:float, pBx:float, pBy:float, pBz:float,
                                                vAx:float, vAy:float, vAz:float, vBx:float, vBy:float, vBz:float,
                                                minParameterA, maxParameterA, minParameterB, maxParameterB): Pnt option =
        let crossX = vAy * vBz - vAz * vBy
        let crossY = vAz * vBx - vAx * vBz
    ...
    /// <param name="minParameterB"> The minimum parameter value of the range, inclusive.</param>
    /// <param name="maxParameterB"> The maximum parameter value of the range, inclusive.</param>
    /// <returns> A point if both lines have a closest approach parameter in the range (inclusive
    /// min and max value). None if the lines are parallel, coincident or at least one closest approach parameter is outside of the range.
    /// </returns>
    static member inline tryClosestPntOnAInRanges (pA:Pnt, pB:Pnt, vA:Vec, vB:Vec, minParameterA, maxParameterA, minParameterB, maxParameterB): Pnt option =
        XLine3D.tryClosestPntOnAInRanges (pA.X, pA.Y, pA.Z, pB.X, pB.Y, pB.Z, vA.X, vA.Y, vA.Z, vB.X, vB.Y, vB.Z, minParameterA, maxParameterA, minParameterB, maxParameterB)
    ...
    /// None if the lines are parallel, coincident or at least one closest approach parameter is outside of the range.
    /// </returns>
    static member inline tryClosestPntOnAInRanges (lineA: Line3D, lineB: Line3D, minParameterA, maxParameterA, minParameterB, maxParameterB): Pnt option =
        XLine3D.tryClosestPntOnAInRanges(lineA.FromX, lineA.FromY, lineA.FromZ, lineB.FromX, lineB.FromY, lineB.FromZ,
                                      lineA.VectorX, lineA.VectorY, lineA.VectorZ,
                                      lineB.VectorX, lineB.VectorY, lineB.VectorZ,
                                      minParameterA, maxParameterA, minParameterB, maxParameterB)
